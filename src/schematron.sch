 ...
 <pattern id="article">
  ...
  <pattern id="content-containers">
    ...
    <rule context="mml:math" id="math-tests">
      ...
      <report test="descendant::mml:mstyle[@displaystyle='true'] and ancestor::inline-formula and not(ancestor::sub-article) and not(ancestor::table-wrap) and (descendant::*[name()=('mml:mfrac','mml:mroot','mml:msqrt','mml:munder','mml:mover','mml:munderover')] or descendant::mml:mo[matches(.,'[∑∫∏⋃⋂\(\)\{\}\[\]\|]')])" 
        role="warning" 
