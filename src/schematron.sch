 ...
 <pattern
  ...
  <pattern id="figure-xref-pattern">
    ...
    <rule context="xref[@ref-type='fig']" id="fig-xref-conformance">
      ...
      <report test="($type = 'Figure') and matches($post-text,'^[\s]?[\s—\-][\s]?[Ff]igure supplement')" 
        role="error" 
      ...
      <report test="($type = 'Figure') and matches($post-text,'^[\s]?[\s—\-][\s]?[Vv]ideo')" 
        role="error" 
      ...
      <report test="($type = ('Figure','Figure supplement')) and matches($post-text,'^[\s]?[\s—\-][\s]?[Ss]ource')" 
        role="error" 
