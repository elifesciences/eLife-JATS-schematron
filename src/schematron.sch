   ...
   <let name="template" value="parent::article-meta/custom-meta-group/custom-meta[meta-name='Template']/meta-value[1]"/>
    ...
    <rule context="article-meta/custom-meta-group" id="custom-meta-group-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/feature-content#features-custom-meta-presence"
        test="($type = $features-subj) and count(custom-meta[@specific-use='meta-only']) != 2" 
        role="error" 
  ...
  <pattern id="dec-letter-auth-response">
    ...
    <rule context="article/sub-article" id="dec-letter-reply-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reply-test-1" 
        test="@article-type=('editor-report','decision-letter','reply')" 
        role="error" 
        flag="dl-ar"
  ...
  <pattern id="element-citation-high-tests">
    ...
    <rule context="element-citation" id="elem-citation">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#err-elem-cit-high-6-2"
        test="@publication-type = ('journal', 'book', 'data', 'patent', 'software', 'preprint', 'web', 'periodical', 'report', 'confproc', 'thesis')" 
        role="error" 
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-element-cite-year"
        test="(@publication-type!='periodical') and not(year)" 
        role="warning" 
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-element-cite-string-date"
        test="(@publication-type='periodical') and not(string-date)" 
        role="warning" 
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#final-element-cite-string-date"
        test="(@publication-type='periodical') and not(string-date)" 
        role="error" 
  ...
  <pattern id="house-style">
    ...
    <rule context="sec[@sec-type='data-availability']/p[1]" id="data-availability-statement">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-dryad-conformity" 
        test="matches(.,'[Dd]ryad') and not(parent::sec//element-citation[contains(source[1],'Dryad') or pub-id[@pub-id-type='doi' and (contains(.,'10.7272') or contains(.,'10.5061/dryad'))]])" 
        role="warning" 
