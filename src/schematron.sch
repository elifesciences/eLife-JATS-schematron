 ...
 <pattern id="article">
   ...
   <let name="template" value="parent::article-meta/custom-meta-group/custom-meta[meta-name='Template']/meta-value[1]"/>
    ...
    <rule context="event/self-uri" id="event-self-uri-tests">
      ...
      <report test="@content-type='reviewed-preprint' and not(contains(@xlink:href,$article-id))" 
        role="error" 
        id="event-self-uri-href-6"><name/> in event the attribute content-type="reviewed-preprint", but the xlink:href attribute value (<value-of select="."/>) does not contain the article id (<value-of select="$article-id"/>) which must be incorrect, since this should be the version DOI for the reviewed preprint version.</report>
    </rule>
    ...
    <rule context="aff" id="gen-aff-tests">
      ...
      <report test="count(institution[not(@*)]) + count(institution-wrap/institution[not(@*)]) gt 1" 
        role="error" 
      ...
      <report test="count(institution[@content-type='dept']) + count(institution-wrap/institution[@content-type='dept']) ge 1" 
        role="warning" 
    ...
    <rule context="aff[institution-wrap/institution-id[@institution-id-type='ror']]" id="aff-ror-tests">
      ...
      <report test="exists($matching-ror) and not(contains(institution-wrap[1]/institution[1],$matching-ror/*:name))"
        role="warning" 
      ...
      <report test="(addr-line/named-content[@content-type='city'] or ancestor::contrib[@contrib-type='author' and not(ancestor::sub-article)]) and exists($matching-ror) and not(contains(addr-line[1]/named-content[@content-type='city'][1],$matching-ror/*:city))"
        role="warning" 
	...
	<rule context="funding-group/award-group" id="award-group-tests">
	  ...
	  <report see="https://elifeproduction.slab.com/posts/funding-3sv64358#final-award-group-test-3" 
        ...
        role="error" 
        id="final-award-group-test-3">award-group must contain a principal-award-recipient.</report>
	  
	  <report test="if ($version != '1') then principal-award-recipient
	    else ()" 
	    role="error" 
    ...
    <rule context="article-meta/custom-meta-group/custom-meta" id="custom-meta-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#custom-meta-test-2" 
        test="($type = $research-subj) and not(meta-name = ('Author impact statement','publishing-route'))" 
        role="error" 
      ...
      <report test="($type = $research-subj) and ($pos=2) and  (meta-name != 'publishing-route')" 
        role="error" 
  ...
  <pattern id="element-citation-confproc-tests">
    <rule context="element-citation[@publication-type='confproc']" id="elem-citation-confproc"> 
      ...
      <report test="(lpage and fpage) and (number(replace(fpage[1],'[^\d]','')) ge number(replace(lpage[1],'[^\d]','')))" 
        role="error" 
 ...
 <pattern id="features">
  ...
  <pattern id="org-pattern">
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#bssubtilis-ref-article-title-check" 
        test="matches($lc,'b\.\p{Zs}?subtilis') and not(italic[contains(.,'B. subtilis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#bacillusssubtilis-ref-article-title-check" 
        test="matches($lc,'bacillus\p{Zs}?subtilis') and not(italic[contains(.,'Bacillus subtilis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#dsmelanogaster-ref-article-title-check" 
        test="matches($lc,'d\.\p{Zs}?melanogaster') and not(italic[contains(.,'D. melanogaster')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#drosophilasmelanogaster-ref-article-title-check" 
        test="matches($lc,'drosophila\p{Zs}?melanogaster') and not(italic[contains(.,'Drosophila melanogaster')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#escoli-ref-article-title-check" 
        test="matches($lc,'e\.\p{Zs}?coli') and not(italic[contains(.,'E. coli')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#escherichiascoli-ref-article-title-check" 
        test="matches($lc,'escherichia\p{Zs}?coli') and not(italic[contains(.,'Escherichia coli')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#sspombe-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?pombe') and not(italic[contains(.,'S. pombe')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#schizosaccharomycesspombe-ref-article-title-check" 
        test="matches($lc,'schizosaccharomyces\p{Zs}?pombe') and not(italic[contains(.,'Schizosaccharomyces pombe')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#sscerevisiae-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?cerevisiae') and not(italic[contains(.,'S. cerevisiae')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#saccharomycesscerevisiae-ref-article-title-check" 
        test="matches($lc,'saccharomyces\p{Zs}?cerevisiae') and not(italic[contains(.,'Saccharomyces cerevisiae')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#cselegans-ref-article-title-check" 
        test="matches($lc,'c\.\p{Zs}?elegans') and not(italic[contains(.,'C. elegans')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#caenorhabditisselegans-ref-article-title-check" 
        test="matches($lc,'caenorhabditis\p{Zs}?elegans') and not(italic[contains(.,'Caenorhabditis elegans')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#asthaliana-ref-article-title-check" 
        test="matches($lc,'a\.\p{Zs}?thaliana') and not(italic[contains(.,'A. thaliana')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#arabidopsissthaliana-ref-article-title-check" 
        test="matches($lc,'arabidopsis\p{Zs}?thaliana') and not(italic[contains(.,'Arabidopsis thaliana')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#msthermophila-ref-article-title-check" 
        test="matches($lc,'m\.\p{Zs}?thermophila') and not(italic[contains(.,'M. thermophila')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#myceliophthorasthermophila-ref-article-title-check" 
        test="matches($lc,'myceliophthora\p{Zs}?thermophila') and not(italic[contains(.,'Myceliophthora thermophila')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#dictyostelium-ref-article-title-check" 
        test="matches($lc,'dictyostelium') and not(italic[contains(.,'Dictyostelium')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#psfalciparum-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?falciparum') and not(italic[contains(.,'P. falciparum')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#plasmodiumsfalciparum-ref-article-title-check" 
        test="matches($lc,'plasmodium\p{Zs}?falciparum') and not(italic[contains(.,'Plasmodium falciparum')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ssenterica-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?enterica') and not(italic[contains(.,'S. enterica')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#salmonellasenterica-ref-article-title-check" 
        test="matches($lc,'salmonella\p{Zs}?enterica') and not(italic[contains(.,'Salmonella enterica')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#sspyogenes-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?pyogenes') and not(italic[contains(.,'S. pyogenes')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#streptococcusspyogenes-ref-article-title-check" 
        test="matches($lc,'streptococcus\p{Zs}?pyogenes') and not(italic[contains(.,'Streptococcus pyogenes')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#psdumerilii-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?dumerilii') and not(italic[contains(.,'P. dumerilii')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#platynereissdumerilii-ref-article-title-check" 
        test="matches($lc,'platynereis\p{Zs}?dumerilii') and not(italic[contains(.,'Platynereis dumerilii')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#pscynocephalus-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?cynocephalus') and not(italic[contains(.,'P. cynocephalus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#papioscynocephalus-ref-article-title-check" 
        test="matches($lc,'papio\p{Zs}?cynocephalus') and not(italic[contains(.,'Papio cynocephalus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#osfasciatus-ref-article-title-check" 
        test="matches($lc,'o\.\p{Zs}?fasciatus') and not(italic[contains(.,'O. fasciatus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#oncopeltussfasciatus-ref-article-title-check" 
        test="matches($lc,'oncopeltus\p{Zs}?fasciatus') and not(italic[contains(.,'Oncopeltus fasciatus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#nscrassa-ref-article-title-check" 
        test="matches($lc,'n\.\p{Zs}?crassa') and not(italic[contains(.,'N. crassa')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#neurosporascrassa-ref-article-title-check" 
        test="matches($lc,'neurospora\p{Zs}?crassa') and not(italic[contains(.,'Neurospora crassa')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#csintestinalis-ref-article-title-check" 
        test="matches($lc,'c\.\p{Zs}?intestinalis') and not(italic[contains(.,'C. intestinalis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#cionasintestinalis-ref-article-title-check" 
        test="matches($lc,'ciona\p{Zs}?intestinalis') and not(italic[contains(.,'Ciona intestinalis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#escuniculi-ref-article-title-check" 
        test="matches($lc,'e\.\p{Zs}?cuniculi') and not(italic[contains(.,'E. cuniculi')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#encephalitozoonscuniculi-ref-article-title-check" 
        test="matches($lc,'encephalitozoon\p{Zs}?cuniculi') and not(italic[contains(.,'Encephalitozoon cuniculi')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#hssalinarum-ref-article-title-check" 
        test="matches($lc,'h\.\p{Zs}?salinarum') and not(italic[contains(.,'H. salinarum')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#halobacteriumssalinarum-ref-article-title-check" 
        test="matches($lc,'halobacterium\p{Zs}?salinarum') and not(italic[contains(.,'Halobacterium salinarum')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#sssolfataricus-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?solfataricus') and not(italic[contains(.,'S. solfataricus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#sulfolobusssolfataricus-ref-article-title-check" 
        test="matches($lc,'sulfolobus\p{Zs}?solfataricus') and not(italic[contains(.,'Sulfolobus solfataricus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ssmediterranea-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?mediterranea') and not(italic[contains(.,'S. mediterranea')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#schmidteasmediterranea-ref-article-title-check" 
        test="matches($lc,'schmidtea\p{Zs}?mediterranea') and not(italic[contains(.,'Schmidtea mediterranea')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ssrosetta-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?rosetta') and not(italic[contains(.,'S. rosetta')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#salpingoecasrosetta-ref-article-title-check" 
        test="matches($lc,'salpingoeca\p{Zs}?rosetta') and not(italic[contains(.,'Salpingoeca rosetta')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#nsvectensis-ref-article-title-check" 
        test="matches($lc,'n\.\p{Zs}?vectensis') and not(italic[contains(.,'N. vectensis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#nematostellasvectensis-ref-article-title-check" 
        test="matches($lc,'nematostella\p{Zs}?vectensis') and not(italic[contains(.,'Nematostella vectensis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ssaureus-ref-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?aureus') and not(italic[contains(.,'S. aureus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#staphylococcussaureus-ref-article-title-check" 
        test="matches($lc,'staphylococcus\p{Zs}?aureus') and not(italic[contains(.,'Staphylococcus aureus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#vscholerae-ref-article-title-check" 
        test="matches($lc,'v\.\p{Zs}?cholerae') and not(italic[contains(.,'V. cholerae')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#vibrioscholerae-ref-article-title-check" 
        test="matches($lc,'vibrio\p{Zs}?cholerae') and not(italic[contains(.,'Vibrio cholerae')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#tsthermophila-ref-article-title-check" 
        test="matches($lc,'t\.\p{Zs}?thermophila') and not(italic[contains(.,'T. thermophila')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#tetrahymenasthermophila-ref-article-title-check" 
        test="matches($lc,'tetrahymena\p{Zs}?thermophila') and not(italic[contains(.,'Tetrahymena thermophila')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#csreinhardtii-ref-article-title-check" 
        test="matches($lc,'c\.\p{Zs}?reinhardtii') and not(italic[contains(.,'C. reinhardtii')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#chlamydomonassreinhardtii-ref-article-title-check" 
        test="matches($lc,'chlamydomonas\p{Zs}?reinhardtii') and not(italic[contains(.,'Chlamydomonas reinhardtii')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#nsattenuata-ref-article-title-check" 
        test="matches($lc,'n\.\p{Zs}?attenuata') and not(italic[contains(.,'N. attenuata')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#nicotianasattenuata-ref-article-title-check" 
        test="matches($lc,'nicotiana\p{Zs}?attenuata') and not(italic[contains(.,'Nicotiana attenuata')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#escarotovora-ref-article-title-check" 
        test="matches($lc,'e\.\p{Zs}?carotovora') and not(italic[contains(.,'E. carotovora')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#erwiniascarotovora-ref-article-title-check" 
        test="matches($lc,'erwinia\p{Zs}?carotovora') and not(italic[contains(.,'Erwinia carotovora')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#esfaecalis-ref-article-title-check" 
        test="matches($lc,'e\.\p{Zs}?faecalis') and not(italic[contains(.,'E. faecalis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#hsapiens-ref-article-title-check" 
        test="matches($lc,'h\.\p{Zs}?sapiens') and not(italic[contains(.,'H. sapiens')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#homosapiens-ref-article-title-check" 
        test="matches($lc,'homo\p{Zs}?sapiens') and not(italic[contains(.,'Homo sapiens')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ctrachomatis-ref-article-title-check" 
        test="matches($lc,'c\.\p{Zs}?trachomatis') and not(italic[contains(.,'C. trachomatis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#chlamydiatrachomatis-ref-article-title-check" 
        test="matches($lc,'chlamydia\p{Zs}?trachomatis') and not(italic[contains(.,'Chlamydia trachomatis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#enterococcussfaecalis-ref-article-title-check" 
        test="matches($lc,'enterococcus\p{Zs}?faecalis') and not(italic[contains(.,'Enterococcus faecalis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#xlaevis-ref-article-title-check" 
        test="matches($lc,'x\.\p{Zs}?laevis') and not(italic[contains(.,'X. laevis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#xenopuslaevis-ref-article-title-check" 
        test="matches($lc,'xenopus\p{Zs}?laevis') and not(italic[contains(.,'Xenopus laevis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#xtropicalis-ref-article-title-check" 
        test="matches($lc,'x\.\p{Zs}?tropicalis') and not(italic[contains(.,'X. tropicalis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#xenopustropicalis-ref-article-title-check" 
        test="matches($lc,'xenopus\p{Zs}?tropicalis') and not(italic[contains(.,'Xenopus tropicalis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#mmusculus-ref-article-title-check" 
        test="matches($lc,'m\.\p{Zs}?musculus') and not(italic[contains(.,'M. musculus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#musmusculus-ref-article-title-check" 
        test="matches($lc,'mus\p{Zs}?musculus') and not(italic[contains(.,'Mus musculus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#dimmigrans-ref-article-title-check" 
        test="matches($lc,'d\.\p{Zs}?immigrans') and not(italic[contains(.,'D. immigrans')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#drosophilaimmigrans-ref-article-title-check" 
        test="matches($lc,'drosophila\p{Zs}?immigrans') and not(italic[contains(.,'Drosophila immigrans')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#dsubobscura-ref-article-title-check" 
        test="matches($lc,'d\.\p{Zs}?subobscura') and not(italic[contains(.,'D. subobscura')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#drosophilasubobscura-ref-article-title-check" 
        test="matches($lc,'drosophila\p{Zs}?subobscura') and not(italic[contains(.,'Drosophila subobscura')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#daffinis-ref-article-title-check" 
        test="matches($lc,'d\.\p{Zs}?affinis') and not(italic[contains(.,'D. affinis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#drosophilaaffinis-ref-article-title-check" 
        test="matches($lc,'drosophila\p{Zs}?affinis') and not(italic[contains(.,'Drosophila affinis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#dobscura-ref-article-title-check" 
        test="matches($lc,'d\.\p{Zs}?obscura') and not(italic[contains(.,'D. obscura')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#drosophilaobscura-ref-article-title-check" 
        test="matches($lc,'drosophila\p{Zs}?obscura') and not(italic[contains(.,'Drosophila obscura')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ftularensis-ref-article-title-check" 
        test="matches($lc,'f\.\p{Zs}?tularensis') and not(italic[contains(.,'F. tularensis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#francisellatularensis-ref-article-title-check" 
        test="matches($lc,'francisella\p{Zs}?tularensis') and not(italic[contains(.,'Francisella tularensis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#pplantaginis-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?plantaginis') and not(italic[contains(.,'P. plantaginis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#podosphaeraplantaginis-ref-article-title-check" 
        test="matches($lc,'podosphaera\p{Zs}?plantaginis') and not(italic[contains(.,'Podosphaera plantaginis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#planceolata-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?lanceolata') and not(italic[contains(.,'P. lanceolata')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#plantagolanceolata-ref-article-title-check" 
        test="matches($lc,'plantago\p{Zs}?lanceolata') and not(italic[contains(.,'Plantago lanceolata')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#mtrossulus-ref-article-title-check" 
        test="matches($lc,'m\.\p{Zs}?trossulus') and not(italic[contains(.,'M. trossulus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#mytilustrossulus-ref-article-title-check" 
        test="matches($lc,'mytilus\p{Zs}?trossulus') and not(italic[contains(.,'Mytilus trossulus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#medulis-ref-article-title-check" 
        test="matches($lc,'m\.\p{Zs}?edulis') and not(italic[contains(.,'M. edulis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#mytilusedulis-ref-article-title-check" 
        test="matches($lc,'mytilus\p{Zs}?edulis') and not(italic[contains(.,'Mytilus edulis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#mchilensis-ref-article-title-check" 
        test="matches($lc,'m\.\p{Zs}?chilensis') and not(italic[contains(.,'M. chilensis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#mytiluschilensis-ref-article-title-check" 
        test="matches($lc,'mytilus\p{Zs}?chilensis') and not(italic[contains(.,'Mytilus chilensis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#umaydis-ref-article-title-check" 
        test="matches($lc,'u\.\p{Zs}?maydis') and not(italic[contains(.,'U. maydis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#ustilagomaydis-ref-article-title-check" 
        test="matches($lc,'ustilago\p{Zs}?maydis') and not(italic[contains(.,'Ustilago maydis')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#pknowlesi-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?knowlesi') and not(italic[contains(.,'P. knowlesi')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#plasmodiumknowlesi-ref-article-title-check" 
        test="matches($lc,'plasmodium\p{Zs}?knowlesi') and not(italic[contains(.,'Plasmodium knowlesi')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#paeruginosa-ref-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?aeruginosa') and not(italic[contains(.,'P. aeruginosa')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#pseudomonasaeruginosa-ref-article-title-check" 
        test="matches($lc,'pseudomonas\p{Zs}?aeruginosa') and not(italic[contains(.,'Pseudomonas aeruginosa')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#tbrucei-ref-article-title-check" 
        test="matches($lc,'t\.\p{Zs}?brucei') and not(italic[contains(.,'T. brucei')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#trypanosomabrucei-ref-article-title-check" 
        test="matches($lc,'trypanosoma\p{Zs}?brucei') and not(italic[contains(.,'Trypanosoma brucei')])" 
        role="info" 
      ...
      <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#tbrucei-ref-article-title-check" 
        test="matches($lc,'t\.\p{Zs}?gondii') and not(italic[contains(.,'T. gondii')])" 
        role="info" 
      ...
      <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#trypanosomabrucei-ref-article-title-check" 
        test="matches($lc,'toxoplasma\p{Zs}?gondii') and not(italic[contains(.,'Toxoplasma gondii')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#drerio-ref-article-title-check" 
        test="matches($lc,'d\.\p{Zs}?rerio') and not(italic[contains(.,'D. rerio')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#daniorerio-ref-article-title-check" 
        test="matches($lc,'danio\p{Zs}?rerio') and not(italic[contains(.,'Danio rerio')])" 
        role="info" 
      ...
      <report test="matches($lc,'yimenosaurus') and not(italic[contains(.,'Yimenosaurus')])" 
        role="info" 
        id="yimenosaurus-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Yimenosaurus' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      
      <report test="matches($lc,'lesothosaurus\p{Zs}?diagnosticus') and not(italic[contains(.,'Lesothosaurus diagnosticus')])" 
        role="info" 
        id="lesothosaurusdiagnosticus-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Lesothosaurus diagnosticus' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'l\.\p{Zs}?diagnosticus') and not(italic[contains(.,'L. diagnosticus')])"
        role="info" 
        id="ldiagnosticus-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'L. diagnosticus' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'scelidosaurus\p{Zs}?harrisonii') and not(italic[contains(.,'Scelidosaurus harrisonii')])" 
        role="info" 
        id="scelidosaurusHarrisonii-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Scelidosaurus harrisonii' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'s\.\p{Zs}?harrisonii') and not(italic[contains(.,'S. harrisonii')])" 
        role="info" 
        id="sharrisonii-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'S. harrisonii' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'haya\p{Zs}?griva') and not(italic[contains(.,'Haya griva')])" 
        role="info" 
        id="hayagriva-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Haya griva' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'h\.\p{Zs}?griva') and not(italic[contains(.,'H. griva')])" 
        role="info" 
        id="hgriva-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'H. griva' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'polacanthus\p{Zs}?foxii') and not(italic[contains(.,'Polacanthus foxii')])" 
        role="info" 
        id="polacanthusfoxii-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Polacanthus foxii' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'p\.\p{Zs}?foxii') and not(italic[contains(.,'P. foxii')])" 
        role="info" 
        id="pfoxii-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'P. foxii' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'scutellosaurus\p{Zs}?lawleri') and not(italic[contains(.,'Scutellosaurus lawleri')])" 
        role="info" 
        id="scutellosaurusLawleri-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Scutellosaurus lawleri' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'s\.\p{Zs}?lawleri') and not(italic[contains(.,'S. lawleri')])" 
        role="info" 
        id="slawleri-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'S. lawleri' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      
      <report test="matches($lc,'saichania\p{Zs}?chulsanensis') and not(italic[contains(.,'Saichania chulsanensis')])" 
        role="info" 
        id="saichaniachulsanensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Saichania chulsanensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'s\.\p{Zs}?chulsanensis') and not(italic[contains(.,'S. chulsanensis')])" 
        role="info" 
        id="schulsanensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'S. chulsanensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      
      <report test="matches($lc,'gargoyleosaurus\p{Zs}?parkpinorum') and not(italic[contains(.,'Gargoyleosaurus parkpinorum')])" 
        role="info" 
        id="gargoyleosaurusparkpinorum-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Gargoyleosaurus parkpinorum' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'g\.\p{Zs}?parkpinorum') and not(italic[contains(.,'G. parkpinorum')])" 
        role="info" 
        id="gparkpinorum-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'G. parkpinorum' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'europelta\p{Zs}?carbonensis') and not(italic[contains(.,'Europelta carbonensis')])" 
        role="info" 
        id="europeltacarbonensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Europelta carbonensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'e\.\p{Zs}?carbonensis') and not(italic[contains(.,'E. carbonensis')])" 
        role="info" 
        id="ecarbonensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'E. carbonensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      
      <report test="matches($lc,'stegosaurus\p{Zs}?stenops') and not(italic[contains(.,'Stegosaurus stenops')])" 
        role="info" 
        id="stegosaurusstenops-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Stegosaurus stenops' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report test="matches($lc,'pinacosaurus\p{Zs}?grangeri') and not(italic[contains(.,'Pinacosaurus grangeri')])" 
        role="info" 
        id="pinacosaurusgrangeri-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Pinacosaurus grangeri' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'p\.\p{Zs}?grangeri') and not(italic[contains(.,'P. grangeri')])" 
        role="info" 
        id="pgrangeri-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'P. grangeri' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      
      <report test="matches($lc,'tatisaurus\p{Zs}?oehleri') and not(italic[contains(.,'Tatisaurus oehleri')])" 
        role="info" 
        id="tatisaurusoehleri-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Tatisaurus oehleri' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'t\.\p{Zs}?oehleri') and not(italic[contains(.,'T. oehleri')])" 
        role="info" 
        id="toehleri-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'T. oehleri' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'hungarosaurus\p{Zs}?tormai') and not(italic[contains(.,'Hungarosaurus tormai')])" 
        role="info" 
        id="Hungarosaurustormai-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Hungarosaurus tormai' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'h\.\p{Zs}?tormai') and not(italic[contains(.,'H. tormai')])" 
        role="info" 
        id="htormai-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'H. tormai' - but there is no italic element with that correct capitalisation or spacing.</report>  
      
      <report test="matches($lc,'bienosaurus\p{Zs}?lufengensis') and not(italic[contains(.,'Bienosaurus lufengensis')])" 
        role="info" 
        id="bienosauruslufengensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Bienosaurus lufengensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'b\.\p{Zs}?lufengensis') and not(italic[contains(.,'B. lufengensis')])" 
        role="info" 
        id="blufengensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'B. lufengensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'fabrosaurus\p{Zs}?australis') and not(italic[contains(.,'Fabrosaurus australis')])" 
        role="info" 
        id="fabrosaurusaustralis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Fabrosaurus australis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'f\.\p{Zs}?australis') and not(italic[contains(.,'F. australis')])" 
        role="info" 
        id="faustralis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'F. australis' - but there is no italic element with that correct capitalisation or spacing.</report>     
      
      <report test="matches($lc,'chinshakiangosaurus\p{Zs}?chunghoensis') and not(italic[contains(.,'Chinshakiangosaurus chunghoensis')])" 
        role="info" 
        id="chinshakiangosauruschunghoensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Chinshakiangosaurus chunghoensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'c\.\p{Zs}?chunghoensis') and not(italic[contains(.,'C. chunghoensis')])" 
        role="info" 
        id="cchunghoensis-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'C. chunghoensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'euoplocephalus\p{Zs}?tutus') and not(italic[contains(.,'Euoplocephalus tutus')])" 
        role="info" 
        id="euoplocephalustutus-ref-article-title-check">ref <value-of select="ancestor::ref/@id"/> references an organism - 'Euoplocephalus tutus' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'e\.\p{Zs}?tutus') and not(italic[contains(.,'E. tutus')])" 
        role="info" 
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#xenopus-ref-article-title-check" 
        test="matches($lc,'xenopus') and not(italic[contains(.,'Xenopus')])" 
        role="info" 
    ...
    <rule context="article//article-meta/title-group/article-title | article/body//sec/title | article//article-meta//kwd" id="org-title-kwd">		
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-yimenosaurus-article-title-check" 
        test="matches($lc,'yimenosaurus') and not(italic[contains(.,'Yimenosaurus')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-scelidosaurusharrisonii-article-title-check" 
        test="matches($lc,'scelidosaurus\p{Zs}?harrisonii') and not(italic[contains(.,'Scelidosaurus harrisonii')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sharrisonii-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?harrisonii') and not(italic[contains(.,'S. harrisonii')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hayagriva-article-title-check" 
        test="matches($lc,'haya\p{Zs}?griva') and not(italic[contains(.,'Haya griva')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hgriva-article-title-check" 
        test="matches($lc,'h\.\p{Zs}?griva') and not(italic[contains(.,'H. griva')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-polacanthusfoxii-article-title-check" 
        test="matches($lc,'polacanthus\p{Zs}?foxii') and not(italic[contains(.,'Polacanthus foxii')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pfoxii-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?foxii') and not(italic[contains(.,'P. foxii')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-scutellosauruslawleri-article-title-check" 
        test="matches($lc,'scutellosaurus\p{Zs}?lawleri') and not(italic[contains(.,'Scutellosaurus lawleri')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-slawleri-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?lawleri') and not(italic[contains(.,'S. lawleri')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-saichaniachulsanensis-article-title-check" 
        test="matches($lc,'saichania\p{Zs}?chulsanensis') and not(italic[contains(.,'Saichania chulsanensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-schulsanensis-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?chulsanensis') and not(italic[contains(.,'S. chulsanensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-gargoyleosaurusparkpinorum-article-title-check" 
        test="matches($lc,'gargoyleosaurus\p{Zs}?parkpinorum') and not(italic[contains(.,'Gargoyleosaurus parkpinorum')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-gparkpinorum-article-title-check" 
        test="matches($lc,'g\.\p{Zs}?parkpinorum') and not(italic[contains(.,'G. parkpinorum')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-europeltacarbonensis-article-title-check" 
        test="matches($lc,'europelta\p{Zs}?carbonensis') and not(italic[contains(.,'Europelta carbonensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ecarbonensis-article-title-check" 
        test="matches($lc,'e\.\p{Zs}?carbonensis') and not(italic[contains(.,'E. carbonensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-stegosaurusstenops-article-title-check" 
        test="matches($lc,'stegosaurus\p{Zs}?stenops') and not(italic[contains(.,'Stegosaurus stenops')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sstenops-article-title-check" 
        test="matches($lc,'s\.\p{Zs}?stenops') and not(italic[contains(.,'S. stenops')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pinacosaurusgrangeri-article-title-check" 
        test="matches($lc,'pinacosaurus\p{Zs}?grangeri') and not(italic[contains(.,'Pinacosaurus grangeri')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pgrangeri-article-title-check" 
        test="matches($lc,'p\.\p{Zs}?grangeri') and not(italic[contains(.,'P. grangeri')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-tatisaurusoehleri-article-title-check" 
        test="matches($lc,'tatisaurus\p{Zs}?oehleri') and not(italic[contains(.,'Tatisaurus oehleri')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-toehleri-article-title-check" 
        test="matches($lc,'t\.\p{Zs}?oehleri') and not(italic[contains(.,'T. oehleri')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hungarosaurustormai-article-title-check" 
        test="matches($lc,'hungarosaurus\p{Zs}?tormai') and not(italic[contains(.,'Hungarosaurus tormai')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-htormai-article-title-check" 
        test="matches($lc,'h\.\p{Zs}?tormai') and not(italic[contains(.,'H. tormai')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-lesothosaurusdiagnosticus-article-title-check" 
        test="matches($lc,'lesothosaurus\p{Zs}?diagnosticus') and not(italic[contains(.,'Lesothosaurus diagnosticus')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ldiagnosticus-article-title-check" 
        test="matches($lc,'l\.\p{Zs}?diagnosticus') and not(italic[contains(.,'L. diagnosticus')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-bienosauruslufengensis-article-title-check" 
        test="matches($lc,'bienosaurus\p{Zs}?lufengensis') and not(italic[contains(.,'Bienosaurus lufengensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-blufengensis-article-title-check" 
        test="matches($lc,'b\.\p{Zs}?lufengensis') and not(italic[contains(.,'B. lufengensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-fabrosaurusaustralis-article-title-check" 
        test="matches($lc,'fabrosaurus\p{Zs}?australis') and not(italic[contains(.,'Fabrosaurus australis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-faustralis-article-title-check" 
        test="matches($lc,'f\.\p{Zs}?australis') and not(italic[contains(.,'F. australis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-chinshakiangosauruschunghoensis-article-title-check" 
        test="matches($lc,'chinshakiangosaurus\p{Zs}?chunghoensis') and not(italic[contains(.,'Chinshakiangosaurus chunghoensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-cchunghoensis-article-title-check" 
        test="matches($lc,'c\.\p{Zs}?chunghoensis') and not(italic[contains(.,'C. chunghoensis')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-euoplocephalustutus-article-title-check" 
        test="matches($lc,'euoplocephalus\p{Zs}?tutus') and not(italic[contains(.,'Euoplocephalus tutus')])" 
        role="warning" 
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-etutus-article-title-check" 
        test="matches($lc,'e\.\p{Zs}?tutus') and not(italic[contains(.,'E. tutus')])" 
        role="warning" 
  ...
  <pattern id="house-style">
    ...
    <rule context="front//aff//named-content[@content-type='city']" id="city-tests">
      ...
      <report test="matches(lower-case(.),'^rue | rue |^street | street |^building | building |^straße | straße |^stadt | stadt |^platz | platz |^strada | strada |^cedex | cedex |^blvd | blvd |^boulevard| boulevard ')" 
        role="warning" 
