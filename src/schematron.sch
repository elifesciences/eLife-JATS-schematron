  ...
  <pattern
    ...
    <rule context="tr" 
      ...
      <report test="td and (parent::thead)"
        role="warning"
        id="tr-test-3">table row in header contains a td element (table data), which is unusual. Please check that this is correct.</report>
    </rule>
  ...
  <pattern
    ...
    <rule context="element-citation[@publication-type='journal']/source" id="journal-title-tests">
      ...
      <report test="contains($uc,'HANDBOOK')"
        role="error" 
        id="handbook-presence">Journal ref '<value-of select="ancestor::ref/@id"/>' has a journal title '<value-of select="."/>'. Should it be captured as a book type reference instead?</report>
    </rule>
    ...
    <rule context="element-citation[@publication-type='preprint']/source" 
      ...
      <report test="contains(.,'handbook')"
        role="error"
        id="preprint-handbook-presence">Preprint ref '<value-of select="ancestor::ref/@id"/>' has a journal title '<value-of select="."/>'. Should it be captured as a book type reference instead?</report>
    </rule>
