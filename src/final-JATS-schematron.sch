 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="elem-citation-ext-link-pattern">
    <rule context="ref/element-citation/ext-link" id="elem-citation-ext-link">
      ...
      <assert test="matches(@xlink:href,'^https?://|^s?ftp://')" role="error" id="link-href-conformance">[link-href-conformance] @xlink:href must start with either "http://", "https://", "sftp://" or "ftp://". The &lt;ext-link&gt; element in Reference '<value-of select="ancestor::ref/@id"/>' is '<value-of select="@xlink:href"/>', which does not.</assert>
  ...
  <pattern id="pub-id-tests-pattern">
    <rule context="element-citation/pub-id" id="pub-id-tests">
      ...
      <report test="(@xlink:href) and not(matches(@xlink:href,'^http[s]?://|^s?ftp://'))" role="error" id="final-pub-id-test-1">[final-pub-id-test-1] @xlink:href must start with an http:// or ftp:// protocol. - <value-of select="@xlink:href"/> does not.</report>
