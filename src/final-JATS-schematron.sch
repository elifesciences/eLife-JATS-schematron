 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="disp-quote-tests-pattern">
    <rule context="disp-quote" id="disp-quote-tests">
      ...
      <assert test="ancestor::sub-article[@article-type=('reply','author-comment')]" role="warning" flag="dl-ar" id="disp-quote-test-1">[disp-quote-test-1] Content is tagged as a display quote, which is almost definitely incorrect, since it's not within an author response - <value-of select="."/>
      </assert>
  ...
  <pattern id="ed-report-evidence-kwds-pattern">
    <rule context="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" id="ed-report-evidence-kwds">
      ...
      <report test=".='Inadequate'" role="error" flag="dl-ar" id="ed-report-evidence-kwd-2">[ed-report-evidence-kwd-2] This article is deemed inadequate. Exeter contact eLife immediately. eLife place this article on hold and DO NOT let it proceed.</report>
    </rule>
  </pattern>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="org-ref-article-book-title-pattern">
    ...
    <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#xenopus-ref-article-title-check" test="matches($lc,'xenopus') and not(italic[contains(.,'Xenopus')])" role="info" id="xenopus-ref-article-title-check">[xenopus-ref-article-title-check] ref <value-of select="ancestor::ref/@id"/> references an organism - 'Xenopus' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report test="matches($lc,'salmonella') and not(italic[contains(.,'Salmonella')])" role="info" id="salmonella-ref-article-title-check">[salmonella-ref-article-title-check] ref <value-of select="ancestor::ref/@id"/> references an organism - 'Salmonella' - but there is no italic element with that correct capitalisation or spacing.</report>
  ...
  <pattern id="org-title-kwd-pattern">
    <rule context="article//article-meta/title-group/article-title | article/body//sec/title | article//article-meta//kwd" id="org-title-kwd">		
      ...
      <report test="matches($lc,'salmonella') and not(italic[contains(.,'Salmonella')])" role="warning" id="salmonella-article-title-check">[salmonella-article-title-check] <name/> contains an organism - 'Salmonella' - but there is no italic element with that correct capitalisation or spacing.</report>
