 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="institution-id-tests-pattern">
    <rule context="institution-wrap/institution-id" id="institution-id-tests">
      ...
      <assert test="@institution-id-type='FundRef'" role="error" id="institution-id-test-2">[institution-id-test-2] <name/> element must have the attribute institution-id-type="FundRef". More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/funding-information#institution-id-test-2</assert>
      
      <assert test="normalize-space(.) != ''" role="error" id="institution-id-test-3">[institution-id-test-3] The funding entry for <value-of select="parent::institution-wrap/institution"/> has an empty <name/> element, which is not allowed. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/funding-information#institution-id-test-3</assert>
      
        <report test="*" role="error" id="institution-id-test-4">[institution-id-test-4] The <name/> element in funding entry for <value-of select="parent::institution-wrap/institution"/> contains child element(s) (<value-of select="string-join(distinct-values(*/name()),', ')"/>) which is not allowed. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/funding-information#institution-id-test-4</report>
      
      <report test="(normalize-space(.) != '') and not(matches(.,'^http[s]?://d?x?\.?doi.org/10.13039/\d*$'))" role="error" id="institution-id-test-5">[institution-id-test-5] <name/> element in funding entry for <value-of select="parent::institution-wrap/institution"/> contains the following text - <value-of select="."/> - which is not a fundref doi. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/funding-information#institution-id-test-5</report>
  ...
  <pattern id="par-name-tests-pattern">
    <rule context="funding-group//principal-award-recipient/name" id="par-name-tests">
      ...
      <report test="contains(.,'.')" role="error" id="par-name-test-1">[par-name-test-1] Author name in funding entry contains a full stop - <value-of select="e:get-name(.)"/>. Please remove the full stop.  More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/funding-information#par-name-test-1</report>
  ...
  <pattern id="fig-group-child-tests-pattern">
    <rule context="fig-group/*" id="fig-group-child-tests">
      ...
      <assert test="local-name() = ('fig','media')" role="error" id="fig-group-child-test-1">[fig-group-child-test-1] <name/> is not allowed as a child of fig-group. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-group-child-test-1</assert>
      
      <report test="(local-name() = 'media') and not(@mimetype='video')" role="error" id="fig-group-child-test-2">[fig-group-child-test-2] <name/> which is a child of fig-group, must have an @mimetype='video' - i.e. only video type media is allowed as a child of fig-group. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-group-child-test-2</report>
  ...
  <pattern id="fig-tests-pattern">
    <rule context="fig[not(ancestor::sub-article)]" id="fig-tests">
      ...
      <assert test="@position" role="error" id="fig-test-2">[fig-test-2] fig must have a @position. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-test-2</assert>
      ...
      <assert test="graphic" role="error" id="final-fig-test-7">[final-fig-test-7] fig must have a graphic. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#final-fig-test-7</assert>
    </rule>
  </pattern>
  <pattern id="ar-fig-tests-pattern">
    <rule context="fig[ancestor::sub-article[@article-type='reply']]" id="ar-fig-tests">
      ...
      <assert test="graphic" role="error" id="final-ar-fig-test-3">[final-ar-fig-test-3] Author Response fig must have a graphic. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#final-ar-fig-test-3</assert>
  ...
  <pattern id="table-cell-tests-pattern">
    <rule context="table-wrap/table/tbody/tr/*[xref[@ref-type='bibr'] and matches(.,'[\(\)\[\]]')]|table-wrap/table/thead/tr/*[xref[@ref-type='bibr'] and matches(.,'[\(\)\[\]]')]" id="table-cell-tests">
      ...
      <assert test="matches($stripped-text,'[\p{N}\p{L}]')" role="warning" id="table-cell-1">[table-cell-1] Table cell in <value-of select="replace(ancestor::table-wrap[1]/label[1],'\.$','')"/> contains '<value-of select="."/>'. Are the brackets around the citation(s) unnecessary? More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/funding-information#table-cell-1</assert>
  ...
  <pattern id="fig-specific-tests-pattern">
    <rule context="article/body//fig[not(@specific-use='child-fig')][not(ancestor::boxed-text)]" id="fig-specific-tests">
      ...
      <report test="label[contains(lower-case(.),'supplement')]" role="error" id="fig-specific-test-1">[fig-specific-test-1] fig label contains 'supplement', but it does not have a @specific-use='child-fig'. If it is a figure supplement it needs the attribute, if it isn't then it cannot contain 'supplement' in the label. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-specific-test-1</report>
      ...
      <report test="($fol-sib/local-name() = 'p') and ($fol-sib/*/local-name() = 'disp-formula') and (count($fol-sib/*[1]/preceding-sibling::text()) = 0) and (not(matches($pre-sib,'\.\s*?$|\?\s*?$|!\s*?$')))" role="warning" id="fig-specific-test-6">[fig-specific-test-6] <value-of select="$lab"/> is immediately followed by a display formula, and preceded by a paragraph which does not end with punctuation. Should it should be moved after the display formula or after the para following the display formula? More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-specific-test-6</report>
      
      <report test="($fol-sib/local-name() = 'disp-formula') and (not(matches($pre-sib,'\.\s*?$|\?\s*?$|!\s*?$')))" role="warning" id="fig-specific-test-5">[fig-specific-test-5] <value-of select="$lab"/> is immediately followed by a display formula, and preceded by a paragraph which does not end with punctuation. Should it should be moved after the display formula or after the para following the display formula? More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-specific-test-5</report>
  ...
  <pattern id="fig-sup-tests-pattern">
    <rule context="article/body//fig[@specific-use='child-fig']" id="fig-sup-tests">
      ...
      <assert test="parent::fig-group" role="error" id="fig-sup-test-1">[fig-sup-test-1] fig supplement is not a child of fig-group. This cannot be correct. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-sup-test-1</assert>
      
      <assert test="$label-conform = true()" role="error" id="fig-sup-test-2">[fig-sup-test-2] fig in the body of the article which has a @specific-use='child-fig' must have a label in the format 'Figure 0—figure supplement 0.' (where 0 is one or more digits). More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-sup-test-2</assert>
      
      <assert test="starts-with(label[1],concat('Figure ',$parent-fig-no))" role="error" id="fig-sup-test-3">[fig-sup-test-3] <value-of select="label"/> does not start with the main figure number it is associated with - <value-of select="concat('Figure ',$parent-fig-no)"/>. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-sup-test-3</assert>
      ...
      <report test="($label-conform = true()) and ($no != $label-no)" role="error" id="fig-sup-test-6">[fig-sup-test-6] <value-of select="label"/> label ends with <value-of select="$label-no"/>, but the id (<value-of select="@id"/>) ends with <value-of select="$no"/>, so one must be incorrect. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-sup-test-6</report>
  ...
  <pattern id="rep-fig-tests-pattern">
    <rule context="sub-article[@article-type='reply']//fig" id="rep-fig-tests">
      ...
      <assert test="label" role="error" id="resp-fig-test-2">[resp-fig-test-2] fig must have a label. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#resp-fig-test-2</assert>
  ...
  <pattern id="dec-fig-tests-pattern">
    <rule context="sub-article[@article-type='decision-letter']//fig" id="dec-fig-tests">
      ...
      <assert test="label" role="error" id="dec-fig-test-1">[dec-fig-test-1] fig must have a label. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#dec-fig-test-1</assert>
  ...
  <pattern id="fig-title-tests-pattern">
    <rule context="fig/caption/title" id="fig-title-tests"> 
      ...
      <report test="matches(.,'^\([A-Za-z]|^[A-Za-z]\)')" role="warning" id="fig-title-test-1">[fig-title-test-1] '<value-of select="$label"/>' appears to have a title which is the beginning of a caption. Is this correct? More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-title-test-1</report>
      
      <assert test="matches(replace(.,'&quot;',''),'\.$|\?$')" role="error" id="fig-title-test-2">[fig-title-test-2] title for <value-of select="$label"/> must end with a full stop. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-title-test-2</assert>
      
      <report test="matches(.,' vs\.$')" role="warning" id="fig-title-test-3">[fig-title-test-3] title for <value-of select="$label"/> ends with 'vs.', which indicates that the title sentence may be split across title and caption. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-title-test-3</report>
      
      <report test="matches(.,'^\s')" role="error" id="fig-title-test-4">[fig-title-test-4] title for <value-of select="$label"/> begins with a space, which is not allowed. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-title-test-4</report>
      
      <report test="matches(.,'^\p{P}')" role="warning" id="fig-title-test-5">[fig-title-test-5] title for <value-of select="$label"/> begins with punctuation. Is this correct? - <value-of select="."/> More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-title-test-5</report>
      
      <report test="matches(.,'^[Pp]anel ')" role="warning" id="fig-title-test-6">[fig-title-test-6] title for <value-of select="$label"/> begins with '<value-of select="substring-before(.,' ')"/>' - <value-of select="."/>. It is very likely that this requires an overall title instead. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-title-test-6</report>
    </rule>
  </pattern>
  ...
  <pattern id="reply-title-tests-pattern">
    <rule context="sub-article[@article-type='reply']/front-stub/title-group" id="reply-title-tests">
      <assert test="article-title = 'Author response'" role="error" id="reply-title-test">[reply-title-test] title-group must contain article-title which contains 'Author response'. Currently it is <value-of select="article-title"/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#reply-title-test</assert>
  ...
  <pattern id="box-fig-ids-pattern">
    <rule context="article/body//boxed-text//fig[not(@specific-use='child-fig')]" id="box-fig-ids">
      ...
      <assert test="matches(@id,'^box[0-9]{1,3}fig[0-9]{1,3}$')" role="error" id="box-fig-id-1">[box-fig-id-1] fig must have @id in the format box0fig0. <value-of select="@id"/> does not conform to this. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#box-fig-id-1</assert>
      
      <assert test="contains(@id,$box-id)" role="error" id="box-fig-id-2">[box-fig-id-2] fig id (<value-of select="@id"/>) does not contain its ancestor boxed-text id. Please ensure the first part of the id contains '<value-of select="$box-id"/>'. More information here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#box-fig-id-2</assert>
    </rule>
  </pattern>
  ...
  <pattern id="dec-letter-reply-tests-pattern">
    <rule context="article/sub-article" id="dec-letter-reply-tests">
      ...
      <assert test="@id = concat('sa',$pos)" role="error" id="dec-letter-reply-test-2">[dec-letter-reply-test-2] sub-article id must be in the format 'sa0', where '0' is its position (1 or 2). More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reply-test-2</assert>
      
      <assert test="count(front-stub) = 1" role="error" id="dec-letter-reply-test-3">[dec-letter-reply-test-3] sub-article must contain one and only one front-stub. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reply-test-3</assert>
      
      <assert test="count(body) = 1" role="error" id="dec-letter-reply-test-4">[dec-letter-reply-test-4] sub-article must contain one and only one body. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reply-test-4</assert>
  ...
  <pattern id="dec-letter-front-tests-pattern">
    <rule context="sub-article[@article-type='decision-letter']/front-stub" id="dec-letter-front-tests">
      ...
      <assert test="count(article-id[@pub-id-type='doi']) = 1" role="error" id="dec-letter-front-test-1">[dec-letter-front-test-1] sub-article front-stub must contain article-id[@pub-id-type='doi']. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-front-test-1</assert>
      
      <assert test="$count gt 0" role="error" id="dec-letter-front-test-2">[dec-letter-front-test-2] decision letter front-stub must contain at least 1 contrib-group element. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-front-test-2</assert>
      
      <report test="$count gt 2" role="error" id="dec-letter-front-test-3">[dec-letter-front-test-3] decision letter front-stub contains more than 2 contrib-group elements. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-front-test-3</report>
  ...
  <pattern id="dec-letter-editor-tests-pattern">
    <rule context="sub-article[@article-type='decision-letter']/front-stub/contrib-group[1]" id="dec-letter-editor-tests">
      ...
      <assert test="count(contrib[@contrib-type='editor']) = 1" role="warning" id="dec-letter-editor-test-1">[dec-letter-editor-test-1] First contrib-group in decision letter must contain 1 and only 1 editor (contrib[@contrib-type='editor']). More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-editor-test-1</assert>
  ...
  <pattern id="dec-letter-reviewer-tests-pattern">
    <rule context="sub-article[@article-type='decision-letter']/front-stub/contrib-group[2]" id="dec-letter-reviewer-tests">
      ...
      <assert test="count(contrib[@contrib-type='reviewer']) gt 0" role="error" id="dec-letter-reviewer-test-1">[dec-letter-reviewer-test-1] Second contrib-group in decision letter must contain a reviewer (contrib[@contrib-type='reviewer']). More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reviewer-test-1</assert>
      ...
      <report test="count(contrib[@contrib-type='reviewer']) gt 5" role="warning" id="dec-letter-reviewer-test-6">[dec-letter-reviewer-test-6] Second contrib-group in decision letter contains more than five reviewers. Is this correct? Exeter: Please check with eLife. eLife: check eJP to ensure this is correct. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reviewer-test-6</report>
    </rule>
  </pattern>
  ...
  <pattern id="dec-letter-body-tests-pattern">
    <rule context="sub-article[@article-type='decision-letter']/body" id="dec-letter-body-tests">
      ...
      <assert test="child::*[1]/local-name() = 'boxed-text'" role="error" id="dec-letter-body-test-1">[dec-letter-body-test-1] First child element in decision letter is not boxed-text. This is certainly incorrect. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-body-test-1</assert>
    </rule>
  </pattern>
  ...
  <pattern id="reply-front-tests-pattern">
    <rule context="sub-article[@article-type='reply']/front-stub" id="reply-front-tests">
      ...
      <assert test="count(article-id[@pub-id-type='doi']) = 1" role="error" id="reply-front-test-1">[reply-front-test-1] sub-article front-stub must contain article-id[@pub-id-type='doi']. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#reply-front-test-1</assert>
    </rule>
  </pattern>
  <pattern id="reply-body-tests-pattern">
    <rule context="sub-article[@article-type='reply']/body" id="reply-body-tests">
      
      <report test="count(disp-quote[@content-type='editor-comment']) = 0" role="error" id="reply-body-test-1">[reply-body-test-1] author response doesn't contain a disp-quote. This has to be incorrect. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#reply-body-test-1</report>
      
      <report test="count(p) = 0" role="error" id="reply-body-test-2">[reply-body-test-2] author response doesn't contain a p. This has to be incorrect. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#reply-body-test-2</report>
    </rule>
  </pattern>
  ...
  <pattern id="reply-missing-disp-quote-tests-pattern">
    <rule context="sub-article[@article-type='reply']/body//p[not(ancestor::disp-quote)]" id="reply-missing-disp-quote-tests">
      ...
      <report test="(count(*)=1) and (child::italic) and ($free-text='')" role="warning" id="reply-missing-disp-quote-test-1">[reply-missing-disp-quote-test-1] para in author response is entirely in italics, but not in a display quote. Is this a quote which has been processed incorrectly? More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#reply-missing-disp-quote-test-1</report>
    </rule>
  </pattern>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="unicode-tests-pattern">
    <rule context="sub-article//p[contains(.,'â') or contains(.,'Â') or contains(.,'Å') or contains(.,'Ã')  or contains(.,'Ë')  or contains(.,'Æ')]|       sub-article//td[contains(.,'â') or contains(.,'Â') or contains(.,'Å') or contains(.,'Ã')  or contains(.,'Ë')  or contains(.,'Æ')]|       sub-article//th[contains(.,'â') or contains(.,'Â') or contains(.,'Å') or contains(.,'Ã')  or contains(.,'Ë')  or contains(.,'Æ')]" id="unicode-tests">
        ...
        <report test="contains(.,'â‚¬')" role="warning" id="unicode-test-1">[unicode-test-1] <name/> element contains 'â‚¬' - this should instead be the character '€'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-1</report>

        <report test="contains(.,'Ã€')" role="warning" id="unicode-test-2">[unicode-test-2] <name/> element contains 'Ã€' - this should instead be the character 'À'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-2</report>

        <report test="contains(.,'Ã')" role="warning" id="unicode-test-3">[unicode-test-3] <name/> element contains 'Ã' - this should instead be the character 'Á'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-3</report>

        <report test="contains(.,'â€š')" role="warning" id="unicode-test-4">[unicode-test-4] <name/> element contains 'â€š' - this should instead be the character '‚'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-4</report>

        <report test="contains(.,'Ã‚')" role="warning" id="unicode-test-5">[unicode-test-5] <name/> element contains 'Ã‚' - this should instead be the character 'Â'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-5</report>

        <report test="contains(.,'Æ’')" role="warning" id="unicode-test-6">[unicode-test-6] <name/> element contains 'Æ’' - this should instead be the character 'ƒ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-6</report>

        <report test="contains(.,'Ãƒ')" role="warning" id="unicode-test-7">[unicode-test-7] <name/> element contains 'Ãƒ' - this should instead be the character 'Ã'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-7</report>

        <report test="contains(.,'â€ž')" role="warning" id="unicode-test-8">[unicode-test-8] <name/> element contains 'â€ž' - this should instead be the character '„'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-8</report>

        <report test="contains(.,'Ã„')" role="warning" id="unicode-test-9">[unicode-test-9] <name/> element contains 'Ã„' - this should instead be the character 'Ä'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-9</report>

        <report test="contains(.,'â€¦')" role="warning" id="unicode-test-10">[unicode-test-10] <name/> element contains 'â€¦' - this should instead be the character '…'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-10</report>

        <report test="contains(.,'Ã…')" role="warning" id="unicode-test-11">[unicode-test-11] <name/> element contains 'Ã…' - this should instead be the character 'Å'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-11</report>

        <report test="contains(.,'Ã†')" role="warning" id="unicode-test-13">[unicode-test-13] <name/> element contains 'Ã†' - this should instead be the character 'Æ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-13</report>

        <report test="contains(.,'â€¡')" role="warning" id="unicode-test-14">[unicode-test-14] <name/> element contains 'â€¡' - this should instead be the character '‡'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-14</report>

        <report test="contains(.,'Ã‡')" role="warning" id="unicode-test-15">[unicode-test-15] <name/> element contains 'Ã‡' - this should instead be the character 'Ç'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-15</report>

        <report test="contains(.,'Ë†')" role="warning" id="unicode-test-16">[unicode-test-16] <name/> element contains 'Ë†' - this should instead be the character 'ˆ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-16</report>

        <report test="contains(.,'Ãˆ')" role="warning" id="unicode-test-17">[unicode-test-17] <name/> element contains 'Ãˆ' - this should instead be the character 'È'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-17</report>

        <report test="contains(.,'â€°')" role="warning" id="unicode-test-18">[unicode-test-18] <name/> element contains 'â€°' - this should instead be the character '‰'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-18</report>

        <report test="contains(.,'Ã‰')" role="warning" id="unicode-test-19">[unicode-test-19] <name/> element contains 'Ã‰' - this should instead be the character 'É'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-19</report>

        <report test="contains(.,'ÃŠ')" role="warning" id="unicode-test-21">[unicode-test-21] <name/> element contains 'ÃŠ' - this should instead be the character 'Ê'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-21</report>

        <report test="contains(.,'â€¹')" role="warning" id="unicode-test-22">[unicode-test-22] <name/> element contains 'â€¹' - this should instead be the character '‹'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-22</report>

        <report test="contains(.,'Ã‹')" role="warning" id="unicode-test-23">[unicode-test-23] <name/> element contains 'Ã‹' - this should instead be the character 'Ë'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-23</report>

        <report test="contains(.,'Å’')" role="warning" id="unicode-test-24">[unicode-test-24] <name/> element contains 'Å’' - should this instead be the character 'Œ'? - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-24</report>

        <report test="contains(.,'ÃŒ')" role="warning" id="unicode-test-25">[unicode-test-25] <name/> element contains 'ÃŒ' - this should instead be the character 'Ì'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-25</report>

        <report test="contains(.,'Ã')" role="warning" id="unicode-test-26">[unicode-test-26] <name/> element contains 'Ã' - this should instead be the character 'Í'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-26</report>

        <report test="contains(.,'Å½')" role="warning" id="unicode-test-27">[unicode-test-27] <name/> element contains 'Å½' - this should instead be the character 'Ž'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-27</report>

        <report test="contains(.,'ÃŽ')" role="warning" id="unicode-test-28">[unicode-test-28] <name/> element contains 'ÃŽ' - this should instead be the character 'Î'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-28</report>

        <report test="contains(.,'Ã')" role="warning" id="unicode-test-29">[unicode-test-29] <name/> element contains 'Ã' - this should instead be the character 'Ï'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-29</report>

        <report test="contains(.,'Ã')" role="warning" id="unicode-test-30">[unicode-test-30] <name/> element contains 'Ã' - this should instead be the character 'Ð'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-30</report>

        <report test="contains(.,'â€˜')" role="warning" id="unicode-test-31">[unicode-test-31] <name/> element contains 'â€˜' - this should instead be the character '‘'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-31</report>

        <report test="contains(.,'Ã‘')" role="warning" id="unicode-test-32">[unicode-test-32] <name/> element contains 'Ã‘' - this should instead be the character 'Ñ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-32</report>

        <report test="contains(.,'â€™')" role="warning" id="unicode-test-33">[unicode-test-33] <name/> element contains 'â€™' - this should instead be the character '’'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-33</report>

        <report test="contains(.,'Ã’')" role="warning" id="unicode-test-34">[unicode-test-34] <name/> element contains 'Ã’' - this should instead be the character 'Ò'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-34</report>

        <report test="contains(.,'â€œ')" role="warning" id="unicode-test-35">[unicode-test-35] <name/> element contains 'â€œ' - this should instead be the character '“'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-35</report>

        <report test="contains(.,'Ã“')" role="warning" id="unicode-test-36">[unicode-test-36] <name/> element contains 'Ã“' - this should instead be the character 'Ó'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-36</report>

        <report test="contains(.,'â€')" role="warning" id="unicode-test-37">[unicode-test-37] <name/> element contains 'â€' - this should instead be the character '”'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-37</report>

        <report test="contains(.,'Ã”')" role="warning" id="unicode-test-38">[unicode-test-38] <name/> element contains 'Ã”' - this should instead be the character 'Ô'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-38</report>

        <report test="contains(.,'Ã•')" role="warning" id="unicode-test-39">[unicode-test-39] <name/> element contains 'Ã•' - this should instead be the character 'Õ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-39</report>

        <report test="contains(.,'â€“')" role="warning" id="unicode-test-40">[unicode-test-40] <name/> element contains 'â€“' - this should instead be the character '–'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-40</report>

        <report test="contains(.,'Ã–')" role="warning" id="unicode-test-41">[unicode-test-41] <name/> element contains 'Ã–' - this should instead be the character 'Ö'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-41</report>

        <report test="contains(.,'â€”')" role="warning" id="unicode-test-42">[unicode-test-42] <name/> element contains 'â€”' - this should instead be the character '—'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-42</report>

        <report test="contains(.,'Ã—')" role="warning" id="unicode-test-43">[unicode-test-43] <name/> element contains 'Ã—' - this should instead be the character '×'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-43</report>

        <report test="contains(.,'Ëœ')" role="warning" id="unicode-test-44">[unicode-test-44] <name/> element contains 'Ëœ' - this should instead be the character '˜'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-44</report>

        <report test="contains(.,'Ã˜')" role="warning" id="unicode-test-45">[unicode-test-45] <name/> element contains 'Ã˜' - this should instead be the character 'Ø'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-45</report>

        <report test="contains(.,'Ã™')" role="warning" id="unicode-test-46">[unicode-test-46] <name/> element contains 'Ã™' - this should instead be the character 'Ù'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-46</report>

        <report test="contains(.,'Å¡')" role="warning" id="unicode-test-47">[unicode-test-47] <name/> element contains 'Å¡' - this should instead be the character 'š'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-47</report>

        <report test="contains(.,'Ãš')" role="warning" id="unicode-test-48">[unicode-test-48] <name/> element contains 'Ãš' - this should instead be the character 'Ú'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-48</report>
        ...
        <report test="contains(.,'Ã›')" role="warning" id="unicode-test-50">[unicode-test-50] <name/> element contains 'Ã›' - this should instead be the character 'Û'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-50</report>

        <report test="contains(.,'Å“')" role="warning" id="unicode-test-51">[unicode-test-51] <name/> element contains 'Å“' - this should instead be the character 'œ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-51</report>

        <report test="contains(.,'Ãœ')" role="warning" id="unicode-test-52">[unicode-test-52] <name/> element contains 'Ãœ' - this should instead be the character 'Ü'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-52</report>

        <report test="contains(.,'Ã')" role="warning" id="unicode-test-53">[unicode-test-53] <name/> element contains 'Ã' - this should instead be the character 'Ý'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-53</report>

        <report test="contains(.,'Å¾')" role="warning" id="unicode-test-54">[unicode-test-54] <name/> element contains 'Å¾' - this should instead be the character 'ž'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-54</report>

        <report test="contains(.,'Ãž')" role="warning" id="unicode-test-55">[unicode-test-55] <name/> element contains 'Ãž' - this should instead be the character 'Þ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-55</report>

        <report test="contains(.,'Å¸')" role="warning" id="unicode-test-56">[unicode-test-56] <name/> element contains 'Å¸' - this should instead be the character 'Ÿ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-56</report>

        <report test="contains(.,'ÃŸ')" role="warning" id="unicode-test-57">[unicode-test-57] <name/> element contains 'ÃŸ' - this should instead be the character 'ß'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-57</report>

        <report test="contains(.,'Â¡')" role="warning" id="unicode-test-58">[unicode-test-58] <name/> element contains 'Â¡' - this should instead be the character '¡'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-58</report>

        <report test="contains(.,'Ã¡')" role="warning" id="unicode-test-59">[unicode-test-59] <name/> element contains 'Ã¡' - this should instead be the character 'á'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-59</report>

        <report test="contains(.,'Â¢')" role="warning" id="unicode-test-60">[unicode-test-60] <name/> element contains 'Â¢' - this should instead be the character '¢'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-60</report>

        <report test="contains(.,'Ã¢')" role="warning" id="unicode-test-61">[unicode-test-61] <name/> element contains 'Ã¢' - this should instead be the character 'â'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-61</report>

        <report test="contains(.,'Â£')" role="warning" id="unicode-test-62">[unicode-test-62] <name/> element contains 'Â£' - this should instead be the character '£'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-62</report>

        <report test="contains(.,'Ã£')" role="warning" id="unicode-test-63">[unicode-test-63] <name/> element contains 'Ã£' - this should instead be the character 'ã'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-63</report>

        <report test="contains(.,'Â¤')" role="warning" id="unicode-test-64">[unicode-test-64] <name/> element contains 'Â¤' - this should instead be the character '¤'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-64</report>

        <report test="contains(.,'Ã¤')" role="warning" id="unicode-test-65">[unicode-test-65] <name/> element contains 'Ã¤' - this should instead be the character 'ä'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-65</report>

        <report test="contains(.,'Ã¥')" role="warning" id="unicode-test-66">[unicode-test-66] <name/> element contains 'Ã¥' - this should instead be the character 'å'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-66</report>

        <report test="contains(.,'Â¨')" role="warning" id="unicode-test-67">[unicode-test-67] <name/> element contains 'Â¨' - this should instead be the character '¨'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-67</report>

        <report test="contains(.,'Ã¨')" role="warning" id="unicode-test-68">[unicode-test-68] <name/> element contains 'Ã¨' - this should instead be the character 'è'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-68</report>

        <report test="contains(.,'Âª')" role="warning" id="unicode-test-69">[unicode-test-69] <name/> element contains 'Âª' - this should instead be the character 'ª'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-69</report>

        <report test="contains(.,'Ãª')" role="warning" id="unicode-test-70">[unicode-test-70] <name/> element contains 'Ãª' - this should instead be the character 'ê'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-70</report>

        <report test="contains(.,'Â­')" role="warning" id="unicode-test-71">[unicode-test-71] <name/> element contains 'Â­' - this should instead be the character '­'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-71</report>

        <report test="contains(.,'Ã­')" role="warning" id="unicode-test-72">[unicode-test-72] <name/> element contains 'Ã­' - this should instead be the character 'í'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-72</report>

        <report test="contains(.,'Â¯')" role="warning" id="unicode-test-73">[unicode-test-73] <name/> element contains 'Â¯' - this should instead be the character '¯'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-73</report>

        <report test="contains(.,'Ã¯')" role="warning" id="unicode-test-74">[unicode-test-74] <name/> element contains 'Ã¯' - this should instead be the character 'ï'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-74</report>

        <report test="contains(.,'Â°')" role="warning" id="unicode-test-75">[unicode-test-75] <name/> element contains 'Â°' - this should instead be the character '°'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-75</report>

        <report test="contains(.,'Ã°')" role="warning" id="unicode-test-76">[unicode-test-76] <name/> element contains 'Ã°' - this should instead be the character 'ð'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-76</report>

        <report test="contains(.,'Â±')" role="warning" id="unicode-test-77">[unicode-test-77] <name/> element contains 'Â±' - this should instead be the character '±'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-77</report>

        <report test="contains(.,'Ã±')" role="warning" id="unicode-test-78">[unicode-test-78] <name/> element contains 'Ã±' - this should instead be the character 'ñ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-78</report>

        <report test="contains(.,'Â´')" role="warning" id="unicode-test-79">[unicode-test-79] <name/> element contains 'Â´' - this should instead be the character '´'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-79</report>

        <report test="contains(.,'Ã´')" role="warning" id="unicode-test-80">[unicode-test-80] <name/> element contains 'Ã´' - this should instead be the character 'ô'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-80</report>

        <report test="contains(.,'Âµ')" role="warning" id="unicode-test-81">[unicode-test-81] <name/> element contains 'Âµ' - this should instead be the character 'µ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-81</report>

        <report test="contains(.,'Ãµ')" role="warning" id="unicode-test-82">[unicode-test-82] <name/> element contains 'Ãµ' - this should instead be the character 'õ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-82</report>

        <report test="contains(.,'Â¶')" role="warning" id="unicode-test-83">[unicode-test-83] <name/> element contains 'Â¶' - this should instead be the character '¶'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-83</report>

        <report test="contains(.,'Ã¶')" role="warning" id="unicode-test-84">[unicode-test-84] <name/> element contains 'Ã¶' - this should instead be the character 'ö'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-84</report>

        <report test="contains(.,'Â·')" role="warning" id="unicode-test-85">[unicode-test-85] <name/> element contains 'Â·' - this should instead be the character '·'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-85</report>

        <report test="contains(.,'Ã·')" role="warning" id="unicode-test-86">[unicode-test-86] <name/> element contains 'Ã·' - this should instead be the character '÷'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-86</report>

        <report test="contains(.,'Â¸')" role="warning" id="unicode-test-87">[unicode-test-87] <name/> element contains 'Â¸' - this should instead be the character '¸'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-87</report>

        <report test="contains(.,'Ã¸')" role="warning" id="unicode-test-88">[unicode-test-88] <name/> element contains 'Ã¸' - this should instead be the character 'ø'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-88</report>

        <report test="contains(.,'Ã¹')" role="warning" id="unicode-test-89">[unicode-test-89] <name/> element contains 'Ã¹' - this should instead be the character 'ù'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-89</report>

        <report test="contains(.,'Âº')" role="warning" id="unicode-test-90">[unicode-test-90] <name/> element contains 'Âº' - this should instead be the character 'º'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-90</report>

        <report test="contains(.,'Ãº')" role="warning" id="unicode-test-91">[unicode-test-91] <name/> element contains 'Ãº' - this should instead be the character 'ú'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-91</report>

        <report test="contains(.,'Â¿')" role="warning" id="unicode-test-92">[unicode-test-92] <name/> element contains 'Â¿' - this should instead be the character '¿'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-92</report>

        <report test="contains(.,'Ã¿')" role="warning" id="unicode-test-93">[unicode-test-93] <name/> element contains 'Ã¿' - this should instead be the character 'ÿ'. - <value-of select="."/>. More info here - https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#unicode-test-93</report>
