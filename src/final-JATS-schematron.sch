 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="abstract-sec-title-content-pattern">
    <rule context="abstract[not(@abstract-type)]/sec/title" id="abstract-sec-title-content">
      ...
      <report test="*" role="error" id="struct-abs-title-1">[struct-abs-title-1] A title in a structured abstract cannot contain a child element. It shouyld only contain text. This title with the content <value-of select="."/> has the following element(s): <value-of select="string-join(*/name(),'; ')"/>.</report>
