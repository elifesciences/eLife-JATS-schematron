 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="supplementary-material-tests-pattern">
    <rule context="supplementary-material" id="supplementary-material-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/additional-files#supplementary-material-test-2" test="not(matches(label[1],'Transparent reporting form|MDAR')) and not(caption)" role="warning" id="supplementary-material-test-2">[supplementary-material-test-2] <value-of select="label"/> is missing a title/caption - is this correct?  (supplementary-material should have a child caption.)</report>
  ...
  <pattern id="dec-letter-reply-tests-pattern">
    <rule context="article/sub-article" id="dec-letter-reply-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reply-test-1" test="if ($pos = 1) then @article-type='decision-letter'         else @article-type='reply'" role="error" flag="dl-ar" id="dec-letter-reply-test-1">[dec-letter-reply-test-1] 1st sub-article must be the decision letter. 2nd sub-article must be the author response.</assert>
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/decision-letters-and-author-responses#dec-letter-reply-test-2" test="@id = concat('sa',$pos)" role="error" flag="dl-ar" id="dec-letter-reply-test-2">[dec-letter-reply-test-2] sub-article id must be in the format 'sa0', where '0' is its position (1 or 2).</assert>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="KRT-td-checks-pattern">
    <rule context="table-wrap[@id='keyresource']//td" id="KRT-td-checks">
      ...
      <report test="matches(lower-case(.),'addgene\p{Zs}?#?\p{Zs}?\d') and not(ext-link[contains(@xlink:href,'scicrunch.org/resolver')])" role="warning" id="addgene-test">[addgene-test] td element containing - '<value-of select="."/>' - looks like it contains an addgene number. Should this be changed to an RRID with a https://scicrunch.org/resolver/RRID:addgene_{number} link?</report>
