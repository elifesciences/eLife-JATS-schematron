 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="elem-citation-pattern">
    <rule context="element-citation" id="elem-citation">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#err-elem-cit-high-6-2" test="@publication-type = ('journal', 'book', 'data', 'patent', 'software', 'preprint', 'web', 'periodical', 'report', 'confproc', 'thesis')" role="error" id="err-elem-cit-high-6-2">[err-elem-cit-high-6-2] element-citation must have a publication-type attribute with one of these values: 'journal', 'book', 'data', 'patent', 'software', 'preprint', 'web', 'periodical', 'report', 'confproc', or 'thesis'. Reference '<value-of select="../@id"/>' has '<value-of select="if (@publication-type) then concat('a @publication-type with the value ',@publication-type) else ('no @publication-type')"/>'.</assert>
  ...
  <pattern id="elem-citation-report-pattern">
    <rule context="element-citation[@publication-type='report']" id="elem-citation-report">
      ...
      <report test="ext-link and pub-id[@pub-id-type='doi']" role="error" id="err-elem-cit-report-14">[err-elem-cit-report-14] Report reference cannot have both a doi and a URL. Reference '<value-of select="ancestor::ref/@id"/>' has a doi (<value-of select="pub-id[@pub-id-type='doi']"/>) and a URL (<value-of select="ext-link"/>).</report>
