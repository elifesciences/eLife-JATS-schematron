 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="abstract-word-count-pattern">
    <rule context="front//abstract[not(@abstract-type) and not(sec)]" id="abstract-word-count">
      ...
      <report test="($count gt 280)" role="warning" id="final-abstract-word-count-restriction">[final-abstract-word-count-restriction] The abstract contains <value-of select="$count"/> words, when the usual upper limit is 280. Abstracts with more than 180 words should be checked with the eLife Editorial team.</report>
	   </rule>
  </pattern>
