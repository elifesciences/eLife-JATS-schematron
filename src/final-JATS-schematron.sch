 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="software-heritage-tests-pattern">
    <rule context="ext-link[contains(@xlink:href,'softwareheritage')]" id="software-heritage-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/toolkit/archiving-code#software-heritage-test-6" test="ends-with(@xlink:href,'/')" role="error" id="software-heritage-test-6">[software-heritage-test-6] A Software heritage link ending with '/' is not valid. Please remove the trailing '/' from the link.</report>
