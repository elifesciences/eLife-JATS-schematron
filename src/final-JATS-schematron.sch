 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="fig-tests-pattern">
    <rule context="fig[not(ancestor::sub-article)]" id="fig-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#fig-test-3" test="if ($article-type = ($features-article-types,'correction','retraction')) then ()         else not(label)" role="error" id="fig-test-3">[fig-test-3] fig must have a label.</report>
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#final-fig-test-5" test="if ($article-type = ('correction','retraction')) then ()         else not(caption/title)" role="error" id="final-fig-test-5">[final-fig-test-5] fig caption must have a title.</report>
  ...
  <pattern id="rep-fig-tests-pattern">
    <rule context="sub-article[@article-type='reply']//fig" id="rep-fig-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#resp-fig-test-2" test="label" role="error" id="resp-fig-test-2">[resp-fig-test-2] fig must have a label.</assert>
  ...
  <pattern id="dec-fig-tests-pattern">
    <rule context="sub-article[@article-type='decision-letter']//fig" id="dec-fig-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#dec-fig-test-1" test="label" role="error" id="dec-fig-test-1">[dec-fig-test-1] fig must have a label.</assert>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="ref-xref-conformance-pattern">
    <rule context="xref[@ref-type='bibr']" id="ref-xref-conformance">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/reference-citations#ref-xref-test-19" test="matches(.,'^et al|^ and|^\(\d|^,')" role="error" id="ref-xref-test-19">[ref-xref-test-19] <value-of select="."/> - citation doesn't start with an author's name which is incorrect.</report>
  ...
  <pattern id="table-xref-conformance-pattern">
    <rule context="xref[@ref-type='table']" id="table-xref-conformance">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#table-xref-conformity-3" test="(not(contains($rid,'app'))) and ($text-no != $rid-no) and not(contains(.,'–'))" role="warning" id="table-xref-conformity-3">[table-xref-conformity-3] <value-of select="."/> - Citation content does not match what it directs to.</report>
      
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#table-xref-conformity-4" test="(contains($rid,'app')) and (not(ends-with($text-no,substring($rid-no,2)))) and not(contains(.,'–'))" role="warning" id="table-xref-conformity-4">[table-xref-conformity-4] <value-of select="."/> - Citation content does not match what it directs to.</report>
