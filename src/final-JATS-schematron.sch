 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="clintrial-related-object-pattern">
    <rule context="abstract[not(@abstract-type) and sec]//related-object" id="clintrial-related-object">
      ...
      <assert see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#clintrial-related-object-6" test="@document-id" role="error" id="clintrial-related-object-6">[clintrial-related-object-6] <name/> must have an @document-id.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#clintrial-related-object-7" test="@xlink:href" role="error" id="clintrial-related-object-7">[clintrial-related-object-7] <name/> must have an @xlink:href.</assert>
  ...
  <pattern id="institution-id-tests-pattern">
    <rule context="article[e:get-version(.)='1']//award-group//institution-wrap/institution-id" id="institution-id-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/funding-3sv64358#institution-id-test-2" test="@institution-id-type='FundRef'" role="error" id="institution-id-test-2">[institution-id-test-2] <name/> element must have the attribute institution-id-type="FundRef".</assert>
  ...
  <pattern id="institution-id-tests-v2-pattern">
    <rule context="article[e:get-version(.)!='1']//award-group//institution-wrap/institution-id" id="institution-id-tests-v2">
      ...
      <assert see="https://elifeproduction.slab.com/posts/funding-3sv64358#institution-id-test-3" test="normalize-space(.) != ''" role="error" id="institution-id-test-3-v2">[institution-id-test-3-v2] The funding entry for <value-of select="parent::institution-wrap/institution"/> has an empty <name/> element, which is not allowed.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/funding-3sv64358#institution-id-test-4" test="*" role="error" id="institution-id-test-4-v2">[institution-id-test-4-v2] The <name/> element in funding entry for <value-of select="parent::institution-wrap/institution"/> contains child element(s) (<value-of select="string-join(distinct-values(*/name()),', ')"/>) which is not allowed.</report>
  ...
  <pattern id="body-table-label-tests-pattern">
    <rule context="body//table-wrap/label" id="body-table-label-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/tables-3nehcouh#body-table-label-test-1" test="matches(.,'^Table \d{1,4}\.$|^Key resources table$|^Author response table \d{1,4}\.$|^Decision letter table \d{1,4}\.$')" role="error" id="body-table-label-test-1">[body-table-label-test-1] <value-of select="."/> - Table label does not conform to the usual format.</assert>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="journal-tests-pattern">
    <rule context="element-citation[@publication-type='journal']" id="journal-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/journal-references-i098980k#elife-ref-check" test="(lower-case(source[1]) = 'elife') and not(matches(pub-id[@pub-id-type='doi'][1],'^10.7554/eLife\.\d{5}$|^10.7554/eLife\.\d{5}\.\d{3}$|^10.7554/eLife\.\d{5}\.sa[12]$'))" role="error" id="elife-ref-check">[elife-ref-check] ref '<value-of select="ancestor::ref/@id"/>' is an <value-of select="source[1]"/> article, but it has no doi in the format 10.7554/eLife.00000, which must be incorrect.</report>
