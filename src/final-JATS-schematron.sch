 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="elem-citation-book-comment-pattern">
    <rule context="element-citation[@publication-type='book']/comment" id="elem-citation-book-comment">
      ...
      <assert test="count(../fpage) eq 0" role="error" id="err-elem-cit-book-6-4">[err-elem-cit-book-6-4] If &lt;comment&gt;In press&lt;/comment&gt; is present, &lt;fpage&gt; cannot be present. Reference '<value-of select="ancestor::ref/@id"/>' has one of those elements.</assert>
