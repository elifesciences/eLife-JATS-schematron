 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="meta-value-tests-pattern">
    <rule context="article-meta/custom-meta-group/custom-meta[meta-name='Author impact statement']/meta-value" id="meta-value-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/impact-statement#final-custom-meta-test-6" test="matches(.,'[\.|\?]$')" role="error" id="final-custom-meta-test-6">[final-custom-meta-test-6] Impact statement must end with a full stop or question mark.</assert>
  ...
  <pattern id="meta-value-child-tests-pattern">
    <rule context="article-meta/custom-meta-group/custom-meta/meta-value/*" id="meta-value-child-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/impact-statement#custom-meta-child-test-1" test="local-name() = $allowed-elements" role="error" id="custom-meta-child-test-1">[custom-meta-child-test-1] <name/> is not allowed in impact statement.</assert>
  ...
  <pattern id="disp-formula-tests-pattern">
    <rule context="disp-formula" id="disp-formula-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/maths#disp-formula-test-4" test="parent::p and not(preceding-sibling::*) and (not(preceding-sibling::text()) or normalize-space(preceding-sibling::text()[1])='') and not(ancestor::list)" role="error" id="disp-formula-test-4">[disp-formula-test-4] disp-formula cannot be placed as the first child of a p element with no content before it (ie. &lt;p&gt;&lt;disp-formula ...). Either capture it at the end of the previous paragraph or capture it as a child of <value-of select="parent::p/parent::*/local-name()"/>
      </report>
    </rule>
  </pattern>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="table-xref-conformance-pattern">
    <rule context="xref[@ref-type='table']" id="table-xref-conformance">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/asset-citations#table-xref-conformity-4" test="(contains($rid,'sa')) and (not(ends-with($text-no,substring($rid-no,2)))) and not(contains(.,'–'))" role="warning" id="table-xref-conformity-4">[table-xref-conformity-4] <value-of select="."/> - Citation content does not match what it directs to.</report>
