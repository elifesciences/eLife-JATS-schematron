<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:java="http://www.java.com/" version="2.0">
  <!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="article[@article-type='research-article']" priority="1000" mode="M57">
   ...
   <xsl:template match="article[@article-type='research-article' and sub-article]" priority="1000" mode="M58">
      <xsl:variable name="disp-channel" select="descendant::article-meta/article-categories/subj-group[@subj-group-type='display-channel']/subject[1]"/>
   ...
   <!--PATTERN ar-fig-tests-pattern-->
	  ...
	  <!--RULE ar-fig-tests-->
   <xsl:template match="fig[ancestor::sub-article[@article-type='reply']]" priority="1000" mode="M59">
   ...
   <xsl:template match="disp-quote" priority="1000" mode="M60">
   ...
   <xsl:template match="sub-article[@article-type=('decision-letter','referee-report')]/body//media[@mimetype='video']" priority="1000" mode="M61">
   ...
   <xsl:template match="sub-article[@article-type=('reply','author-comment')]/body//media[@mimetype='video']" priority="1000" mode="M62">
      <xsl:variable name="count" select="count(ancestor::body//media[@mimetype='video'])"/>
   ...
   <!--PATTERN rep-fig-tests-pattern-->
	  ...
	  <!--RULE rep-fig-tests-->
   <xsl:template match="sub-article[@article-type='reply']//fig" priority="1000" mode="M63">
   ...
   <!--PATTERN dec-fig-tests-pattern-->
	  ...
	  <!--RULE dec-fig-tests-->
   <xsl:template match="sub-article[@article-type='decision-letter']//fig" priority="1000" mode="M64">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/title-group" priority="1000" mode="M65">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/front-stub/title-group" priority="1000" mode="M66">
   ...
   <xsl:template match="sub-article[@article-type='reply']/front-stub/title-group" priority="1000" mode="M67">
   ...
   <!--PATTERN rep-fig-ids-pattern-->
	  ...
	  <!--RULE rep-fig-ids-->
   <xsl:template match="sub-article//fig[not(@specific-use='child-fig')]" priority="1000" mode="M68">
   ...
   <xsl:template match="sub-article//fig[@specific-use='child-fig']" priority="1000" mode="M69">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M70">
   ...
   <xsl:template match="article/sub-article//p[not(ancestor::disp-quote)]" priority="1000" mode="M75">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/contrib-group" priority="1000" mode="M78">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/contrib-group/contrib[@contrib-type='author' and name]" priority="1000" mode="M79">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/related-object" priority="1000" mode="M80">
   ...
   <!--PATTERN ed-report-kwds-pattern-->
	  ...
	  <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M84">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/front-stub" priority="1000" mode="M85">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/front-stub/contrib-group[1]" priority="1000" mode="M86">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/front-stub/contrib-group[1]/contrib[@contrib-type='editor']" priority="1000" mode="M87">
      <xsl:variable name="name" select="e:get-name(name[1])"/>
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/front-stub/contrib-group[2]" priority="1000" mode="M88">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/front-stub/contrib-group[2]/contrib[@contrib-type='reviewer']" priority="1000" mode="M89">
      <xsl:variable name="name" select="e:get-name(name[1])"/>
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/body" priority="1000" mode="M90">
   ...
   <xsl:template match="sub-article[@article-type=('decision-letter','referee-report')]/body//p" priority="1000" mode="M91">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']/body/boxed-text[1]" priority="1000" mode="M92">
   ...
   <xsl:template match="sub-article[@article-type='decision-letter']" priority="1000" mode="M93">
   ...
   <xsl:template match="sub-article[@article-type='reply']/front-stub" priority="1000" mode="M94">
   ...
   <xsl:template match="sub-article[@article-type='reply']/body" priority="1000" mode="M95">
   ...
   <xsl:template match="sub-article[@article-type='reply']/body//disp-quote" priority="1000" mode="M96">
   ...
   <xsl:template match="sub-article[@article-type='reply']/body//p[not(ancestor::disp-quote)]" priority="1000" mode="M97">
   ...
   <xsl:template match="sub-article[@article-type='reply']//italic[not(ancestor::disp-quote)]" priority="1000" mode="M98">
   ...
   <xsl:template match="sub-article[@article-type='reply']" priority="1000" mode="M99">
   ...
   <xsl:template match="sub-article//ext-link" priority="1000" mode="M100">
   ...
   <xsl:template match="sub-article[@article-type='reply']/body/*[last()][name()='p']" priority="1000" mode="M101">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']/front-stub" priority="1000" mode="M102">
      <xsl:variable name="count" select="count(contrib-group)"/>
   ...
   <xsl:template match="sub-article[@article-type=('editor-report','referee-report','author-comment')]/front-stub/contrib-group/contrib" priority="1000" mode="M103">
   ...
   <xsl:template match="sub-article/front-stub/contrib-group/contrib/role" priority="1000" mode="M104">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']/front-stub[lower-case(title-group[1]/article-title[1])='recommendations for authors']" priority="1000" mode="M105">
   ...
   <xsl:template match="sub-article[@article-type='referee-report' and contains(lower-case(front-stub[1]/title-group[1]/article-title[1]),'public review')]/front-stub" priority="1000" mode="M106">
   ...
   <xsl:template match="article[descendant::article-meta/article-categories/subj-group[@subj-group-type='display-channel']/subject = $features-subj]" priority="1000" mode="M107">
