 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="meta-value-tests-pattern">
    <rule context="article-meta/custom-meta-group/custom-meta[meta-name='Author impact statement']/meta-value" id="meta-value-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/impact-statement#pre-custom-meta-test-6" test="matches(.,'[\.|\?]$')" role="warning" id="pre-custom-meta-test-6">[pre-custom-meta-test-6] Impact statement must end with a full stop or question mark.</assert>
  ...
  <pattern id="supplementary-material-tests-pattern">
    <rule context="supplementary-material" id="supplementary-material-tests">
      ...
      <report test="if (caption) then not(caption/title)         else ()" role="warning" id="pre-supplementary-material-test-3">[pre-supplementary-material-test-3] <value-of select="label"/> does not have a title.</report>
      
      
      
      <assert test="media" role="warning" id="pre-supplementary-material-test-5">[pre-supplementary-material-test-5] <value-of select="label"/> is missing a file (supplementary-material missing a media element) - please ensure that this is queried with the author.</assert>		
  ...
  <pattern id="article-title-tests-pattern">
    <rule context="article-meta//article-title" id="article-title-tests">
      ...
      <report test="($count gt 140)" role="warning" id="pre-title-length-restriction">[pre-title-length-restriction] The article title contains <value-of select="$count"/> characters, when the usual upper limit is 140. Exeter: Please check with the eLife production team who will need to contact the eLife Editorial team.</report>
