 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="research-article-pattern">
    <rule context="article[@article-type='research-article']" id="research-article">
	  ...
	  <report test="($type-display != 'Scientific Correspondence') and not(sub-article[@article-type='referee-report'])" role="warning" flag="dl-ar" id="pre-test-r-article-d-letter">[pre-test-r-article-d-letter] A decision letter should be present for research articles.</report>
  ...
  <pattern id="auth-cont-tests-pattern">
    <rule context="article[@article-type=('research-article','review-article')]//article-meta//contrib[(@contrib-type='author') and not(ancestor::collab)]" id="auth-cont-tests">
      ...
      <assert test="role" role="warning" id="pre-auth-cont-test-1">[pre-auth-cont-test-1] <value-of select="e:get-name(name[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
  ...
  <pattern id="collab-cont-tests-pattern">
    <rule context="article[@article-type=('research-article','review-article')]//article-meta//contrib[(@contrib-type='author') and child::collab]" id="collab-cont-tests">
      ...
      <assert test="role" role="warning" id="pre-collab-cont-test-1">[pre-collab-cont-test-1] <value-of select="e:get-collab(child::collab[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
  ...
  <pattern id="impact-statement-tests-pattern">
    <rule context="article-meta/abstract[@abstract-type='toc']/p[1]" id="impact-statement-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/impact-statement#pre-custom-meta-test-6" test="matches(.,'[\.|\?]$')" role="warning" id="pre-impact-statement-test-3">[pre-impact-statement-test-3] Impact statement must end with a full stop or question mark.</assert>
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/impact-statement#pre-rep-study-custom-meta-test" test="($subj = 'Replication Study') and not(matches(.,'^Editors[\p{Po}] Summary: '))" role="warning" id="pre-rep-study-impact-statement-test">[pre-rep-study-impact-statement-test] Impact statement in Replication studies must begin with 'Editors' summary: '. This does not - <value-of select="."/>.</report>
  ...
  <pattern id="author-aff-tests-pattern">
    <rule context="article-meta/contrib-group[@content-type='authors']/aff" id="author-aff-tests">
      ...
      <assert test="city" role="warning" id="pre-auth-aff-test-2">[pre-auth-aff-test-2] Author affiliations must have a city. This one does not - <value-of select="$display"/>. Please query the authors.</assert>
      
      
      
      <assert test="institution[not(@*)] or institution-wrap" role="warning" id="pre-auth-aff-test-3">[pre-auth-aff-test-3] Author affiliations must have a top level institution. This one (with the id <value-of select="@id"/>) does not - <value-of select="$display"/>. Please query the authors.</assert>
  ...
  <pattern id="fig-tests-pattern">
    <rule context="fig[not(ancestor::sub-article)]" id="fig-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-test-7" test="graphic or alternatives[graphic[not(@specific-use='print')]]" role="warning" id="pre-fig-test-7">[pre-fig-test-7] fig does not have a graphic. Ensure author query is added asking for file.</assert>
 ...
 <pattern id="feature-abstract-tests-pattern">
  ...
  <pattern id="data-availability-statement-pattern">
    <rule context="sec[@sec-type='data-availability']/p[1]" id="data-availability-statement">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-dryad-conformity" test="matches(.,'[Dd]ryad') and not(xref[@rid = ancestor::back/ref-list/ref[element-citation[@publication-type='data' and contains(source[1],'Dryad')]]/@id])" role="warning" id="pre-das-dryad-conformity">[pre-das-dryad-conformity] Data Availability Statement contains the word Dryad, but there is no data citation in the dataset section with a database name containing 'Dryad'. If there is a dryad dataset present, ensure the assigning authority is dryad, otherwise please query the authors for the reference details.</report>
