 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="elem-citation-data-pattern">
    <rule context="ref/element-citation[@publication-type='data']" id="elem-citation-data">
      ...
      <assert test="count(person-group) ge 1" role="warning" id="pre-err-elem-cit-data-3-2">[pre-err-elem-cit-data-3-2] Each  &lt;element-citation&gt; of type 'data' must contain at least one &lt;person-group&gt; element. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(person-group)"/> &lt;person-group&gt; elements. if this information is missing, please query the authors for it.</assert>
