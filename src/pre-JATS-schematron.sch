 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="auth-cont-tests-v2-pattern">
    <rule context="article[@article-type=('research-article','review-article') and e:get-version(.)!='1']//article-meta//contrib[(@contrib-type='author') and not(child::collab) and not(ancestor::collab)]" id="auth-cont-tests-v2">
      ...
      <assert test="role" role="warning" flag="version-2" id="pre-auth-cont-test-1-v2">[pre-auth-cont-test-1-v2] <value-of select="e:get-name(name[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
  ...
  <pattern id="collab-cont-tests-v2-pattern">
    <rule context="article[@article-type=('research-article','review-article') and e:get-version(.)!='1']//article-meta//contrib[(@contrib-type='author') and child::collab]" id="collab-cont-tests-v2">
      ...
      <assert test="role" role="warning" flag="version-2" id="pre-collab-cont-test-1-v2">[pre-collab-cont-test-1-v2] <value-of select="e:get-collab(child::collab[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
  ...
  <pattern id="pub-date-tests-1-pattern">
    <rule context="pub-date[not(@pub-type='collection')]" id="pub-date-tests-1">
      ...
      <assert test="matches(day[1],'^[0-9]{2}$')" role="warning" id="pre-pub-date-test-1">[pre-pub-date-test-1] day is not present in pub-date.</assert>
      
      
      
      <assert test="matches(month[1],'^[0-9]{2}$')" role="warning" id="pre-pub-date-test-2">[pre-pub-date-test-2] month is not present in pub-date.</assert>
  ...
  <pattern id="abstract-tests-pattern">
    <rule context="front//abstract" id="abstract-tests">
	  ...
	  <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/article-structure/abstract-digest-impact-statement#pre-abstract-test-5" test="child::sec and not(count(sec) = (5,6))" role="warning" id="pre-abstract-test-5">[pre-abstract-test-5] If an abstract is structured, then it must have 5 or 6 sections depending on whether it is a clinical trial. An article without a clinical trial should have 5 sections, whereas one with a clinical trial should have 6.</report>
  ...
  <pattern id="abstract-word-count-pattern">
    <rule context="front//abstract[not(@abstract-type) and not(sec)]" id="abstract-word-count">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/article-structure/abstract-digest-impact-statement#pre-abstract-word-count-restriction" test="($count gt 280)" role="warning" id="pre-abstract-word-count-restriction">[pre-abstract-word-count-restriction] The abstract contains <value-of select="$count"/> words, when the usual upper limit is 280. Exeter: Please check with the eLife production team who will need to contact the eLife Editorial team.</report>
  ...
  <pattern id="author-aff-tests-pattern">
    <rule context="article-meta/contrib-group[not(@*)]/aff" id="author-aff-tests">
      ...
      <assert test="country" role="warning" id="pre-auth-aff-test-1">[pre-auth-aff-test-1] Author affiliations must have a country. This one does not - <value-of select="$display"/>. Please query with the authors.</assert>
      
      
      
      <assert test="addr-line[named-content[@content-type='city']]" role="warning" id="pre-auth-aff-test-2">[pre-auth-aff-test-2] Author affiliations must have a city. This one does not - <value-of select="$display"/>. Please query the authors.</assert>
  ...
  <pattern id="meta-value-tests-pattern">
    <rule context="article-meta/custom-meta-group/custom-meta[meta-name='Author impact statement']/meta-value" id="meta-value-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/article-structure/abstract-digest-impact-statement#pre-custom-meta-test-6" test="matches(.,'[\.|\?]$')" role="warning" id="pre-custom-meta-test-6">[pre-custom-meta-test-6] Impact statement must end with a full stop or question mark.</assert>
  ...
  <pattern id="fig-tests-pattern">
    <rule context="fig[not(ancestor::sub-article)]" id="fig-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-test-4" test="not($article-type = ('discussion',$notice-article-types)) and not(caption)" role="warning" id="pre-fig-test-4">[pre-fig-test-4] <value-of select="label"/> has no title or caption (caption element). Ensure this is queried with the author.</report>
      
      
      
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-test-5" test="not($article-type = ('discussion',$notice-article-types)) and not(caption/title)" role="warning" id="pre-fig-test-5">[pre-fig-test-5] <value-of select="label"/> does not have a title.</report>
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-test-7" test="graphic" role="warning" id="pre-fig-test-7">[pre-fig-test-7] fig does not have graphic. Ensure author query is added asking for file.</assert>
  ...
  <pattern id="ar-fig-tests-pattern">
    <rule context="fig[ancestor::sub-article[@article-type='reply']]" id="ar-fig-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-ar-fig-test-3" test="graphic" role="warning" flag="dl-ar" id="pre-ar-fig-test-3">[pre-ar-fig-test-3] Author Response fig does not have graphic. Ensure author query is added asking for file.</assert>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-ar-fig-position-test" test="$no = string($pos)" role="warning" flag="dl-ar" id="pre-ar-fig-position-test">[pre-ar-fig-position-test] <value-of select="label"/> does not appear in sequence which is likely incorrect. Relative to the other AR images it is placed in position <value-of select="$pos"/>.</assert>
  ...
  <pattern id="video-test-pattern">
    <rule context="media[child::label]" id="video-test">
      ...
      <assert test="caption/title" role="warning" id="pre-video-title">[pre-video-title] <value-of select="replace(label,'\.$,','')"/> does not have a title. Please query the authors for one.</assert>
  ...
  <pattern id="supplementary-material-tests-pattern">
    <rule context="supplementary-material" id="supplementary-material-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/additional-files#pre-supplementary-material-test-3" test="if (caption) then not(caption/title)         else ()" role="warning" id="pre-supplementary-material-test-3">[pre-supplementary-material-test-3] <value-of select="label"/> does not have a title.</report>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/additional-files#pre-supplementary-material-test-5" test="media" role="warning" id="pre-supplementary-material-test-5">[pre-supplementary-material-test-5] <value-of select="label"/> is missing a file (supplementary-material missing a media element) - please ensure that this is queried with the author.</assert>		
  ...
  <pattern id="table-title-tests-pattern">
    <rule context="table-wrap[not(ancestor::sub-article) and not(contains(@id,'keyresource')) and label]" id="table-title-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#pre-table-title-test-1" test="caption/title" role="warning" id="pre-table-title-test-1">[pre-table-title-test-1] <value-of select="replace(label[1],'\.$','')"/> does not have a title. Please ensure to query the authors for one.</assert>
  ...
  <pattern id="kr-table-tests-pattern">
    <rule context="table-wrap[contains(@id,'keyresource')]" id="kr-table-tests">
      ...
      <report test="following::table-wrap[contains(@id,'keyresource') or contains(lower-case(label[1]),'key resources table')]" role="warning" id="pre-duplicate-kr-table-1">[pre-duplicate-kr-table-1] There appears to be more than one key resources table. Exeter please check with Production on how to proceed.</report>
  ...
  <pattern id="general-video-pattern">
    <rule context="media[@mimetype='video'][matches(@id,'^video[0-9]{1,3}$')]" id="general-video">
      ...
      <assert test="$xrefs//*:match" role="warning" id="pre-video-cite">[pre-video-cite] There is no citation to <value-of select="$label"/>. Ensure to query the author asking for a citation.</assert>
      
      
      
      <report test="($xrefs//*:match) and ($sec-id != $sec1/@id)" role="warning" id="pre-video-placement-1">[pre-video-placement-1] <value-of select="$label"/> does not appear in the same section as where it is first cited (sec with title '<value-of select="$sec1/title"/>'), which is incorrect. If videos are cited out of order, please ensure that this issue is raised with the authors.</report>
  ...
  <pattern id="body-video-specific-pattern">
    <rule context="article[not(@article-type = $notice-article-types)]/body//media[@mimetype='video']" id="body-video-specific">
      ...
      <report test="not(ancestor::fig-group) and (matches(label[1],'[Vv]ideo')) and ($no != string($pos))" role="warning" id="pre-body-video-position-test-1">[pre-body-video-position-test-1] <value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other videos it is placed in position <value-of select="$pos"/>. Please ensure this is queried with the authors if they have cited them out of position.</report>
  ...
  <pattern id="dl-video-specific-pattern">
    <rule context="sub-article[@article-type=('decision-letter','referee-report')]/body//media[@mimetype='video']" id="dl-video-specific">
      ...
      <assert test="$no = string($pos)" role="warning" flag="dl-ar" id="pre-dl-video-position-test">[pre-dl-video-position-test] <value-of select="label"/> does not appear in sequence which is likely incorrect. Relative to the other DL videos it is placed in position <value-of select="$pos"/>.</assert>
  ...
  <pattern id="body-table-pos-conformance-pattern">
    <rule context="article[not(@article-type=$notice-article-types)]/body//table-wrap[matches(@id,'^table[\d]+$')]" id="body-table-pos-conformance">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#pre-body-table-report" test="($no = string($pos))" role="warning" id="pre-body-table-report">[pre-body-table-report] <value-of select="label"/> does not appear in sequence. Relative to the other numbered tables it is placed in position <value-of select="$pos"/>.</assert>
  ...
  <pattern id="app-table-pos-conformance-pattern">
    <rule context="article//app//table-wrap[matches(@id,'^app[\d]+table[\d]+$')]" id="app-table-pos-conformance">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#pre-app-table-report" test="($no = string($pos))" role="warning" id="pre-app-table-report">[pre-app-table-report] <value-of select="label"/> does not appear in sequence. Relative to the other numbered tables in the same appendix it is placed in position <value-of select="$pos"/>.</assert>
  ...
  <pattern id="fig-specific-tests-pattern">
    <rule context="article/body//fig[not(@specific-use='child-fig')][not(ancestor::boxed-text)]" id="fig-specific-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-specific-test-2" test="if ($article-type = $notice-article-types) then ()         else if ($count = 0) then ()         else if (not(matches($id,'^fig[0-9]{1,3}$'))) then ()         else $no != string($pos)" role="warning" id="pre-fig-specific-test-2">[pre-fig-specific-test-2] <value-of select="$lab"/> does not appear in sequence. Relative to the other figures it is placed in position <value-of select="$pos"/>. Please query this with the author.</report>
  ...
  <pattern id="article-title-tests-pattern">
    <rule context="article-meta//article-title" id="article-title-tests">
      ...
      <report test="not($type = ('Scientific Correspondence','Correction','Retraction')) and ($count gt 140)" role="warning" id="pre-title-length-restriction">[pre-title-length-restriction] The article title contains <value-of select="$count"/> characters, when the usual upper limit is 140. Exeter: Please check with the eLife production team who will need to contact the eLife Editorial team.</report>
  ...
  <pattern id="elem-citation-pattern">
    <rule context="element-citation" id="elem-citation">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-element-cite-year" test="not(year)" role="warning" id="pre-element-cite-year">[pre-element-cite-year] '<value-of select="@publication-type"/>' type references must have a year. Reference '<value-of select="../@id"/>' does not. If you are unable to determine this, please ensure to add an author query asking for the year of publication.</report>
  ...
  <pattern id="element-citation-descendants-pattern">
    <rule context="element-citation//*" id="element-citation-descendants">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-empty-elem-cit-des" test="not(*) and (normalize-space(.)='')" role="warning" id="pre-empty-elem-cit-des">[pre-empty-elem-cit-des] <name/> element is empty - this is not allowed. It must contain content. If the details are missing and cannot be determined, please query the authors.</report>
  ...
  <pattern id="elem-citation-journal-pattern">
    <rule context="element-citation[@publication-type='journal']" id="elem-citation-journal">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/journal-references#pre-err-elem-cit-journal-2-1" test="count(person-group)=1" role="warning" id="pre-err-elem-cit-journal-2-1">[pre-err-elem-cit-journal-2-1] Each  &lt;element-citation&gt; of type 'journal' must contain one and only one &lt;person-group&gt; element. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(person-group)"/> &lt;person-group&gt; elements. If this information is missing, please query the authors for it.</assert>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/journal-references#pre-err-elem-cit-journal-2-2" test="person-group[@person-group-type='author']" role="warning" id="pre-err-elem-cit-journal-2-2">[pre-err-elem-cit-journal-2-2] Each  &lt;element-citation&gt; of type 'journal' must contain one &lt;person-group&gt;  with the attribute person-group-type 'author'. Reference '<value-of select="ancestor::ref/@id"/>' has a  &lt;person-group&gt; type of '<value-of select="person-group/@person-group-type"/>'. If this information is missing, please query the authors for it.</assert>
  ...
  <pattern id="elem-citation-book-pattern">
    <rule context="element-citation[@publication-type='book']" id="elem-citation-book">
      ...
      <assert test="count(person-group)=1 or (count(person-group[@person-group-type='author'])=1 and count(person-group[@person-group-type='editor'])=1)" role="warning" id="pre-err-elem-cit-book-2-3">[pre-err-elem-cit-book-2-3] In a book reference, there should be a single person-group element (either author or editor) or one person-group with @person-group-type="author" and one person-group with @person-group-type=editor. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(person-group)"/> &lt;person-group&gt; elements. If this finromation is missing, please query it with the authors.</assert>
      ...
      <assert test="count(publisher-name)=1" role="warning" id="pre-err-elem-cit-book-13-1">[pre-err-elem-cit-book-13-1] One and only one &lt;publisher-name&gt; is required in a book reference. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(publisher-name)"/> &lt;publisher-name&gt; elements. If this information is missing, please query it with the authors.</assert>
  ...
  <pattern id="elem-citation-book-chapter-title-pattern">
    <rule context="element-citation[@publication-type='book']/chapter-title" id="elem-citation-book-chapter-title">
      ...
      <assert test="count(../person-group[@person-group-type='author'])=1" role="warning" id="pre-err-elem-cit-book-22">[pre-err-elem-cit-book-22] If there is a &lt;chapter-title&gt; element there must be one and only one &lt;person-group person-group-type="author"&gt;. Reference '<value-of select="ancestor::ref/@id"/>' does not meet this requirement. If this information is missing, please query the authors for it.</assert>
  ...
  <pattern id="elem-citation-data-pattern">
    <rule context="ref/element-citation[@publication-type='data']" id="elem-citation-data">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references/data-references#pre-err-elem-cit-data-3-2" test="count(person-group) lt 1" role="warning" id="pre-err-elem-cit-data-3-2">[pre-err-elem-cit-data-3-2] Data references must have one and only one &lt;person-group person-group-type='author'&gt;. Reference '<value-of select="ancestor::ref/@id"/>' has 0. If this information is missing, please query the authors asking for it.</report>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references/data-references#pre-err-elem-cit-data-10" test="count(data-title)=1" role="warning" id="pre-err-elem-cit-data-10">[pre-err-elem-cit-data-10] Data reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(data-title)"/> data-title elements, when it should contain one. If this information is missing, please query it with the authors.</assert>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references/data-references#pre-err-elem-cit-data-11-2" test="count(source)=1" role="warning" id="pre-err-elem-cit-data-11-2">[pre-err-elem-cit-data-11-2] Data reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(source)"/> source elements, when it should contain one. If this information is missing, please query it with the authors.</assert>
  ...
  <pattern id="elem-citation-patent-pattern">
    <rule context="element-citation[@publication-type='patent']" id="elem-citation-patent">
      ...
      <assert test="count(person-group[@person-group-type='inventor'])=1" role="warning" id="pre-err-elem-cit-patent-2-1">[pre-err-elem-cit-patent-2-1] There must be one person-group with @person-group-type="inventor". Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(person-group[@person-group-type='inventor'])"/> &lt;person-group&gt; elements of type 'inventor'. If this information is missing, please query the authors for it.</assert>
      ...
      <assert test="count(article-title)=1" role="warning" id="pre-err-elem-cit-patent-8-1">[pre-err-elem-cit-patent-8-1] Each  &lt;element-citation&gt; of type 'patent' must contain one and only one &lt;article-title&gt; element. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(article-title)"/> &lt;article-title&gt; elements.</assert>
      
      
      
      <assert test="count(source)=1" role="warning" id="pre-err-elem-cit-patent-9-1">[pre-err-elem-cit-patent-9-1] Each &lt;element-citation&gt; of type 'patent' must contain one and only one &lt;source&gt; elements. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(source)"/> &lt;source&gt; elements. If this information is missing, please query the authors for it.</assert>
  ...
  <pattern id="elem-citation-web-pattern">
    <rule context="element-citation[@publication-type='web']" id="elem-citation-web">
      ...
      <assert test="count(article-title)=1" role="warning" id="pre-err-elem-cit-web-8-1">[pre-err-elem-cit-web-8-1] Each  &lt;element-citation&gt; of type 'web' must contain one and only one &lt;article-title&gt; element. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(article-title)"/> &lt;article-title&gt; elements. If you are unable to determine this yourself, please query the authors for this information.</assert>
      ...
      <report test="count(date-in-citation) lt 1" role="warning" id="pre-err-elem-cit-web-11-1">[pre-err-elem-cit-web-11-1] Web Reference '<value-of select="ancestor::ref/@id"/>' has no accessed date (&lt;date-in-citation&gt; element), which is required. Please ensure this is queried with the author.</report>
  ...
  <pattern id="gen-das-tests-pattern">
    <rule context="sec[@sec-type='data-availability']//element-citation[@publication-type='data']" id="gen-das-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-person-group-1" test="count(person-group[@person-group-type='author'])=1" role="warning" id="pre-das-elem-person-group-1">[pre-das-elem-person-group-1] The reference in position <value-of select="$pos"/> of the data availability section does not have any authors (no person-group[@person-group-type='author']). Please ensure to add them in or query the authors asking for the author list.</assert>
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-person-1" test="(count(person-group[@person-group-type='author']/name)=0) and (count(person-group[@person-group-type='author']/collab)=0)" role="warning" id="pre-das-elem-person-1">[pre-das-elem-person-1] The reference in position <value-of select="$pos"/> of the data availability section does not have any authors. Please ensure to add them in or query the authors asking for the author list.</report>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-data-title-1" test="count(data-title)=1" role="warning" id="pre-das-elem-data-title-1">[pre-das-elem-data-title-1] The reference in position <value-of select="$pos"/> of the data availability section does not have a title (no data-title). Please ensure to add it in or query the authors asking for it.</assert>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-source-1" test="count(source)=1" role="warning" id="pre-das-elem-source-1">[pre-das-elem-source-1] The reference in position <value-of select="$pos"/> of the data availability section does not have a database name (no source). Please ensure to add it in or query the authors asking for it.</assert>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-pub-id-1" test="count(pub-id)=1" role="warning" id="pre-das-elem-pub-id-1">[pre-das-elem-pub-id-1] The reference in position <value-of select="$pos"/> of the data availability section does not have an identifier (no pub-id). Please ensure to add it in or query the authors asking for it.</assert>
      
      
      
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-pub-id-2" test="normalize-space(pub-id)=''" role="warning" id="pre-das-elem-pub-id-2">[pre-das-elem-pub-id-2] The reference in position <value-of select="$pos"/> of the data availability section does not have an id (pub-id is empty). Please ensure to add it in or query the authors asking for it.</report>
      
      
      
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-year-1" test="count(year)=1" role="warning" id="pre-das-elem-year-1">[pre-das-elem-year-1] The reference in position <value-of select="$pos"/> of the data availability section does not have a year. Please ensure to add it in or query the authors asking for it.</assert>
  ...
  <pattern id="das-elem-citation-year-tests-pattern">
    <rule context="sec[@sec-type='data-availability']//element-citation[@publication-type='data']/year" id="das-elem-citation-year-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-citation-year-2" test="normalize-space(.)=''" role="warning" id="pre-das-elem-citation-year-2">[pre-das-elem-citation-year-2] Reference with id <value-of select="parent::*/@id"/> has an empty year. Please ensure to add it in or query the authors asking for it.</report>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="feature-template-tests-pattern">
    <rule context="article[descendant::article-meta/article-categories/subj-group[@subj-group-type='display-channel']/subject = $features-subj]" id="feature-template-tests">
     ...
     <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/feature-content#pre-feature-templates-author-cont-2" test="$template = ('3','4') and not(back/fn-group[@content-type='author-contribution'])" role="warning" id="pre-feature-templates-author-cont-2">[pre-feature-templates-author-cont-2] <value-of select="$type"/>s should have Author contributions. This one does not. Exeter please check with the Production team who will check with the Features team.</report>
  ...
  <pattern id="ref-xref-conformance-pattern">
    <rule context="xref[@ref-type='bibr']" id="ref-xref-conformance">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/reference-citations#pre-ref-xref-test-19" test="matches(.,'^et al|^ and|^\(\d|^,')" role="warning" id="pre-ref-xref-test-19">[pre-ref-xref-test-19] <value-of select="."/> - citation doesn't start with an author's name. If this information is missing, please ensure to query the authors asking for the details for this reference.</report>
  ...
  <pattern id="city-tests-pattern">
    <rule context="front//aff//named-content[@content-type='city']" id="city-tests">
      ...
      <report test="matches($lc,$states-regex)" role="warning" id="pre-US-states-test">[pre-US-states-test] city contains a US state (or an abbreviation for it) - <value-of select="."/>. Please raise with eLife production staff.</report>
  ...
  <pattern id="data-availability-statement-pattern">
    <rule context="sec[@sec-type='data-availability']/p[1]" id="data-availability-statement">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-dryad-conformity" test="matches(.,'[Dd]ryad') and          not(parent::sec//element-citation[contains(source[1],'Dryad') or pub-id[@pub-id-type='doi' and (contains(.,'10.7272') or contains(.,'10.5061/dryad'))]])         and not(ancestor::back//ref-list/ref[element-citation[@publication-type='data' and (contains(source[1],'Dryad') or pub-id[@pub-id-type='doi' and (contains(.,'10.7272') or contains(.,'10.5061/dryad'))])]]/@id = xref[@ref-type='bibr']/@rid)" role="warning" id="pre-das-dryad-conformity">[pre-das-dryad-conformity] Data Availability Statement contains the word Dryad, but there is no data citation in the dataset section with a dryad doi and/or database name containing 'Dryad'. If there is a dryad dataset present, ensure that it is captured correctly, otherwise please query the authors for the reference details.</report>
  ...
  <pattern id="italic-house-style-pattern">
    <rule context="italic[not(ancestor::ref) and not(ancestor::sub-article)]" id="italic-house-style">  
      ...
      <report test="matches(.,'et al[\.]?')" role="error" id="pre-et-al-italic-test">[pre-et-al-italic-test] <name/> element contains 'et al.' - this should not be in italics (eLife house style).</report>

        
      
      <report test="matches(.,'[Ii]n [Vv]itro')" role="error" id="pre-in-vitro-italic-test">[pre-in-vitro-italic-test] <name/> element contains 'in vitro' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Ii]n [Vv]ivo')" role="error" id="pre-in-vivo-italic-test">[pre-in-vivo-italic-test] <name/> element contains 'in vivo' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Ee]x [Vv]ivo')" role="error" id="pre-ex-vivo-italic-test">[pre-ex-vivo-italic-test] <name/> element contains 'ex vivo' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Aa] [Pp]riori')" role="error" id="pre-a-priori-italic-test">[pre-a-priori-italic-test] <name/> element contains 'a priori' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Aa] [Pp]osteriori')" role="error" id="pre-a-posteriori-italic-test">[pre-a-posteriori-italic-test] <name/> element contains 'a posteriori' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Dd]e [Nn]ovo')" role="error" id="pre-de-novo-italic-test">[pre-de-novo-italic-test] <name/> element contains 'de novo' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Ii]n [Uu]tero')" role="error" id="pre-in-utero-italic-test">[pre-in-utero-italic-test] <name/> element contains 'in utero' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Ii]n [Nn]atura')" role="error" id="pre-in-natura-italic-test">[pre-in-natura-italic-test] <name/> element contains 'in natura' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ii]n [Ss]itu')" role="error" id="pre-in-situ-italic-test">[pre-in-situ-italic-test] <name/> element contains 'in situ' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Ii]n [Pp]lanta')" role="error" id="pre-in-planta-italic-test">[pre-in-planta-italic-test] <name/> element contains 'in planta' - this should not be in italics (eLife house style).</report> 
      
      <report test="matches(.,'[Rr]ete [Mm]irabile')" role="error" id="pre-rete-mirabile-italic-test">[pre-rete-mirabile-italic-test] <name/> element contains 'rete mirabile' - this should not be in italics (eLife house style).</report>  
      ...
      <report test="matches(.,'^[Ss]ensu$| [Ss]ensu$|^[Ss]ensu | [Ss]ensu ')" role="error" id="pre-sensu-italic-test">[pre-sensu-italic-test] <name/> element contains 'sensu' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Aa]d [Ll]ibitum')" role="error" id="pre-ad-libitum-italic-test">[pre-ad-libitum-italic-test] <name/> element contains 'ad libitum' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ii]n [Oo]vo')" role="error" id="pre-in-ovo-italic-test">[pre-in-ovo-italic-test] <name/> element contains 'In Ovo' - this should not be in italics (eLife house style).</report>
  ...
  <pattern id="pubmed-link-2-pattern">
    <rule context="table-wrap//ext-link[(contains(@xlink:href,'ncbi.nlm.nih.gov/pubmed') or contains(@xlink:href,'pubmed.ncbi.nlm.nih.gov')) and not(ancestor::sub-article)]" id="pubmed-link-2">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#pre-pmid-spacing-table" test="ends-with($lc,'pmid: ') or ends-with($lc,'pmid ')" role="error" id="pre-pmid-spacing-table">[pre-pmid-spacing-table] PMID link should be preceding by 'PMID:' with no space but instead it is preceded by '<value-of select="concat(substring($pre-text,string-length($pre-text)-15),.)"/>'.</report>
  ...
  <pattern id="rrid-link-pattern">
    <rule context="ext-link[contains(@xlink:href,'scicrunch.org/resolver') and not(ancestor::sub-article)]" id="rrid-link">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/rrids#pre-rrid-spacing" test="ends-with($lc,'rrid: ') or ends-with($lc,'rrid ')" role="error" id="pre-rrid-spacing">[pre-rrid-spacing] RRID link should be preceded by 'RRID:' with no space but instead it is preceded by '<value-of select="concat(substring($pre-text,string-length($pre-text)-15),.)"/>'.</report>
  ...
  <pattern id="empty-attribute-test-pattern">
    <rule context="*[@*/normalize-space(.)='']" id="empty-attribute-test">
      ...
      <report test="." role="warning" id="pre-empty-attribute-conformance">[pre-empty-attribute-conformance] <value-of select="name()"/> element has attribute(s) with an empty value. &lt;<value-of select="name()"/>
