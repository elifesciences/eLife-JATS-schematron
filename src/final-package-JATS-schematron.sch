<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:file="java.io.File" xmlns:java="http://www.java.com/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" queryBinding="xslt2">
 ...
 <pattern id="article-tests-pattern"><rule context="article" id="article-tests">
    ...
    <report test="(@article-type = ('article-commentary','discussion','editorial','research-article','review-article')) and count(back) != 1" role="error" id="test-article-back">Article must have one child back. Currently there are <value-of select="count(back)"/></report>
      ...
      <report test="not(@article-type='research-article') and not(@article-type='review-article' and e:is-prc(.)) and sub-article" role="error" id="non-r-article-sub-article"><value-of select="@article-type"/> type articles cannot have sub-articles (peer review materials).</report>
	  ...
	  <report test="count(sub-article[@article-type=('reply','author-comment')]) gt 1" role="error" id="test-r-article-a-reply-2">There cannot be more than one author response. This article has <value-of select="count(sub-article[@article-type=('reply','author-comment')])"/>.</report>
	  
	  <report test="count(sub-article[@article-type='editor-report']) gt 1" role="error" id="editor-report-2">There cannot be more than one eLife Assessment or Editor's evaluation. This one has <value-of select="count(sub-article[@article-type='editor-report'])"/>.</report>
  ...
  <pattern id="test-article-metadata-pattern"><rule context="article/front/article-meta" id="test-article-metadata">
    ...
    <report test="not($article-type = ($notice-article-types,'article-commentary','editorial')) and ($dtd le '1.3') and count(history) != 1" role="error" id="test-history-presence">There must be one and only one history element in the article-meta. Currently there are <value-of select="count(history)"/></report>
    ...
    <report see="https://elifeproduction.slab.com/posts/keywords-and-research-organisms-mq0bozp9#test-auth-kwd-group-presence-2" test="if ($subj-type = $notice-display-types) then (count(kwd-group[@kwd-group-type='author-keywords']) != 0)       else ()" role="error" id="test-auth-kwd-group-presence-2"><value-of select="$subj-type"/> articles must not have any author keywords</report>
    ...
    <report see="https://elifeproduction.slab.com/posts/keywords-and-research-organisms-mq0bozp9#test-ro-kwd-group-presence-2" test="if ($subj-type = ('Research Article', 'Research Advance', 'Replication Study', 'Research Communication'))       then (count(kwd-group[@kwd-group-type='research-organism']) = 0)       else ()" role="warning" id="test-ro-kwd-group-presence-2"><value-of select="$subj-type"/> does not contain a Research Organism keyword group. Is this correct?</report>
    ...
    <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#test-contrib-group-presence-1" test="contrib-group" role="error" id="test-contrib-group-presence-1">contrib-group (with no attributes containing authors) must be present (as a child of article-meta) for research articles.</assert>
     ...
     <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#test-contrib-group-presence-2" test="contrib-group[@content-type='section']" role="error" id="test-contrib-group-presence-2">contrib-group[@content-type='section'] must be present (as a child of article-meta) for research articles (this is the contrib-group which contains reviewers and editors).</assert>
      ...
      <assert test="@article-version-type='publication-state'" role="error" id="article-version-test-2"><name/> must have an article-version-type="publication-state" attribute. This one does not.</assert>
   ...
   <let name="template" value="parent::article-meta/custom-meta-group/custom-meta[meta-name='Template']/meta-value[1]"/>
    ...
    <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#equal-count-test" test="count(contrib[@equal-contrib='yes']) = 1" role="error" id="equal-count-test">There is one contrib with the attribute equal-contrib='yes'. This cannot be correct. Either 2 or more contribs within the same contrib-group should have this attribute, or none. Check <value-of select="contrib[@equal-contrib='yes']/name"/></report>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#editor-conformance-3" test="(@contrib-type='senior_editor') and ($role!='Senior Editor')" role="error" id="editor-conformance-3"><value-of select="$name"/> has a @contrib-type='senior_editor' but their role is not 'Senior Editor' (<value-of select="$role"/>), which is incorrect.</report>
      
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#editor-conformance-4" test="(@contrib-type='editor') and ($role!='Reviewing Editor')" role="error" id="editor-conformance-4"><value-of select="$name"/> has a @contrib-type='editor' but their role is not 'Reviewing Editor' (<value-of select="$role"/>), which is incorrect.</report>

      <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#editor-conformance-5" test="count($matching-author-names)=0" role="error" id="editor-conformance-5"><value-of select="$name"/> is listed both as an author and as a <value-of select="$role"/>, which must be incorrect.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#auth-cont-test-1" test="child::xref[@ref-type='fn' and matches(@rid,'^con[0-9]{1,3}$')]" role="warning" id="auth-cont-test-1"><value-of select="e:get-name(name[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#auth-cont-test-1-v2" test="role" role="warning" id="auth-cont-test-1-v2"><value-of select="e:get-name(name[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#auth-cont-test-2-v2" test="role and not(role[@vocab='credit'])" role="warning" id="auth-cont-test-2-v2"><value-of select="e:get-name(name[1])"/> has no CRediT contributions. Is that correct?</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#collab-cont-test-1" test="child::xref[@ref-type='fn' and matches(@rid,'^con[0-9]{1,3}$')]" role="warning" id="collab-cont-test-1"><value-of select="e:get-surname(.)"/> has no contributions. Please ensure to query this with the authors.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#final-collab-cont-test-1-v2" test="role" role="error" id="final-collab-cont-test-1-v2"><value-of select="e:get-surname(.)"/> has no contributions. Please ensure to query this with the authors.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#final-collab-cont-test-2-v2" test="role and not(role[@vocab='credit'])" role="warning" id="final-collab-cont-test-2-v2"><value-of select="e:get-surname(.)"/> has no CRediT contributions. Is that correct?</report>
      ...
      <report test="ancestor::article-meta and not(parent::collab-wrap)" role="error" id="collab-name-test-1"><name/> that is a descendant of article-meta must be captured as a child of collab-wrap. This one has the parent <value-of select="parent::*/name()"/>.</report>
      
      <report test="ancestor::ref and not(parent::person-group)" role="error" id="collab-name-test-2"><name/> that is a descendant of ref must be captured as a child of person-group. This one has the parent <value-of select="parent::*/name()"/>.</report>
      
      <report test="not(ancestor::element-citation) and not(ancestor::article-meta)" role="error" id="collab-name-test-3"><name/> must only be captured as a descendant of ref or article-meta. This one is not.</report>
	  ...
	  <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-1" test="count(given-names) gt 1" role="error" id="given-names-test-1">Each name must contain only one given-names element.</report>
	  ...
	  <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#surname-test-2" test="normalize-space(.)=''" role="error" id="surname-test-2">surname must not be empty.</report>
    ...
    <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#surname-test-3" test="descendant::bold or descendant::sub or descendant::sup or descendant::italic or descendant::sc" role="error" id="surname-test-3">surname must not contain any formatting (bold, or italic emphasis, or smallcaps, superscript or subscript).</report>
	  ...
	  <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#surname-test-5" test="matches(.,'^\p{Ll}') and not(matches(.,'^(de[lrn]?|van|von|el|te[rn]|d[ai]|dos)\s'))" role="warning" id="surname-test-5">surname doesn't begin with a capital letter - <value-of select="."/>. Is this correct?</report>
	  ...
	  <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#surname-test-7" test="matches(.,'\p{Zs}$')" role="error" id="surname-test-7">surname ends with a space, which cannot be correct - '<value-of select="."/>'.</report>
	  ...
	  <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-3" test="normalize-space(.)=''" role="error" id="given-names-test-3">given-names must not be empty.</report>
    	...
    	<report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-4" test="descendant::bold or descendant::sub or descendant::sup or descendant::italic or descendant::sc" role="error" id="given-names-test-4">given-names must not contain any formatting (bold, or italic emphasis, or smallcaps, superscript or subscript) - '<value-of select="."/>'.</report>
    ...
    <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-7" test="matches(.,'^[\p{L}]{1}\.$|^[\p{L}]{1}\.\p{Zs}?[\p{L}]{1}\.\p{Zs}?$')" role="error" id="given-names-test-7">given-names contains initialised full stop(s) which is incorrect - <value-of select="."/></report>
	  
    <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-8" test="matches(.,'^\p{Zs}')" role="error" id="given-names-test-8">given-names starts with a space, which cannot be correct - '<value-of select="."/>'.</report>
    ...
    <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-9" test="matches(.,'\p{Zs}$')" role="error" id="given-names-test-9">given-names ends with a space, which cannot be correct - '<value-of select="."/>'.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-12" test="matches(.,'[A-Za-z] [Vv]on$')" role="warning" id="given-names-test-12">given-names ends with ' von' - should this be captured as the beginning of the surname instead? - '<value-of select="."/>'.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#given-names-test-15" test="matches(normalize-space(.),'[A-Za-z]\p{Zs}[A-za-z]\p{Zs}[A-za-z]\p{Zs}[A-za-z]|[A-Za-z]\p{Zs}[A-za-z]\p{Zs}[A-za-z]$|^[A-za-z]\p{Zs}[A-za-z]$')" role="info" id="given-names-test-15">given-names contains initials with spaces. Ensure that the space(s) is removed between initials - '<value-of select="."/>'.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#suffix-child-test" test="*" role="error" id="suffix-child-test">suffix cannot have any child elements - <value-of select="*/local-name()"/></report>
      
    </rule></pattern><pattern id="name-child-tests-pattern"><rule context="contrib-group//name/*" id="name-child-tests">
      
      <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#disallowed-child-assert" test="local-name() = ('surname','given-names','suffix')" role="error" id="disallowed-child-assert"><value-of select="local-name()"/> is not allowed as a child of name.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#author-role-check-1" test="@vocab-term or @vocab-term-identifier or @vocab-identifier" role="error" id="author-role-check-1">role with <value-of select="string-join(@*[name()=('vocab-term','vocab-term-identifier','vocab-identifier')]/name(),'; ')"/> attributes must have a vocab="credit" attribute. This one does not.</report>
	  ...
	  <assert see="https://elifeproduction.slab.com/posts/article-contributors-m3y6vxlc#orcid-test-2" test="matches(.,'^http[s]?://orcid.org/[\d]{4}-[\d]{4}-[\d]{4}-[\d]{3}[0-9X]$')" role="error" id="orcid-test-2">contrib-id[@contrib-id-type="orcid"] must contain a valid ORCID URL in the format 'https://orcid.org/0000-0000-0000-0000'</assert>
    ...
    <assert test="name()=$allowed-children" role="error" id="pub-date-child-test-1"><value-of select="name()"/> is not allowed as a child of pub-date. The only permitted elements are <value-of select="string-join($allowed-children,'; ')"/>.</assert>
      ...
      <report test="ancestor::article/@article-type=('article-commentary','editorial',$notice-article-types)" role="error" id="pub-history-exception-1"><name/> is not permitted in articles with the article-type <value-of select="ancestor::article/@article-type"/>. Either correct the article type if it is wrong or remove the <name/> element.</report>
      ...
      <report test="not(e:is-prc(.)) and ($dtd-version le '1.3') and count(event) gt 1" role="error" id="pub-history-child"><name/> must have one, and only one, event element in in JATS 1.3 (or lower) non-PRC content. This one has <value-of select="count(event)"/>.</report>
      
      <report test="not(e:is-prc(.)) and ($dtd-version ge '1.4') and count(event) gt 3" role="error" id="pub-history-child-1.4"><name/> cannot have more than 3 event elements in JATS 1.4 (or later) non-PRC content. This one has <value-of select="count(event)"/>.</report>
      ...
      <report test="e:is-prc(.) and count(event[self-uri[@content-type='preprint']]) != 1" role="error" id="pub-history-events-2"><name/> must contain one, and only one preprint event (an event with a self-uri[@content-type='preprint'] element). This one has <value-of select="count(event[self-uri[@content-type='preprint']])"/> preprint event elements.</report>
      
      <report test="e:is-prc(.) and count(event[date[@date-type='preprint']]) != 1" role="error" id="pub-history-events-2a"><name/> must contain one, and only one preprint event (an event with a date[@date-type='preprint'] element). This one has <value-of select="count(event[date[@date-type='preprint']])"/> preprint event elements.</report>
      ...
      <report test="e:is-prc(.) and ($dtd-version ge '1.4') and count(event/date[@date-type='sent-for-review']) != 1" role="error" id="pub-history-events-5"><name/> has <value-of select="count(event/date[@date-type='sent-for-review'])"/> sent for review event elements. Under JATS version <value-of select="$dtd-version"/> this must be captured in pub-history.</report>
      ...
      <assert test="date[@date-type=$date-type-vals]" role="error" id="event-test-2"><name/> must contain a date element with a date-type attribute with one of the following values: <value-of select="string-join($date-type-vals,'; ')"/>. This one does not.</assert>
      
      <report test="not(date[@date-type=('received','accepted','sent-for-review')]) and not(self-uri)" role="error" id="event-test-3"><name/> must contain a self-uri element. This one does not.</report>
      ...
      <report test="self::self-uri and parent::event/date[@date-type='sent-for-review']" role="error" id="sent-for-review-event-test-1"><name/> is not allowed in a sent for review event element. The only permitted children of that event type are <value-of select="string-join($allowed-elems[.!='self-uri'],', ')"/>.</report>
    </rule></pattern><pattern id="event-desc-tests-pattern"><rule context="event-desc" id="event-desc-tests">
      
      <report test="(parent::event/date[@date-type='preprint'] or (self-uri and not(matches(parent::event/self-uri[1]/@xlink:href,'elifesciences\.org|10.7554/e[lL]ife')))) and not(.='Preprint posted' or starts-with(.,'This manuscript was published as a preprint at ') or .='This manuscript was published as a preprint.')" role="error" id="event-desc-content"><name/> that's a child of an event without an eLife DOI must contain the text 'Preprint posted'. This one has '<value-of select="."/>'.</report>
      
      <report test="matches(parent::event/self-uri[1]/@xlink:href,'elifesciences\.org|10.7554/e[lL]ife') and not(matches(.,'^Reviewed preprint v\d$') or .=('This manuscript was published as a reviewed preprint.','The reviewed preprint was revised.'))" role="error" id="event-desc-content-2"><name/> that's a child of an event with an eLife DOI must contain the text 'Reviewed preprint v0' (or in older content 'This manuscript was published as a reviewed preprint.' or 'The reviewed preprint was revised.'). This one has '<value-of select="."/>'.</report>
      
      <report test="parent::event/date[@date-type='sent-for-review'] and not(.='Sent for review')" role="error" id="event-desc-content-3"><name/> that's a child of a sent for review event must contain the text 'Sent for review'. This one has '<value-of select="."/>'.</report>
      ...
      <assert test="@date-type=$date-type-vals" role="error" id="event-date-type"><name/> in event must have a date-type attribute with one of the following values: <value-of select="string-join($date-type-vals,'; ')"/>.</assert>
      ...
      <assert test="@content-type=$allowed-content-vals" role="error" id="event-self-uri-content-type"><name/> in event must have the attribute content-type with one of the following values: <value-of select="string-join($allowed-content-vals,'; ')"/>. This one does not.</assert>
      
      <report test="@content-type=('preprint','reviewed-preprint') and (* or normalize-space(.)!='')" role="error" id="event-self-uri-content-1"><name/> with the content-type <value-of select="@content-type"/> must not have any child elements or text. This one does.</report>
      
      <report test="@content-type='editor-report' and (* or not(matches(.,'^eLife [Aa]ssessment$')))" role="error" id="event-self-uri-content-2"><name/> with the content-type <value-of select="@content-type"/> must not have any child elements, and contain the text 'eLife Assessment'. This one does not.</report>
        
      <report test="@content-type='referee-report' and (* or .='')" role="error" id="event-self-uri-content-3"><name/> with the content-type <value-of select="@content-type"/> must not have any child elements, and contain the title of the public review as text. This self-uri either has child elements or it is empty.</report>
        
      <report test="@content-type='author-comment' and (* or not(matches(.,'^Author [Rr]esponse:?\s?$')))" role="error" id="event-self-uri-content-4"><name/> with the content-type <value-of select="@content-type"/> must not have any child elements, and contain the title of the text 'Author response'. This one does not.</report>
      
      <report test="not($content-type=('referee-report')) and preceding-sibling::self-uri[@content-type=$content-type]" role="error" id="event-self-uri-content-5"><name/> with the content-type <value-of select="@content-type"/> is preceded by self-uri(s) with the same content-type. This only permitted for self-uri elements with @content-type="referee-report" within the same event.</report>
	...
	<assert test="license" role="error" id="permissions-test-5">permissions must contain license.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#clintrial-related-object-14" test="ends-with(@xlink:href,'.')" role="error" id="clintrial-related-object-14"><name/> has a @xlink:href attribute value which ends with a full stop, which is not correct - '<value-of select="@xlink:href"/>'.</report>

      <report see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#clintrial-related-object-15" test="ends-with(@document-id,'.')" role="error" id="clintrial-related-object-15"><name/> has an @document-id attribute value which ends with a full stop, which is not correct - '<value-of select="@document-id"/>'.</report>

      <report see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#clintrial-related-object-16" test="ends-with(.,'.')" role="error" id="clintrial-related-object-16">Content within <name/> element ends with a full stop, which is not correct - '<value-of select="."/>'.</report>
    ...
    <assert see="https://elifeproduction.slab.com/posts/affiliations-js7opgq6#h5tdf-aff-test-1" test="parent::contrib-group//contrib//xref/@rid = @id" role="error" id="aff-test-1">aff elements that are direct children of contrib-group must have an xref in that contrib-group pointing to them.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/funding-3sv64358#known-grant-funder-grant-doi-test-1" test="$grant-matches" role="warning" id="known-grant-funder-grant-doi-test-1">Funding entry from <value-of select="funding-source/institution-wrap/institution"/> has an award-id (<value-of select="$award-id-elem"/>) which could potentially be replaced with a grant DOI. The following grant DOIs are possibilities: <value-of select="string-join(distinct-values(for $grant in $grant-matches return concat('https://doi.org/',$grant/@doi)),'; ')"/>.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/funding-3sv64358#institution-id-test-5" test="@institution-id-type='FundRef' and (normalize-space(.) != '') and not(matches(.,'^http[s]?://d?x?\.?doi.org/10.13039/\d*$'))" role="error" id="institution-id-test-5"><name/> element in funding entry for <value-of select="parent::institution-wrap/institution"/> has the institution-id-type 'fundref' and contains the following text - <value-of select="."/> - which is not a fundref doi.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/keywords-and-research-organisms-mq0bozp9#ro-kwd-presence-test" test="kwd" role="warning" id="ro-kwd-presence-test">kwd-group must contain at least one kwd</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/keywords-and-research-organisms-mq0bozp9#kwd-upper-case" test="substring(.,1,1) = upper-case(substring(.,1,1))" role="error" id="kwd-upper-case">research-organism kwd elements should start with an upper-case letter.</assert>
  ...
  <pattern id="p-tests-pattern"><rule context="p" id="p-tests">
    ...
    <report test="not(ancestor::fig/permissions[contains(.,'phylopic')]) and matches(@xlink:href,'phylopic\.org')" role="warning" id="phylopic-link-check">This link is to phylopic.org, which is a site where silhouettes/images are typically reproduced from. Please check whether any figures contain reproduced images from this site, and if so whether permissions have been obtained and/or copyright statements are correctly included.</report>
      ...
      <report test="matches(@xlink:href,'^mailto:')" role="error" id="ext-link-mailto-check">Embedded URL within text starts with the mailto prefix - <value-of select="if (not(. = (@xlink:href,replace(@xlink:href,'^mailto:','')))) then concat(@xlink:href,' embedded in ',.) else ."/>. This will fail ingestion at PMC. Remove this link (the text can remain).</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#fig-group-child-test-2" test="(local-name() = 'media') and not(contains(@mimetype,'video'))" role="error" id="fig-group-child-test-2"><name/> which is a child of fig-group, must have an @mimetype containing 'video' - i.e. only video type media is allowed as a child of fig-group.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#graphic-test-1" test="contains($mime-subtype,'tiff') and not(matches($file,'\.tif$|\.tiff$'))" role="error" id="graphic-test-1"><name/> has tif mime-subtype but filename does not end with '.tif' or '.tiff'. This cannot be correct.</report>
      
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#graphic-test-2" test="contains($mime-subtype,'postscript') and not(ends-with($file,'.eps'))" role="error" id="graphic-test-2"><name/> has postscript mime-subtype but filename does not end with '.eps'. This cannot be correct.</report>
      
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#graphic-test-3" test="contains($mime-subtype,'jpeg') and not(matches($file,'\.jpg$|\.jpeg$'))" role="error" id="graphic-test-3"><name/> has jpeg mime-subtype but filename does not end with '.jpg' or '.jpeg'. This cannot be correct.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#graphic-test-4" test="$dtd-version le '1.3' and not(@mimetype=('image','application'))" role="error" id="graphic-test-4"><name/> must have a @mimetype='image' or 'application'.</report>
      
      <report test="$dtd-version ge '1.4' and not(matches(@mimetype,'^(image|application)/'))" role="error" id="graphic-test-4a"><name/> must have a mimetype that starts with 'image'. This one is '<value-of select="@mimetype"/>'.</report>
      
      <assert see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#graphic-test-5" test="matches(@xlink:href,'\.[\p{L}\p{N}]{1,6}$')" role="error" id="graphic-test-5"><name/> must have an @xlink:href which contains a file reference.</assert>
      ...
      <report test="($dtd-version ge '1.4') and @mime-subtype" role="error" id="media-test-2a">media has a mime-subtype attribute, but this is depcreated in JATS v<value-of select="$dtd-version"/>. Add it to the existing mimetype, i.e. <value-of select="concat(@mimetype,'/',@mime-subtype)"/></report>
      ...
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#media-test-5" test="matches(label[1],'[Aa]nimation') and not($file='gif')" role="error" id="media-test-5"><value-of select="label"/> media with animation type label must have a mimetype ending with 'gif' (or mime-subtype='gif'). This one has '<value-of select="$file"/>'.</report>
      
      <report test="matches(label[1],'[Aa]nimation') and not(starts-with(@mimetype,'video'))" role="error" id="media-test-5a"><value-of select="label"/> media with animation type label must have a mimetype containing 'video'. This one has '<value-of select="@mimetype"/>'.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-video-title" test="not(ancestor::sub-article) and not(caption/title)" role="error" id="final-video-title"><value-of select="replace(label,'\.$,','')"/> does not have a title, which is incorrect.</report>
      
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-video-title-sa" test="ancestor::sub-article and not(caption/title)" role="warning" id="final-video-title-sa"><value-of select="replace(label,'\.$,','')"/> does not have a title, which is incorrect.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/maths-0gfptlyl#inline-formula-test-3" test="not($post-text/preceding-sibling::*[1]/local-name()='disp-formula') and not(parent::*[name()=('td','th')] and following-sibling::node()[1]/name()='break') and matches($post-text,'^[\p{L}\p{N}\p{M}]')" role="warning" id="inline-formula-test-3">There is no space between inline-formula and the following text - <value-of select="concat(descendant::mml:math[1],substring($post-text,1,15))"/> - Is this correct?</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/maths-0gfptlyl#math-test-19" test="descendant::mml:mi[(.='') and preceding-sibling::*[1][(local-name() = 'mi') and matches(.,'[A-Za-z]')] and following-sibling::*[1][(local-name() = 'mi') and matches(.,'[A-Za-z]')]]" role="warning" id="math-test-19">Maths containing '<value-of select="."/>' has what looks like words or terms which need separating with a space. With it's current markup the space will not be preserved on the eLife website. Please add in the space(s) using the latex '\;' in the appropriate place(s), so that the space is preserved in the HTML.</report>
      
      <report test="matches(.,'\p{Zs}\p{Zs}\p{Zs}\p{Zs}+$') and not(matches(.,'\s\s\s\s+$'))" role="error" id="math-test-20"><value-of select="ancestor::*[name()=('inline-formula','disp-formula')][1]/name()"/> ends with 4 or more spaces. These types of spaces may cause the equation to break over numerous lines in the HTML or shift the equation to the left. Please ensure they are removed.</report>
      
      <report test="matches(.,'^\p{Zs}\p{Zs}\p{Zs}\p{Zs}+') and not(matches(.,'^\s\s\s\s+'))" role="error" id="math-test-21"><value-of select="ancestor::*[name()=('inline-formula','disp-formula')][1]/name()"/> starts with 4 or more spaces. These types of spaces may cause the equation to break over numerous lines in the HTML or shift the equation to the right. Please ensure they are removed.</report>
      ...
      <report test="*[1][matches(.,'^\p{Z}*$')]" role="warning" id="math-empty-base-check"><name/> element should not have a missing or empty base expression.</report>
      ...
      <assert test="starts-with(.,'\begin{document}')" role="error" id="tex-math-test-2">Content of <name/> element must start with '\begin{document}'. This one doesn't - <value-of select="."/></assert>
      ...
      <report test="ancestor::disp-formula and not(contains($formula-text,'\displaystyle'))" role="warning" id="tex-math-test-6"><name/> element in a disp-formula does not contain the \displaystyle command. Is that correct? <value-of select="$formula-text"/></report>
      ...
      <report test="exists($arrays-without-spaces)" role="warning" id="tex-math-test-8"><name/> contains array(s) without horizontal or vertical spacing - <value-of select="string-join($arrays-without-spaces,' ---- ')"/></report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-video-cite" test="$xrefs//*:match" role="warning" id="final-video-cite">There is no citation to <value-of select="$label"/>. Ensure this is added.</assert>
      
      
      
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-video-placement-1" test="($xrefs//*:match) and ($sec-id != $sec1/@id)" role="error" id="final-video-placement-1"><value-of select="$label"/> does not appear in the same section as where it is first cited (sec with title '<value-of select="$sec1/title"/>'), which is incorrect.</report>
      
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#video-placement-2" test="($xref-sib = 'p') and ($xref1//following::media/@id = $id)" role="warning" id="video-placement-2"><value-of select="$label"/> appears after its first citation but not directly after its first citation. Is this correct?</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#label-fig-group-conformance-2" test="not(ancestor::fig-group) and parent::media and matches(.,'[Ff]igure')" role="error" id="label-fig-group-conformance-2"><value-of select="$label"/> contains the string 'Figure' but it's not placed in a &lt;fig-group&gt; element, which is incorrect. Either the label needs updating, or it needs moving into the &lt;fig-group&gt;.</report>
  ...
  <pattern id="body-video-specific-pattern"><rule context="article[not(@article-type = $notice-article-types)]/body//media[starts-with(@mimetype,'video')]" id="body-video-specific">
      ...
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-body-video-position-test-1" test="not(ancestor::fig-group) and (matches(label[1],'[Vv]ideo')) and ($no != string($pos))" role="error" id="final-body-video-position-test-1"><value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other videos it is placed in position <value-of select="$pos"/>.</report>
      
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#fig-video-label-test" test="starts-with(label[1],$fig-label)" role="error" id="fig-video-label-test"><value-of select="label"/> does not begin with its parent figure label - <value-of select="$fig-label"/> - which is incorrect.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#fig-video-position-test" test="(ancestor::fig-group) and ($no != string($fig-pos))" role="error" id="fig-video-position-test"><value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other fig-level videos it is placed in position <value-of select="$fig-pos"/>.</report>
      
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#fig-video-check-1" test="(not(ancestor::fig-group)) and (descendant::xref[@ref-type='fig'][contains(.,'igure') and not(contains(.,'supplement'))])" role="warning" id="fig-video-check-1"><value-of select="label"/> contains a link to <value-of select="descendant::xref[@ref-type='fig'][contains(.,'igure') and not(contains(.,'supplement'))][1]"/>, but it is not a captured as a child of that fig. Should it be captured as <value-of select="concat(descendant::xref[@ref-type='fig'][contains(.,'igure') and not(contains(.,'supplement'))][1],'—video x')"/> instead?</report>
      
      <report test="$is-explainer and not(caption/p[matches(lower-case(.),'explainer videos are not peer reviewed')])" role="error" id="explainer-video-check-1"><value-of select="label"/> is an author explainer video, but the caption does not include the text 'Explainer videos are not peer reviewed'.</report>
      
      <report test="$is-explainer and not(caption//supplementary-material[contains(label[1],'data')])" role="error" id="explainer-video-check-2"><value-of select="label"/> is an author explainer video, but it does not have any source data. All author explainer videos should be accompanied by a source data file with a transcript.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-app-video-position-test" test="$no = string($pos)" role="error" id="final-app-video-position-test"><value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other appendix videos it is placed in position <value-of select="$pos"/>.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-app-fig-video-position-test" test="$no = string($pos)" role="error" id="final-app-fig-video-position-test"><value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other appendix videos it is placed in position <value-of select="$pos"/>.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#fig-video-position-test-2" test="not($is-explainer) and following-sibling::fig" role="error" id="fig-video-position-test-2"><value-of select="replace(label,'\.$','')"/> is placed before <value-of select="following-sibling::fig[1]/label[1]"/> Figure level videos should always be placed after figures and figure supplements in their figure group.</report>
      
      <report test="$is-explainer and preceding-sibling::fig[@specific-use='child-fig']" role="error" id="fig-video-position-test-3"><value-of select="replace(label,'\.$','')"/> is placed after <value-of select="preceding-sibling::fig[1]/label[1]"/>. Figure level author explainer videos should always be placed directly after the main figure and before any figure supplements in the figure group.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-dl-video-position-test" test="$no = string($pos)" role="error" id="final-dl-video-position-test"><value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other DL videos it is placed in position <value-of select="$pos"/>.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#final-ar-video-position-test" test="$no = string($pos)" role="error" id="final-ar-video-position-test"><value-of select="label"/> does not appear in sequence which is incorrect. Relative to the other AR videos it is placed in position <value-of select="$pos"/>.</assert>
  ...
  <pattern id="article-title-tests-pattern"><rule context="article-meta//article-title" id="article-title-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#video-title-test-4" test="matches(.,'^\p{Zs}')" role="error" id="video-title-test-4">title for <value-of select="$label"/> begins with a space, which is not allowed.</report>
      
      <report see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#video-title-test-7" test="string-length(.) gt 250" role="warning" id="video-title-test-7">title for <value-of select="$label"/> is longer than 250 characters. Is it a caption instead?</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-title-test" test="article-title = 'Decision letter'" role="error" id="dec-letter-title-test">title-group must contain article-title which contains 'Decision letter'. Currently it is <value-of select="article-title"/>.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-title-test" test="article-title = 'Author response'" role="error" id="reply-title-test">title-group must contain article-title which contains 'Author response'. Currently it is <value-of select="article-title"/>.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/article-title-qhybaifk#title-child-conformance" test="name()=$allowed-elems" role="error" id="title-child-conformance"><name/> is not allowed in a title element. The only permitted elements are <value-of select="string-join($allowed-elems,', ')"/>.</assert>
  ...
  <pattern id="dec-letter-reply-tests-pattern"><rule context="article/sub-article" id="dec-letter-reply-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reply-test-2" test="@id = $id-convention" role="error" id="dec-letter-reply-test-2">sub-article id is <value-of select="@id"/> when based on it's article-type and position it should be <value-of select="$id-convention"/>.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reply-test-3" test="count(front-stub) = 1" role="error" id="dec-letter-reply-test-3">sub-article must contain one and only one front-stub.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reply-test-4" test="count(body) = 1" role="error" id="dec-letter-reply-test-4">sub-article must contain one and only one body.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reply-test-5" test="matches(.,'&lt;[/]?[Aa]uthor response')" role="error" id="dec-letter-reply-test-5"><value-of select="ancestor::sub-article/@article-type"/> paragraph contains what looks like pseudo-code - <value-of select="."/>.</report>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reply-test-6" test="matches(.,'&lt;\p{Zs}?/?\p{Zs}?[a-z]*\p{Zs}?/?\p{Zs}?&gt;')" role="warning" id="dec-letter-reply-test-6"><value-of select="ancestor::sub-article/@article-type"/> paragraph contains what might be pseudo-code or tags which should likely be removed - <value-of select="."/>.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-front-test-1" test="count(article-id[@pub-id-type='doi']) = 1" role="error" id="ed-eval-front-test-1">sub-article front-stub must contain article-id[@pub-id-type='doi'].</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-front-test-2" test="count(contrib-group) = 1" role="error" id="ed-eval-front-test-2">editor report front-stub must contain 1 (and only 1) contrib-group element. This one has <value-of select="count(contrib-group)"/>.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-front-test-3" test="count(related-object) gt 1" role="error" id="ed-eval-front-test-3">editor report front-stub must contain 1 or 0 related-object elements. This one has <value-of select="count(related-object)"/>.</report>

      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-front-test-4" test="e:is-prc(.) and not($article-type='review-article') and not(kwd-group[@kwd-group-type='evidence-strength'])" role="error" id="ed-eval-front-test-4">eLife Assessment front-stub does not contain a strength term keyword group, which must be incorrect.</report>
      
      <report test="e:is-prc(.) and $article-type='review-article' and kwd-group[@kwd-group-type='evidence-strength']" role="error" id="ed-eval-front-test-4b">eLife Assessment front-stub contains a strength term keyword group, but this is a PRC Review article (which don't use the terms), so this must be incorrect.</report>

      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-front-test-5" test="e:is-prc(.) and not($article-type='review-article') and not(kwd-group[@kwd-group-type='claim-importance'])" role="warning" id="ed-eval-front-test-5">eLife Assessment front-stub does not contain a significance term keyword group, which is very unusual. Is that correct?</report>
      
      <report test="e:is-prc(.) and $article-type='review-article' and kwd-group[@kwd-group-type='claim-importance']" role="error" id="ed-eval-front-test-5b">eLife Assessment front-stub contains a significance term keyword group, but this is a PRC Review article (which don't use the terms), so this must be incorrect.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-front-child-test-1" test="name()=('article-id','title-group','contrib-group','kwd-group','related-object')" role="error" id="ed-eval-front-child-test-1"><name/> element is not allowed in the front-stub for an editor report. Only the following elements are permitted: article-id, title-group, contrib-group, kwd-group, related-object.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-contrib-group-test-1" test="count(contrib[@contrib-type='author']) = 1" role="error" id="ed-eval-contrib-group-test-1">editor report contrib-group must contain 1 contrib[@contrib-type='author'].</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-author-test-1" test="$name = $rev-ed-name" role="error" id="ed-eval-author-test-1">The author of the editor report must be the same as the Reviewing editor for the article. The Reviewing editor is <value-of select="$rev-ed-name"/>, but the editor evaluation author is <value-of select="$name"/>.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-rel-obj-test-1" test="matches(@id,'^sa0ro\d$')" role="error" id="ed-eval-rel-obj-test-1">related-object in editor's evaluation must have an id in the format sa0ro1. <value-of select="@id"/> does not meet this convention.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-rel-obj-test-2" test="@object-id-type='id'" role="error" id="ed-eval-rel-obj-test-2">related-object in editor's evaluation must have an object-id-type="id" attribute.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-rel-obj-test-3" test="@link-type='continued-by'" role="error" id="ed-eval-rel-obj-test-3">related-object in editor's evaluation must have a link-type="continued-by" attribute.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-rel-obj-test-4" test="matches(@object-id,'^10\.\d{4,9}/[-._;\+()#/:A-Za-z0-9&lt;&gt;\[\]]+$')" role="error" id="ed-eval-rel-obj-test-4">related-object in editor's evaluation must have an object-id attribute which is a doi. '<value-of select="@object-id"/>' is not a valid doi.</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-eval-rel-obj-test-5" test="@object-id = $event-preprint-doi" role="error" id="ed-eval-rel-obj-test-5">related-object in editor's evaluation must have an object-id attribute whose value is the same as the preprint doi in the article's pub-history. object-id '<value-of select="@object-id"/>' is not the same as the preprint doi in the event history, '<value-of select="$event-preprint-doi"/>'.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-group-1" test="@kwd-group-type=('claim-importance','evidence-strength')" role="error" id="ed-report-kwd-group-1">kwd-group in <value-of select="parent::*/title-group/article-title"/> must have the attribute kwd-group-type with the value 'claim-importance' or 'evidence-strength'. This one does not.</assert>

      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-group-3" test="@kwd-group-type='claim-importance' and count(kwd) gt 1" role="error" id="ed-report-kwd-group-3"><value-of select="@kwd-group-type"/> type kwd-group has <value-of select="count(kwd)"/> keywords: <value-of select="string-join(kwd,'; ')"/>. This is not permitted, please check which single importance keyword should be used.</report>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-group-2" test="@kwd-group-type='evidence-strength' and count(kwd) = 2" role="warning" id="ed-report-kwd-group-2"><value-of select="@kwd-group-type"/> type kwd-group has <value-of select="count(kwd)"/> keywords: <value-of select="string-join(kwd,'; ')"/>. Please check this is correct.</report>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-group-4" test="@kwd-group-type='evidence-strength' and count(kwd) gt 2" role="error" id="ed-report-kwd-group-4"><value-of select="@kwd-group-type"/> type kwd-group has <value-of select="count(kwd)"/> keywords: <value-of select="string-join(kwd,'; ')"/>. This is incorrect.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-claim-kwd-1" test=".=$allowed-vals" role="error" id="ed-report-claim-kwd-1">Keyword contains <value-of select="."/>, but it is in a 'claim-importance' keyword group, meaning it should have one of the following values: <value-of select="string-join($allowed-vals,', ')"/></assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-evidence-kwd-1" test=".=$allowed-vals" role="error" id="ed-report-evidence-kwd-1">Keyword contains <value-of select="."/>, but it is in an 'evidence-strength' keyword group, meaning it should have one of the following values: <value-of select="string-join($allowed-vals,', ')"/></assert>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-evidence-kwd-2" test=".=$wos-no-go-vals and parent::*/kwd[.=$wos-go-vals]" role="warning" id="ed-report-evidence-kwd-2">There is both an <value-of select="."/> and <value-of select="string-join(parent::*/kwd[.=$wos-go-vals],'; ')"/> kwd in the kwd-group for strength of evidence. Should <value-of select="."/> be unbolded or changed to a different word in the Assessment and removed as a keyword?</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-1" test="preceding-sibling::kwd = ." role="error" id="ed-report-kwd-1">Keyword contains <value-of select="."/>, there is another kwd with that value witin the same kwd-group, so this one is either incorrect or superfluous and should be deleted.</report>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-2" test="some $x in ancestor::sub-article[1]/body/p//bold satisfies contains(lower-case($x),lower-case(.))" role="error" id="ed-report-kwd-2">Keyword contains <value-of select="."/>, but this term is not bolded in the text of the <value-of select="ancestor::front-stub/title-group/article-title"/>.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#ed-report-kwd-3" test="*" role="error" id="ed-report-kwd-3">Keywords in <value-of select="ancestor::front-stub/title-group/article-title"/> cannot contain elements, only text. This one has: <value-of select="string-join(distinct-values(*/name()),'; ')"/>.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-front-test-1" test="count(article-id[@pub-id-type='doi']) = 1" role="error" id="dec-letter-front-test-1">sub-article front-stub must contain article-id[@pub-id-type='doi'].</assert>
      
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-front-test-2" test="$count gt 0" role="error" id="dec-letter-front-test-2">decision letter front-stub must contain at least 1 contrib-group element.</assert>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-front-test-3" test="$count gt 2" role="error" id="dec-letter-front-test-3">decision letter front-stub contains more than 2 contrib-group elements.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-editor-test-1" test="count(contrib[@contrib-type='editor']) = 1" role="warning" id="dec-letter-editor-test-1">First contrib-group in decision letter must contain 1 and only 1 editor (contrib[@contrib-type='editor']).</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reviewer-test-1" test="count(contrib[@contrib-type='reviewer']) gt 0" role="error" id="dec-letter-reviewer-test-1">Second contrib-group in decision letter must contain a reviewer (contrib[@contrib-type='reviewer']).</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reviewer-test-6" test="count(contrib[@contrib-type='reviewer']) gt 5" role="warning" id="dec-letter-reviewer-test-6">Second contrib-group in decision letter contains more than five reviewers. Is this correct? Exeter: Please check with eLife. eLife: check eJP to ensure this is correct.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-reviewer-test-3" test="role='Reviewer'" role="error" id="dec-letter-reviewer-test-3">Reviewer in decision letter front-stub must have the role 'Reviewer'. <value-of select="$name"/> has '<value-of select="role"/>'.</assert>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#dec-letter-body-test-1" test="child::*[1]/local-name() = 'boxed-text'" role="error" id="dec-letter-body-test-1">First child element in decision letter is not boxed-text. This is certainly incorrect.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#decision-missing-table-test" test="contains(.,'letter table') and not(descendant::table-wrap[label])" role="warning" id="decision-missing-table-test">A decision letter table is referred to in the text, but there is no table in the decision letter with a label.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-front-test-1" test="count(article-id[@pub-id-type='doi']) = 1" role="error" id="reply-front-test-1">sub-article front-stub must contain article-id[@pub-id-type='doi'].</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-body-test-1" test="count(disp-quote[@content-type='editor-comment']) = 0" role="warning" id="reply-body-test-1">author response doesn't contain a disp-quote. This is very likely to be incorrect. Please check the original file.</report>
      
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-body-test-2" test="count(p) = 0" role="error" id="reply-body-test-2">author response doesn't contain a p. This has to be incorrect.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-disp-quote-test-1" test="@content-type='editor-comment'" role="warning" id="reply-disp-quote-test-1">disp-quote in author reply does not have @content-type='editor-comment'. This is almost certainly incorrect.</assert>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-missing-disp-quote-test-1" test="(count(*)=1) and (child::italic) and ($free-text='')" role="warning" id="reply-missing-disp-quote-test-1">para in author response is entirely in italics, but not in a display quote. Is this a quote which has been processed incorrectly?</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#reply-missing-table-test" test="contains(.,'response table') and not(descendant::table-wrap[label])" role="warning" id="reply-missing-table-test">An author response table is referred to in the text, but there is no table in the response with a label.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#paper-pile-test" test="contains(@xlink:href,'paperpile.com')" role="error" id="paper-pile-test">In the <value-of select="if (ancestor::sub-article[@article-type='reply']) then 'author response' else 'decision letter'"/> the text '<value-of select="."/>' has an embedded hyperlink to <value-of select="@xlink:href"/>. The hyperlink should be removed (but the text retained).</report>
  ...
  <pattern id="ref-report-front-pattern"><rule context="sub-article[@article-type='referee-report']/front-stub" id="ref-report-front">
      ...
      <assert test="name or anonymous or collab or collab-wrap" role="error" id="sub-article-contrib-test-2">sub-article contrib must have either a child name or a child anonymous element.</assert>
      
      <report test="(name and anonymous) or ((collab or collab-wrap) and anonymous) or (name and (collab or collab-wrap))" role="error" id="sub-article-contrib-test-3">sub-article contrib can only have a child name element or a child anonymous element or a child collab element (with descendant group members as required), it cannot have more than one of these elements. This has <value-of select="string-join(for $x in *[name()=('name','anonymous','collab','collab-wrap')] return concat('a ',$x/name()),' and ')"/>.</report>
  ...
  <pattern id="video-parent-conformance-pattern"><rule context="media[starts-with(@mimetype,'video')]" id="video-parent-conformance">
      ...
      <assert see="https://elifeproduction.slab.com/posts/videos-m0p9ve8m#video-parent-test" test="$parent = ('sec','fig-group','body','boxed-text','app')" role="error" id="video-parent-test"><value-of select="replace(label[1],'\.$','')"/> is a child of a &lt;<value-of select="$parent"/>&gt; element. It can only be a child of sec, fig-group, body, boxed-text, or app.</assert>
  ...
  <pattern id="elem-citation-general-pattern"><rule context="element-citation" id="elem-citation-general">
      ...
      <report test="matches(.,'[\[\]\(\)]')" role="warning" id="collab-brackets"><name/> in reference '<value-of select="ancestor::ref/@id"/>' contains brackets - <value-of select="."/>. Are the brackets necessary?</report>
  ...
  <pattern id="ref-list-ordering-pattern"><rule context="ref[preceding-sibling::ref]" id="ref-list-ordering">
      ...
      <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#final-empty-elem-cit-des" test="normalize-space(.)=''" role="error" id="final-empty-elem-cit-des"><name/> element is empty - this is not allowed. It must contain content.</report>
  ...
  <pattern id="elem-citation-web-pattern"><rule context="element-citation[@publication-type='web']" id="elem-citation-web">
      ...
      <report see="https://elifeproduction.slab.com/posts/website-references-ua2hs8qo#final-err-elem-cit-web-11-1" test="count(date-in-citation) lt 1" role="error" id="final-err-elem-cit-web-11-1">Web Reference '<value-of select="ancestor::ref/@id"/>' has no accessed date (&lt;date-in-citation&gt; element) which is required.</report>
      ...
      <assert see="https://elifeproduction.slab.com/posts/website-references-ua2hs8qo#err-elem-cit-web-8-2-1" test="./string-length() + sum(*/string-length()) ge 2" role="error" id="err-elem-cit-web-8-2-1">A  &lt;article-title&gt; element within a &lt;element-citation&gt; of type 'web' must contain 
      ...
      <report see="https://elifeproduction.slab.com/posts/website-references-ua2hs8qo#err-elem-cit-web-11-4" test="if (matches(@iso-8601-date,replace($date-regex,'\p{Zs}',''))) then format-date(xs:date(@iso-8601-date), '[MNn] [D], [Y]')!=.         else ()" role="error" id="err-elem-cit-web-11-4">
 ...
 <pattern id="feature-title-tests-pattern"><rule context="article-meta[descendant::subj-group[@subj-group-type='display-channel']/subject = $features-subj]//title-group/article-title" id="feature-title-tests">
     ...
     <report test="@related-article-type='commentary-article' and not(ancestor::article//ref-list/ref//pub-id[@pub-id-type]/lower-case(.) = lower-case($doi))" role="error" id="insight-related-article-test-2">This Insight is related to <value-of select="$doi"/>, but there is no reference in the ref-list with that doi.</report>
  ...
  <pattern id="rrid-org-code-pattern"><rule context="p|td|th" id="rrid-org-code">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#equal-spacing-test" test="matches(.,'\+cell[s]?|±cell[s]?') and not(descendant::p[matches(.,'\+cell[s]?|±cell[s]?')]) and not(descendant::td[matches(.,'\+cell[s]?|±cell[s]?')]) and not(descendant::th[matches(.,'\+cell[s]?|±cell[s]?')])" role="warning" id="equal-spacing-test"><name/> element contains the text '+cells' or '±cells' which is very likely to be incorrect spacing - <value-of select="."/></report>
  ...
  <pattern id="unlinked-object-cite-pattern"><rule context="fig[not(ancestor::sub-article) and label]|       table-wrap[not(ancestor::sub-article) and label[not(contains(.,'ey resources table'))]]|       media[not(ancestor::sub-article) and label]|       supplementary-material[not(ancestor::sub-article) and label]" id="unlinked-object-cite">
      ...
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#text-v-object-cite-test" test="matches(lower-case($article-text),lower-case($regex))" role="warning" id="text-v-object-cite-test"><value-of select="$cite1"/> has possible unlinked citations in the text.</report>
  ...
  <pattern id="vid-xref-conformance-pattern"><rule context="xref[@ref-type='video']" id="vid-xref-conformance">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#vid-xref-test-4" test="(ancestor::media[starts-with(@mimetype,'video')]/@id = $rids)" role="warning" id="vid-xref-test-4"><value-of select="."/> - video citation is in the caption of the video that it links to. Is it correct or necessary?</report>
  ...
  <pattern id="fig-xref-conformance-pattern"><rule context="xref[@ref-type='fig' and @rid]" id="fig-xref-conformance">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#fig-xref-test-2" test="not(parent::*[name()=('td','th')] and preceding-sibling::node()[1]/name()='break') and matches($pre-text,'[\p{L}\p{N}\p{M}\p{Pe},;]$')" role="warning" id="fig-xref-test-2">There is no space between citation and the preceding text - <value-of select="concat(substring($pre-text,string-length($pre-text)-15),.)"/> - Is this correct?</report>
      
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#fig-xref-test-3" test="not(parent::*[name()=('td','th')] and following-sibling::node()[1]/name()='break') and matches($post-text,'^[\p{L}\p{N}\p{M}\p{Ps}]')" role="warning" id="fig-xref-test-3">There is no space between citation and the following text - <value-of select="concat(.,substring($post-text,1,15))"/> - Is this correct?</report>
  ...
  <pattern id="unallowed-symbol-tests-pattern"><rule context="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" id="unallowed-symbol-tests">		
      ...
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#replacement-character-presence" test="contains(.,'�')" role="error" id="replacement-character-presence"><name/> element contains the replacement character '�' which is not allowed.</report>
      
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#junk-character-presence" test="contains(.,'')" role="error" id="junk-character-presence"><name/> element contains a junk character '' which should be replaced.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#inverterted-question-presence" test="contains(.,'¿')" role="warning" id="inverterted-question-presence"><name/> element contains an inverted question mark '¿' which should very likely be replaced/removed.</report>
      
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#empty-parentheses-presence" test="some $x in self::*[not(local-name() = ('monospace','code'))]/text() satisfies matches($x,'\(\)|\[\]')" role="warning" id="empty-parentheses-presence"><name/> element contains empty parentheses ('[]', or '()'). Is there a missing citation within the parentheses? Or perhaps this is a piece of code that needs formatting?</report>
      
      <report see="https://elifeproduction.slab.com/posts/general-content-2y3029rs#broken-unicode-presence" test="matches(.,'&amp;#x\d')" role="warning" id="broken-unicode-presence"><name/> element contains what looks like a broken unicode - <value-of select="."/>.</report>
      ...
      <report test="matches(., '[ﬀ-ﬆ]')" role="error" id="ligature-presence-1"><name/> element contains the following latin ligature character(s) that need replacing with the regular latin character(s): <value-of select="string-join(distinct-values(e:analyze-string(.,'[ﬀ-ﬆ]')//*:match),'; ')"/>.</report>
      
      <report test="matches(., '[԰-ۿ܀-ॿ฀-࿿]')" role="warning" id="non-roman-script-presence-1"><name/> element contains the following non-roman script character(s): <value-of select="string-join(distinct-values(e:analyze-string(.,'[԰-ۿ܀-ॿ฀-࿿]')//*:match),'; ')"/>. It is unusual for these characters to be present in eLife content. Are they correct?</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/website-references-ua2hs8qo#webreplacement-character-presence" test="matches(.,'�')" role="error" id="webreplacement-character-presence">web citation contains the replacement character '�' which is unallowed - <value-of select="."/></report>
      ...
      <report see="https://elifeproduction.slab.com/posts/website-references-ua2hs8qo#biorxiv-web-test" test="matches($link,'biorxiv.org')" role="warning" id="biorxiv-web-test">web ref '<value-of select="ancestor::ref/@id"/>' has a link which points to a preprint server, bioRxiv, therefore it should almost certainly be captured as a preprint type ref - <value-of select="ext-link"/></report>
      ...
      <report see="https://elifeproduction.slab.com/posts/website-references-ua2hs8qo#peerj-preprints-web-test" test="matches($link,'peerj.com/preprints/')" role="error" id="peerj-preprints-web-test">web ref '<value-of select="ancestor::ref/@id"/>' has a link which points to a preprint server, PeerJ Preprints, therefore it should be captured as a preprint type ref - <value-of select="ext-link"/></report>
      ...
      <report see="https://elifeproduction.slab.com/posts/maths-0gfptlyl#inline-formula-length-test-1" test="string-length(descendant::mml:math[1]) gt 89" role="warning" id="inline-formula-length-test-1">Inline formula containing '<value-of select="descendant::mml:math[1]"/>' is particularly long. Consider either splitting this up into multiple equations or capturing this as a display equation, as the display on Continuum will likely be strange.</report>
      ...
      <report test="matches(caption[1],'[Cc]ourtesy|[Pp]roprietary')" role="warning" id="reproduce-test-9">The caption for <value-of select="$label"/> contains the text 'courtesy' or 'proprietary', but has no permissions. Is this correct?</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/keywords-and-research-organisms-mq0bozp9#auth-kwd-check" test="not(matches(.,'RNA|[Cc]ryoEM|[34]D')) and (. != $lower) and not(contains($t,.))" role="warning" id="auth-kwd-check">Keyword - '<value-of select="."/>' - does not appear in the article text with this capitalisation. Should it be <value-of select="$lower"/> instead?</report>
  ...
  <pattern id="doi-journal-ref-checks-pattern"><rule context="element-citation[(@publication-type='journal') and not(pub-id[@pub-id-type='doi']) and year and source]" id="doi-journal-ref-checks">
      ...
      <report see="https://elifeproduction.slab.com/posts/conference-references-d51f08lj?shr=d51f08lj#h5t13-conf-doi-test-1" test="contains($name,'ieee')" role="warning" id="conf-doi-test-1"><value-of select="e:citation-format1(.)"/> is a conference ref without a doi, but it's a conference which is known to possibly have dois - (<value-of select="conf-name[1]"/>). Should it have one?</report>
  ...
  <pattern id="unicode-tests-pattern"><rule context="sub-article//p[matches(.,'[âÂÅÃËÆ]')]|sub-article//td[matches(.,'[âÂÅÃËÆ]')]|sub-article//th[matches(.,'[âÂÅÃËÆ]')]" id="unicode-tests">
        ...
        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-1" test="contains(.,'â‚¬')" role="warning" id="unicode-test-1"><name/> element contains 'â‚¬' - this should instead be the character '€'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-2" test="contains(.,'Ã€')" role="warning" id="unicode-test-2"><name/> element contains 'Ã€' - this should instead be the character 'À'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-3" test="contains(.,'Ã')" role="warning" id="unicode-test-3"><name/> element contains 'Ã' - this should instead be the character 'Á'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-4" test="contains(.,'â€š')" role="warning" id="unicode-test-4"><name/> element contains 'â€š' - this should instead be the character '‚'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-5" test="contains(.,'Ã‚')" role="warning" id="unicode-test-5"><name/> element contains 'Ã‚' - this should instead be the character 'Â'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-6" test="contains(.,'Æ’')" role="warning" id="unicode-test-6"><name/> element contains 'Æ’' - this should instead be the character 'ƒ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-7" test="contains(.,'Ãƒ')" role="warning" id="unicode-test-7"><name/> element contains 'Ãƒ' - this should instead be the character 'Ã'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-8" test="contains(.,'â€ž')" role="warning" id="unicode-test-8"><name/> element contains 'â€ž' - this should instead be the character '„'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-9" test="contains(.,'Ã„')" role="warning" id="unicode-test-9"><name/> element contains 'Ã„' - this should instead be the character 'Ä'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-10" test="contains(.,'â€¦')" role="warning" id="unicode-test-10"><name/> element contains 'â€¦' - this should instead be the character '…'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-11" test="contains(.,'Ã…')" role="warning" id="unicode-test-11"><name/> element contains 'Ã…' - this should instead be the character 'Å'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-13" test="contains(.,'Ã†')" role="warning" id="unicode-test-13"><name/> element contains 'Ã†' - this should instead be the character 'Æ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-14" test="contains(.,'â€¡')" role="warning" id="unicode-test-14"><name/> element contains 'â€¡' - this should instead be the character '‡'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-15" test="contains(.,'Ã‡')" role="warning" id="unicode-test-15"><name/> element contains 'Ã‡' - this should instead be the character 'Ç'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-16" test="contains(.,'Ë†')" role="warning" id="unicode-test-16"><name/> element contains 'Ë†' - this should instead be the character 'ˆ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-17" test="contains(.,'Ãˆ')" role="warning" id="unicode-test-17"><name/> element contains 'Ãˆ' - this should instead be the character 'È'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-18" test="contains(.,'â€°')" role="warning" id="unicode-test-18"><name/> element contains 'â€°' - this should instead be the character '‰'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-19" test="contains(.,'Ã‰')" role="warning" id="unicode-test-19"><name/> element contains 'Ã‰' - this should instead be the character 'É'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-21" test="contains(.,'ÃŠ')" role="warning" id="unicode-test-21"><name/> element contains 'ÃŠ' - this should instead be the character 'Ê'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-22" test="contains(.,'â€¹')" role="warning" id="unicode-test-22"><name/> element contains 'â€¹' - this should instead be the character '‹'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-23" test="contains(.,'Ã‹')" role="warning" id="unicode-test-23"><name/> element contains 'Ã‹' - this should instead be the character 'Ë'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-24" test="contains(.,'Å’')" role="warning" id="unicode-test-24"><name/> element contains 'Å’' - should this instead be the character 'Œ'? - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-25" test="contains(.,'ÃŒ')" role="warning" id="unicode-test-25"><name/> element contains 'ÃŒ' - this should instead be the character 'Ì'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-26" test="contains(.,'Ã')" role="warning" id="unicode-test-26"><name/> element contains 'Ã' - this should instead be the character 'Í'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-27" test="contains(.,'Å½')" role="warning" id="unicode-test-27"><name/> element contains 'Å½' - this should instead be the character 'Ž'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-28" test="contains(.,'ÃŽ')" role="warning" id="unicode-test-28"><name/> element contains 'ÃŽ' - this should instead be the character 'Î'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-29" test="contains(.,'Ã')" role="warning" id="unicode-test-29"><name/> element contains 'Ã' - this should instead be the character 'Ï'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-30" test="contains(.,'Ã')" role="warning" id="unicode-test-30"><name/> element contains 'Ã' - this should instead be the character 'Ð'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-31" test="contains(.,'â€˜')" role="warning" id="unicode-test-31"><name/> element contains 'â€˜' - this should instead be the character '‘'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-32" test="contains(.,'Ã‘')" role="warning" id="unicode-test-32"><name/> element contains 'Ã‘' - this should instead be the character 'Ñ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-33" test="contains(.,'â€™')" role="warning" id="unicode-test-33"><name/> element contains 'â€™' - this should instead be the character '’'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-34" test="contains(.,'Ã’')" role="warning" id="unicode-test-34"><name/> element contains 'Ã’' - this should instead be the character 'Ò'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-35" test="contains(.,'â€œ')" role="warning" id="unicode-test-35"><name/> element contains 'â€œ' - this should instead be the character '“'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-36" test="contains(.,'Ã“')" role="warning" id="unicode-test-36"><name/> element contains 'Ã“' - this should instead be the character 'Ó'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-37" test="contains(.,'â€')" role="warning" id="unicode-test-37"><name/> element contains 'â€' - this should instead be the character '”'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-38" test="contains(.,'Ã”')" role="warning" id="unicode-test-38"><name/> element contains 'Ã”' - this should instead be the character 'Ô'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-39" test="contains(.,'Ã•')" role="warning" id="unicode-test-39"><name/> element contains 'Ã•' - this should instead be the character 'Õ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-40" test="contains(.,'â€“')" role="warning" id="unicode-test-40"><name/> element contains 'â€“' - this should instead be the character '–'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-41" test="contains(.,'Ã–')" role="warning" id="unicode-test-41"><name/> element contains 'Ã–' - this should instead be the character 'Ö'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-42" test="contains(.,'â€”')" role="warning" id="unicode-test-42"><name/> element contains 'â€”' - this should instead be the character '—'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-43" test="contains(.,'Ã—')" role="warning" id="unicode-test-43"><name/> element contains 'Ã—' - this should instead be the character '×'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-44" test="contains(.,'Ëœ')" role="warning" id="unicode-test-44"><name/> element contains 'Ëœ' - this should instead be the character '˜'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-45" test="contains(.,'Ã˜')" role="warning" id="unicode-test-45"><name/> element contains 'Ã˜' - this should instead be the character 'Ø'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-46" test="contains(.,'Ã™')" role="warning" id="unicode-test-46"><name/> element contains 'Ã™' - this should instead be the character 'Ù'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-47" test="contains(.,'Å¡')" role="warning" id="unicode-test-47"><name/> element contains 'Å¡' - this should instead be the character 'š'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-48" test="contains(.,'Ãš')" role="warning" id="unicode-test-48"><name/> element contains 'Ãš' - this should instead be the character 'Ú'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-49" test="contains(.,'â€º')" role="warning" id="unicode-test-49"><name/> element contains 'â€º' - this should instead be the character '›'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-50" test="contains(.,'Ã›')" role="warning" id="unicode-test-50"><name/> element contains 'Ã›' - this should instead be the character 'Û'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-51" test="contains(.,'Å“')" role="warning" id="unicode-test-51"><name/> element contains 'Å“' - this should instead be the character 'œ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-52" test="contains(.,'Ãœ')" role="warning" id="unicode-test-52"><name/> element contains 'Ãœ' - this should instead be the character 'Ü'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-53" test="contains(.,'Ã')" role="warning" id="unicode-test-53"><name/> element contains 'Ã' - this should instead be the character 'Ý'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-54" test="contains(.,'Å¾')" role="warning" id="unicode-test-54"><name/> element contains 'Å¾' - this should instead be the character 'ž'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-55" test="contains(.,'Ãž')" role="warning" id="unicode-test-55"><name/> element contains 'Ãž' - this should instead be the character 'Þ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-56" test="contains(.,'Å¸')" role="warning" id="unicode-test-56"><name/> element contains 'Å¸' - this should instead be the character 'Ÿ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-57" test="contains(.,'ÃŸ')" role="warning" id="unicode-test-57"><name/> element contains 'ÃŸ' - this should instead be the character 'ß'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-58" test="contains(.,'Â¡')" role="warning" id="unicode-test-58"><name/> element contains 'Â¡' - this should instead be the character '¡'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-59" test="contains(.,'Ã¡')" role="warning" id="unicode-test-59"><name/> element contains 'Ã¡' - this should instead be the character 'á'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-60" test="contains(.,'Â¢')" role="warning" id="unicode-test-60"><name/> element contains 'Â¢' - this should instead be the character '¢'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-61" test="contains(.,'Ã¢')" role="warning" id="unicode-test-61"><name/> element contains 'Ã¢' - this should instead be the character 'â'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-62" test="contains(.,'Â£')" role="warning" id="unicode-test-62"><name/> element contains 'Â£' - this should instead be the character '£'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-63" test="contains(.,'Ã£')" role="warning" id="unicode-test-63"><name/> element contains 'Ã£' - this should instead be the character 'ã'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-64" test="contains(.,'Â¤')" role="warning" id="unicode-test-64"><name/> element contains 'Â¤' - this should instead be the character '¤'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-65" test="contains(.,'Ã¤')" role="warning" id="unicode-test-65"><name/> element contains 'Ã¤' - this should instead be the character 'ä'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-66" test="contains(.,'Ã¥')" role="warning" id="unicode-test-66"><name/> element contains 'Ã¥' - this should instead be the character 'å'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-67" test="contains(.,'Â¨')" role="warning" id="unicode-test-67"><name/> element contains 'Â¨' - this should instead be the character '¨'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-68" test="contains(.,'Ã¨')" role="warning" id="unicode-test-68"><name/> element contains 'Ã¨' - this should instead be the character 'è'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-69" test="contains(.,'Âª')" role="warning" id="unicode-test-69"><name/> element contains 'Âª' - this should instead be the character 'ª'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-70" test="contains(.,'Ãª')" role="warning" id="unicode-test-70"><name/> element contains 'Ãª' - this should instead be the character 'ê'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-71" test="contains(.,'Â­')" role="warning" id="unicode-test-71"><name/> element contains 'Â­' - this should instead be the character '­'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-72" test="contains(.,'Ã­')" role="warning" id="unicode-test-72"><name/> element contains 'Ã­' - this should instead be the character 'í'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-73" test="contains(.,'Â¯')" role="warning" id="unicode-test-73"><name/> element contains 'Â¯' - this should instead be the character '¯'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-74" test="contains(.,'Ã¯')" role="warning" id="unicode-test-74"><name/> element contains 'Ã¯' - this should instead be the character 'ï'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-75" test="contains(.,'Â°')" role="warning" id="unicode-test-75"><name/> element contains 'Â°' - this should instead be the character '°'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-76" test="contains(.,'Ã°')" role="warning" id="unicode-test-76"><name/> element contains 'Ã°' - this should instead be the character 'ð'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-77" test="contains(.,'Â±')" role="warning" id="unicode-test-77"><name/> element contains 'Â±' - this should instead be the character '±'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-78" test="contains(.,'Ã±')" role="warning" id="unicode-test-78"><name/> element contains 'Ã±' - this should instead be the character 'ñ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-79" test="contains(.,'Â´')" role="warning" id="unicode-test-79"><name/> element contains 'Â´' - this should instead be the character '´'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-80" test="contains(.,'Ã´')" role="warning" id="unicode-test-80"><name/> element contains 'Ã´' - this should instead be the character 'ô'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-81" test="contains(.,'Âµ')" role="warning" id="unicode-test-81"><name/> element contains 'Âµ' - this should instead be the character 'µ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-82" test="contains(.,'Ãµ')" role="warning" id="unicode-test-82"><name/> element contains 'Ãµ' - this should instead be the character 'õ'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-83" test="contains(.,'Â¶')" role="warning" id="unicode-test-83"><name/> element contains 'Â¶' - this should instead be the character '¶'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-84" test="contains(.,'Ã¶')" role="warning" id="unicode-test-84"><name/> element contains 'Ã¶' - this should instead be the character 'ö'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-85" test="contains(.,'Â·')" role="warning" id="unicode-test-85"><name/> element contains 'Â·' - this should instead be the character '·'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-86" test="contains(.,'Ã·')" role="warning" id="unicode-test-86"><name/> element contains 'Ã·' - this should instead be the character '÷'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-87" test="contains(.,'Â¸')" role="warning" id="unicode-test-87"><name/> element contains 'Â¸' - this should instead be the character '¸'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-88" test="contains(.,'Ã¸')" role="warning" id="unicode-test-88"><name/> element contains 'Ã¸' - this should instead be the character 'ø'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-89" test="contains(.,'Ã¹')" role="warning" id="unicode-test-89"><name/> element contains 'Ã¹' - this should instead be the character 'ù'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-90" test="contains(.,'Âº')" role="warning" id="unicode-test-90"><name/> element contains 'Âº' - this should instead be the character 'º'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-91" test="contains(.,'Ãº')" role="warning" id="unicode-test-91"><name/> element contains 'Ãº' - this should instead be the character 'ú'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-92" test="contains(.,'Â¿')" role="warning" id="unicode-test-92"><name/> element contains 'Â¿' - this should instead be the character '¿'. - <value-of select="."/>.</report>

        <report see="https://elifeproduction.slab.com/posts/review-materials-r9uiav3j#unicode-test-93" test="contains(.,'Ã¿')" role="warning" id="unicode-test-93"><name/> element contains 'Ã¿' - this should instead be the character 'ÿ'. - <value-of select="."/>.</report>
