<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:file="java.io.File" xmlns:java="http://www.java.com/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" queryBinding="xslt2">
 ...
 <pattern id="feature-title-tests-pattern"><rule context="article-meta[descendant::subj-group[@subj-group-type='display-channel']/subject = $features-subj]//title-group/article-title" id="feature-title-tests">
  ...
  <pattern id="correction-tests-pattern"><rule context="article[@article-type = 'correction']" id="correction-tests">
      ...
      <report test="descendant::article-meta//aff" role="error" id="retr-aff-presence"><value-of select="$display-subject"/> notices should not contain affiliations.</report>
      
      <report test="descendant::fn-group[@content-type='competing-interest']" role="error" id="retr-COI-presence"><value-of select="$display-subject"/> notices should not contain competing interests.</report>
      
      <report test="descendant::self-uri" role="error" id="retr-self-uri-presence"><value-of select="$display-subject"/> notices should not contain a self-uri element (as the PDF is not published).</report>
      ...
      <report test="back/*" role="error" id="retr-back"><value-of select="$display-subject"/> notices should not contain any content in the back.</report>
      
      <report test="descendant::meta-name[text() = 'Author impact statement']" role="error" id="retr-impact-statement"><value-of select="$display-subject"/> notices should not contain an impact statement.</report>
      
      <report test="descendant::contrib-group[@content-type='section']" role="error" id="retr-SE-BRE"><value-of select="$display-subject"/> notices must not contain any Senior or Reviewing Editors.</report>
