 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="research-article-sub-article-pattern">
    <rule context="article[@article-type='research-article' and sub-article]" id="research-article-sub-article">
     ...
     <report test="$disp-channel != 'Scientific Correspondence' and not(sub-article[not(@article-type=('reply','author-comment'))])" role="error" id="r-article-sub-articles">
  ...
  <pattern id="article-dois-non-prc-pattern">
    <rule context="article[not(e:is-prc(.))]/front/article-meta/article-id[@pub-id-type='doi']" id="article-dois-non-prc">
      ...
      <assert test="starts-with(.,'10.7554/eLife.')" role="error" id="nprc-article-dois-1">Article level DOI must start with '10.7554/eLife.'. Currently it is <value-of select="."/>
      </assert>
  ...
  <pattern id="auth-cont-tests-v2-pattern">
    <rule context="article[@article-type=('research-article','review-article') and e:get-version(.)!='1']//article-meta//contrib[(@contrib-type='author') and not(child::collab) and not(ancestor::collab)]" id="auth-cont-tests-v2">
      ...
      <assert test="role" role="warning" id="auth-cont-test-1-v2">
        <value-of select="e:get-name(name[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
      
      <report test="role and not(role[@vocab='credit'])" role="warning" id="auth-cont-test-2-v2">
  ...
  <pattern id="collab-cont-tests-v2-pattern">
    <rule context="article[@article-type=('research-article','review-article') and e:get-version(.)!='1']//article-meta//contrib[(@contrib-type='author') and child::collab]" id="collab-cont-tests-v2">
      ...
      <assert test="role" role="error" id="final-collab-cont-test-1-v2">
        <value-of select="e:get-collab(child::collab[1])"/> has no contributions. Please ensure to query this with the authors.</assert>
      
      <report test="role and not(role[@vocab='credit'])" role="warning" id="final-collab-cont-test-2-v2">
  ...
  <pattern id="author-children-tests-v2-pattern">
    <rule context="article[e:get-version(.)!='1']//article-meta//contrib[@contrib-type='author']/*" id="author-children-tests-v2">
      ...
      <!-- Exception included for group authors -->
      <assert test="if (ancestor::collab) then self::*[local-name() = ($allowed-contrib-blocks,'aff')]         else if ($template = '5') then self::*[local-name() = $allowed-contrib-blocks-features]         else if ($article-type = $features-article-types) then self::*[local-name() = $allowed-contrib-blocks-features]         else self::*[local-name() = $allowed-contrib-blocks]" role="error" id="author-children-test-v2">
        <value-of select="self::*/local-name()"/> is not allowed as a child of author.</assert>
  ...
  <pattern id="abstract-tests-pattern">
    <rule context="front//abstract" id="abstract-tests">
	  ...
	  <report see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#abstract-test-6" test="matches(lower-case(.),'^\p{Zs}*abstract')" role="warning" id="abstract-test-6">Abstract starts with the word 'Abstract', which is almost certainly incorrect - <value-of select="."/>
      </report>
  ...
  <pattern id="medicine-abstract-tests-2-pattern">
    <rule context="article[@article-type='research-article']//article-meta[article-categories[not(subj-group[@subj-group-type='display-channel']/subject[lower-case(.)='feature article'])]/subj-group[@subj-group-type='heading']/subject[. = ('Medicine','Epidemiology and Global Health')] and history/date[@date-type='received' and @iso-8601-date]]/abstract[not(@abstract-type) and not(sec)]" id="medicine-abstract-tests-2">
      ...
      <assert see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#medicine-abstract-conformance-2" test="parent::article-meta/history/date[@date-type='received']/@iso-8601-date lt '2021-04-05'" role="warning" id="medicine-abstract-conformance-2">
  ...
  <pattern id="fig-tests-pattern">
    <rule context="fig[not(ancestor::sub-article)]" id="fig-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#final-fig-test-4" test="not($article-type = ('discussion',$notice-article-types)) and not(caption)" role="error" id="final-fig-test-4">
  ...
  <pattern id="supplementary-material-tests-pattern">
    <rule context="supplementary-material" id="supplementary-material-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/additional-files-60jpvalx#supplementary-material-test-2" test="not(matches(label[1],'Transparent reporting form|MDAR checklist')) and not(caption)" role="warning" id="supplementary-material-test-2">
      ...
      <report see="https://elifeproduction.slab.com/posts/additional-files-60jpvalx#final-supplementary-material-test-3" test="if (caption) then not(caption/title)         else ()" role="warning" id="final-supplementary-material-test-3">
      ...
      <report see="https://elifeproduction.slab.com/posts/additional-files-60jpvalx#supplementary-material-test-11" test="contains(lower-case(caption[1]/title[1]),'key resource')" role="warning" id="supplementary-material-test-11">
  ...
  <pattern id="back-source-data-tests-pattern">
    <rule context="sec[@sec-type='supplementary-material']/supplementary-material[contains(label[1],'ource data')]" id="back-source-data-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/additional-files-60jpvalx#back-source-data-position" test="string($pos) = $no" role="error" id="back-source-data-position">
        <value-of select="replace(label,'\.$','')"/> id ends with <value-of select="$no"/>, but it is placed <value-of select="e:get-ordinal($pos)"/>. Either it is mislabelled, the id is incorrect, or it should be moved to a different position.</assert>
  ...
  <pattern id="source-data-specific-tests-pattern">
    <rule context="supplementary-material[(ancestor::fig) or (ancestor::media) or (ancestor::table-wrap)]" id="source-data-specific-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/additional-files-60jpvalx#fig-data-test-1" test="matches(label[1],'^Figure \d{1,4}—source data \d{1,4}|^Appendix \d{1,4}—figure \d{1,4}—source data \d{1,4}') and (count(descendant::xref[@ref-type='fig'])=1) and (descendant::xref[(@ref-type='fig') and contains(.,'upplement')])" role="warning" id="fig-data-test-1">
  ...
  <pattern id="table-title-tests-pattern">
    <rule context="table-wrap[not(ancestor::sub-article) and not(contains(@id,'keyresource')) and label]" id="table-title-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/tables-3nehcouh#final-table-title-test-1" test="caption/title" role="error" id="final-table-title-test-1">
  ...
  <pattern id="app-table-label-tests-pattern">
    <rule context="app//table-wrap/label" id="app-table-label-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/tables-3nehcouh#app-table-label-test-2" test="starts-with(.,$app)" role="error" id="app-table-label-test-2">
  ...
  <pattern id="list-item-tests-pattern">
    <rule context="list-item" id="list-item-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/general-layout-and-formatting-wq0m31at#hd4i0-list-item-test-1" test="matches(.,'^\p{Zs}?\p{Ll}[\p{Zs}\)\.]')" role="warning" id="list-item-test-1">list-item begins with a single lowercase letter, is this correct? - <value-of select="."/>
      </report>
    </rule>
  </pattern>
  ...
  <pattern id="disp-quote-tests-pattern">
    <rule context="disp-quote" id="disp-quote-tests">
      ...
      <report test="ancestor::sub-article[not(@article-type=('reply','author-comment'))]" role="warning" id="disp-quote-test-1">Content is tagged as a display quote, which is almost definitely incorrect, since it's within peer review material that is not an author response - <value-of select="."/>
      </report>
  ...
  <pattern id="fig-specific-tests-pattern">
    <rule context="article/body//fig[not(@specific-use='child-fig')][not(ancestor::boxed-text)]" id="fig-specific-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#final-fig-specific-test-2" test="if ($article-type = $notice-article-types) then ()         else if ($count = 0) then ()         else if (not(matches($id,'^fig[0-9]{1,3}$'))) then ()         else $no != string($pos)" role="error" id="final-fig-specific-test-2">
      ...
      <report see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#fig-specific-test-6" test="($fol-sib/local-name() = 'p') and ($fol-sib/*/local-name() = 'disp-formula') and (count($fol-sib/*[1]/preceding-sibling::text()) = 0) and (not(matches($pre-sib,'\.\p{Zs}*?$|\?\p{Zs}*?$|!\p{Zs}*?$')))" role="warning" id="fig-specific-test-6">
  ...
  <pattern id="fig-sup-tests-pattern">
    <rule context="article/body//fig[@specific-use='child-fig']" id="fig-sup-tests">
      ...
      <assert see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#fig-sup-test-3" test="starts-with(label[1],concat('Figure ',$parent-fig-no))" role="error" id="fig-sup-test-3">
      ...
      <report see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#fig-sup-test-4" test="if ($article-type = $notice-article-types) then ()         else $no != string($pos)" role="error" id="fig-sup-test-4">
      ...
      <report see="https://elifeproduction.slab.com/posts/figures-and-figure-supplements-8gb4whlr#fig-sup-test-5" test="if ($article-type = $notice-article-types) then ()         else ($label-conforms and ($label-no != string($pos)))" role="error" id="fig-sup-test-5">
  ...
  <pattern id="fig-permissions-pattern">
    <rule context="permissions[not(parent::article-meta)]" id="fig-permissions">
      ...
      <assert see="https://elifeproduction.slab.com/posts/licensing-and-copyright-rqdavyty#permissions-parent" test="parent::*/local-name() = ('fig', 'media', 'table-wrap', 'boxed-text', 'supplementary-material')" role="error" id="permissions-parent">permissions is not allowed as a child of <value-of select="parent::*/local-name()"/>
      </assert>
  ...
  <pattern id="permissions-2-pattern">
    <rule context="permissions[not(parent::article-meta) and copyright-statement and not(license[1]/ali:license_ref[1][contains(.,'creativecommons.org')]) and not(contains(license[1]/@xlink:href,'creativecommons.org'))]" id="permissions-2">
      ...
      <report see="https://elifeproduction.slab.com/posts/licensing-and-copyright-rqdavyty#fig-permissions-test-13" test="license//ext-link[contains(@xlink:href,'creativecommons.org')]" role="warning" id="fig-permissions-test-13">
  ...
  <pattern id="title-child-tests-pattern">
    <rule context="title/*" id="title-child-tests">
      ...
      <assert test="name()=$allowed-elems" role="error" id="title-child-conformance">
        <name/> is not allowed in a title element. The only permitted elements are <value-of select="string-join($allowed-elems,', ')"/>.</assert>
  ...
  <pattern id="supplementary-material-children-pattern">
    <rule context="supplementary-material/*" id="supplementary-material-children">
      ...
      <assert see="https://elifeproduction.slab.com/posts/additional-files-60jpvalx#supplementary-material-child-conformance" test="local-name() = $allowed-children" role="error" id="supplementary-material-child-conformance">
  ...
  <pattern id="author-notes-children-pattern">
    <rule context="author-notes/*" id="author-notes-children">
      ...
      <assert test="local-name() = 'fn'" role="error" id="author-notes-child-conformance">
        <name/> is not allowed as a child of author-notes.</assert>
    </rule>
  </pattern>
  ...
  <pattern id="dec-letter-reply-content-tests-pattern">
    <rule context="article/sub-article//p" id="dec-letter-reply-content-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/decision-letters-and-author-responses-rr1pcseo#dec-letter-reply-test-5" test="matches(.,'&lt;[/]?[Aa]uthor response')" role="error" id="dec-letter-reply-test-5">
        <value-of select="ancestor::sub-article/@article-type"/> paragraph contains what looks like pseudo-code - <value-of select="."/>.</report>
      
      <report see="https://elifeproduction.slab.com/posts/decision-letters-and-author-responses-rr1pcseo#dec-letter-reply-test-6" test="matches(.,'&lt;\p{Zs}?/?\p{Zs}?[a-z]*\p{Zs}?/?\p{Zs}?&gt;')" role="warning" id="dec-letter-reply-test-6">
  ...
  <pattern id="dec-letter-reply-content-tests-2-pattern">
    <rule context="article/sub-article//p[not(ancestor::disp-quote)]" id="dec-letter-reply-content-tests-2">
      ...
      <report see="https://elifeproduction.slab.com/posts/decision-letters-and-author-responses-rr1pcseo#dec-letter-reply-test-7" test="matches(.,$regex)" role="warning" id="dec-letter-reply-test-7">
  ...
  <pattern id="ed-eval-front-child-tests-pattern">
    <rule context="sub-article[@article-type='editor-report']/front-stub/*" id="ed-eval-front-child-tests">
      ...
      <assert test="name()=('article-id','title-group','contrib-group','kwd-group','related-object')" role="error" id="ed-eval-front-child-test-1">
  ...
  <pattern id="ed-report-kwd-group-pattern">
    <rule context="sub-article[@article-type='editor-report']/front-stub/kwd-group" id="ed-report-kwd-group">
      ...
      <report test="@kwd-group-type=('claim-importance','evidence-strength') and count(kwd) gt 2" role="warning" id="ed-report-kwd-group-2">
  ...
  <pattern id="sub-article-ref-p-tests-pattern">
    <rule context="sub-article[@article-type='reply']/body/*[last()][name()='p']" id="sub-article-ref-p-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/decision-letters-and-author-responses-rr1pcseo#sub-article-ref-p-test" test="count(tokenize(lower-case(.),'doi\p{Zs}?:')) gt 2" role="warning" id="sub-article-ref-p-test">The last paragraph of the author response looks like it contains various references. Should each reference be split out into its own paragraph? <value-of select="."/>
      </report>
    </rule>
  </pattern>
  ...
  <pattern id="elem-citation-general-pattern">
    <rule context="element-citation" id="elem-citation-general">
      ...
      <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#fpage-lpage-test-1" test="(fpage) and not(lpage)" role="warning" id="fpage-lpage-test-1">
  ...
  <pattern id="pub-id-tests-pattern">
    <rule context="element-citation/pub-id" id="pub-id-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#pub-id-test-5" test="ends-with(.,'.')" role="error" id="pub-id-test-5">
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="feature-abstract-tests-pattern">
    <rule context="front//abstract[@abstract-type=('executive-summary','plain-language-summary')]" id="feature-abstract-tests">
     ...
     <assert see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#feature-abstract-test-2" test="title = 'eLife digest'" role="error" id="feature-abstract-test-2">abstract title must contain 'eLife digest'. Possible superfluous characters - <value-of select="replace(title,'eLife digest','')"/>
      </assert>
  ...
  <pattern id="feature-subj-tests-pattern">
    <rule context="subj-group[@subj-group-type='sub-display-channel']/subject" id="feature-subj-tests">		
     ...
     <report see="https://elifeproduction.slab.com/posts/feature-content-alikl8qp#feature-subj-test-2" test=". != e:titleCase(.)" role="error" id="feature-subj-test-2">The content of the sub-display-channel should be in title case - <value-of select="e:titleCase(.)"/>
      </report>
  ...
  <pattern id="feature-bio-tests-pattern">
    <rule context="article//article-meta[article-categories//subj-group[@subj-group-type='display-channel']/subject=$features-subj]//contrib[@contrib-type='author']/bio" id="feature-bio-tests">
     ...
     <assert see="https://elifeproduction.slab.com/posts/feature-content-alikl8qp#feature-bio-test-4" test="(count(p) = 1)" role="error" id="feature-bio-test-4">One and only 1 &lt;p&gt; is allowed as a child of bio. <value-of select="."/>
      </assert>
     
     <report see="https://elifeproduction.slab.com/posts/feature-content-alikl8qp#feature-bio-test-5" test="*[local-name()!='p']" role="error" id="feature-bio-test-5">
  ...
  <pattern id="feature-template-tests-pattern">
    <rule context="article[descendant::article-meta/article-categories/subj-group[@subj-group-type='display-channel']/subject = $features-subj]" id="feature-template-tests">
     ...
     <report see="https://elifeproduction.slab.com/posts/feature-content-alikl8qp#feature-template-test-1" test="($template = ('1','2','3')) and child::sub-article" role="error" id="feature-template-test-1">
     ...
     <report see="https://elifeproduction.slab.com/posts/feature-content-alikl8qp#feature-template-test-2" test="($template = '5') and not(@article-type='research-article')" role="error" id="feature-template-test-2">
  ...
  <pattern id="feature-comment-tests-pattern">
    <rule context="article[descendant::article-meta[descendant::subj-group[@subj-group-type='display-channel']/subject = $features-subj]]//p|      article[descendant::article-meta[descendant::subj-group[@subj-group-type='display-channel']/subject = $features-subj]]//td|      article[descendant::article-meta[descendant::subj-group[@subj-group-type='display-channel']/subject = $features-subj]]//th" id="feature-comment-tests">
     ...
     <report see="https://elifeproduction.slab.com/posts/feature-content-alikl8qp#hb9uk-final-feat-query-test" test="matches(.,'\[[Qq][Uu][Ee][Rr][Yy]')" role="error" id="final-feat-query-test">
        <value-of select="name()"/> element contains [Query] or [QUERY] which should be removed - <value-of select="."/>
      </report>
  ...
  <pattern id="retraction-tests-pattern">
    <rule context="article[@article-type = ('retraction','expression-of-concern')]" id="retraction-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/abstracts-digests-and-impact-statements-tiau2k6x#retr-abstract-presence" test="descendant::abstract" role="error" id="retr-abstract-presence">
  ...
  <pattern id="rrid-org-code-pattern">
    <rule context="p|td|th" id="rrid-org-code">
      ...
      <report test="contains(.,'git://')" role="error" id="git-protocol">
        <name/> contains the git:// protocol - <value-of select="."/>. This is no longer widely supported, and should be replaced with the appropriate https:// protocol (or similar) equivalent.</report>
  ...
  <pattern id="ref-xref-conformance-pattern">
    <rule context="xref[@ref-type='bibr']" id="ref-xref-conformance">
      ...
      <assert see="https://elifeproduction.slab.com/posts/reference-citations-vv87m87l#final-ref-xref-test-1" test="replace(.,' ',' ') = ($cite1,$cite2)" role="error" id="final-ref-xref-test-1">
  ...
  <pattern id="vid-xref-conformance-pattern">
    <rule context="xref[@ref-type='video']" id="vid-xref-conformance">
      ...
      <assert see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#vid-xref-conformity-1" test="matches(.,'\p{N}')" role="error" id="vid-xref-conformity-1">
  ...
  <pattern id="fig-xref-conformance-pattern">
    <rule context="xref[@ref-type='fig' and @rid]" id="fig-xref-conformance">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#fig-xref-conformity-4" test="($type = 'Figure') and matches(.,'[Ss]upplement')" role="error" id="fig-xref-conformity-4">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#fig-xref-test-5" test="($type = 'Figure') and (matches($post-text,'^ in $|^ from $|^ of $')) and (following-sibling::*[1]/@ref-type='bibr')" role="error" id="fig-xref-test-5">
        <value-of select="concat(.,$post-text,following-sibling::*[1])"/> - Figure citation refers to a figure from a different paper, and therefore must be unlinked.</report>
  ...
  <pattern id="table-xref-conformance-pattern">
    <rule context="xref[@ref-type='table']" id="table-xref-conformance">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#table-xref-conformity-1" test="not(matches(.,'Table')) and ($pre-text != ' and ') and ($pre-text != '–') and ($pre-text != ', ') and not(contains($rid,'app')) and not(contains($rid,'resp')) and not(contains($rid,'sa'))" role="warning" id="table-xref-conformity-1">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#table-xref-conformity-4" test="(contains($rid,'app')) and (not(ends-with($text-no,substring($rid-no,2)))) and not(contains(.,'–'))" role="warning" id="table-xref-conformity-4">
        <value-of select="."/> - Citation content does not match what it directs to.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#table-xref-test-1" test="(ancestor::table-wrap/@id = $rid) and not(ancestor::supplementary-material)" role="warning" id="table-xref-test-1">
  ...
  <pattern id="supp-file-xref-conformance-pattern">
    <rule context="xref[@ref-type='supplementary-material']" id="supp-file-xref-conformance">
      ...
      <assert see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#supp-file-xref-conformity-4" test="contains(.,$last-rid-no)" role="warning" id="supp-file-xref-conformity-4">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#supp-file-xref-test-1" test="ancestor::supplementary-material/@id = $rid" role="warning" id="supp-file-xref-test-1">
  ...
  <pattern id="equation-xref-conformance-pattern">
    <rule context="xref[@ref-type='disp-formula']" id="equation-xref-conformance">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#equ-xref-conformity-3" test="(matches($post-text,'^ in $|^ from $|^ of $')) and (following-sibling::*[1]/@ref-type='bibr')" role="error" id="equ-xref-conformity-3">
  ...
  <pattern id="org-title-kwd-pattern">
    <rule context="article//article-meta/title-group/article-title | article/body//sec/title | article//article-meta//kwd" id="org-title-kwd">		
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-drosophilasmelanogaster-article-title-check" test="matches($lc,'drosophila\p{Zs}?melanogaster') and not(italic[contains(.,'Drosophila melanogaster')])" role="warning" id="drosophilasmelanogaster-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-escoli-article-title-check" test="matches($lc,'e\.\p{Zs}?coli') and not(italic[contains(.,'E. coli')])" role="warning" id="escoli-article-title-check">
        <name/> contains an organism - 'E. coli' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-escherichiascoli-article-title-check" test="matches($lc,'escherichia\p{Zs}?coli') and not(italic[contains(.,'Escherichia coli')])" role="warning" id="escherichiascoli-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sspombe-article-title-check" test="matches($lc,'s\.\p{Zs}?pombe') and not(italic[contains(.,'S. pombe')])" role="warning" id="sspombe-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sscerevisiae-article-title-check" test="matches($lc,'s\.\p{Zs}?cerevisiae') and not(italic[contains(.,'S. cerevisiae')])" role="warning" id="sscerevisiae-article-title-check">
        <name/> contains an organism - 'S. cerevisiae' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-saccharomycesscerevisiae-article-title-check" test="matches($lc,'saccharomyces\p{Zs}?cerevisiae') and not(italic[contains(.,'Saccharomyces cerevisiae')])" role="warning" id="saccharomycesscerevisiae-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-cselegans-article-title-check" test="matches($lc,'c\.\p{Zs}?elegans') and not(italic[contains(.,'C. elegans')])" role="warning" id="cselegans-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-arabidopsissthaliana-article-title-check" test="matches($lc,'arabidopsis\p{Zs}?thaliana') and not(italic[contains(.,'Arabidopsis thaliana')])" role="warning" id="arabidopsissthaliana-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-msthermophila-article-title-check" test="matches($lc,'m\.\p{Zs}?thermophila') and not(italic[contains(.,'M. thermophila')])" role="warning" id="msthermophila-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-dictyostelium-article-title-check" test="matches($lc,'dictyostelium') and not(italic[contains(.,'Dictyostelium')])" role="warning" id="dictyostelium-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-psfalciparum-article-title-check" test="matches($lc,'p\.\p{Zs}?falciparum') and not(italic[contains(.,'P. falciparum')])" role="warning" id="psfalciparum-article-title-check">
        <name/> contains an organism - 'P. falciparum' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-plasmodiumsfalciparum-article-title-check" test="matches($lc,'plasmodium\p{Zs}?falciparum') and not(italic[contains(.,'Plasmodium falciparum')])" role="warning" id="plasmodiumsfalciparum-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ssenterica-article-title-check" test="matches($lc,'s\.\p{Zs}?enterica') and not(italic[contains(.,'S. enterica')])" role="warning" id="ssenterica-article-title-check">
        <name/> contains an organism - 'S. enterica' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-salmonellasenterica-article-title-check" test="matches($lc,'salmonella\p{Zs}?enterica') and not(italic[contains(.,'Salmonella enterica')])" role="warning" id="salmonellasenterica-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sspyogenes-article-title-check" test="matches($lc,'s\.\p{Zs}?pyogenes') and not(italic[contains(.,'S. pyogenes')])" role="warning" id="sspyogenes-article-title-check">
        <name/> contains an organism - 'S. pyogenes' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-streptococcusspyogenes-article-title-check" test="matches($lc,'streptococcus\p{Zs}?pyogenes') and not(italic[contains(.,'Streptococcus pyogenes')])" role="warning" id="streptococcusspyogenes-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-platynereissdumerilii-article-title-check" test="matches($lc,'platynereis\p{Zs}?dumerilii') and not(italic[contains(.,'Platynereis dumerilii')])" role="warning" id="platynereissdumerilii-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pscynocephalus-article-title-check" test="matches($lc,'p\.\p{Zs}?cynocephalus') and not(italic[contains(.,'P. cynocephalus')])" role="warning" id="pscynocephalus-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-osfasciatus-article-title-check" test="matches($lc,'o\.\p{Zs}?fasciatus') and not(italic[contains(.,'O. fasciatus')])" role="warning" id="osfasciatus-article-title-check">
        <name/> contains an organism - 'O. fasciatus' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-oncopeltussfasciatus-article-title-check" test="matches($lc,'oncopeltus\p{Zs}?fasciatus') and not(italic[contains(.,'Oncopeltus fasciatus')])" role="warning" id="oncopeltussfasciatus-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-neurosporascrassa-article-title-check" test="matches($lc,'neurospora\p{Zs}?crassa') and not(italic[contains(.,'Neurospora crassa')])" role="warning" id="neurosporascrassa-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hssalinarum-article-title-check" test="matches($lc,'h\.\p{Zs}?salinarum') and not(italic[contains(.,'H. salinarum')])" role="warning" id="hssalinarum-article-title-check">
        <name/> contains an organism - 'H. salinarum' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-halobacteriumssalinarum-article-title-check" test="matches($lc,'halobacterium\p{Zs}?salinarum') and not(italic[contains(.,'Halobacterium salinarum')])" role="warning" id="halobacteriumssalinarum-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sssolfataricus-article-title-check" test="matches($lc,'s\.\p{Zs}?solfataricus') and not(italic[contains(.,'S. solfataricus')])" role="warning" id="sssolfataricus-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sulfolobusssolfataricus-article-title-check" test="matches($lc,'sulfolobus\p{Zs}?solfataricus') and not(italic[contains(.,'Sulfolobus solfataricus')])" role="warning" id="sulfolobusssolfataricus-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-schmidteasmediterranea-article-title-check" test="matches($lc,'schmidtea\p{Zs}?mediterranea') and not(italic[contains(.,'Schmidtea mediterranea')])" role="warning" id="schmidteasmediterranea-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ssrosetta-article-title-check" test="matches($lc,'s\.\p{Zs}?rosetta') and not(italic[contains(.,'S. rosetta')])" role="warning" id="ssrosetta-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-nsvectensis-article-title-check" test="matches($lc,'n\.\p{Zs}?vectensis') and not(italic[contains(.,'N. vectensis')])" role="warning" id="nsvectensis-article-title-check">
        <name/> contains an organism - 'N. vectensis' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-nematostellasvectensis-article-title-check" test="matches($lc,'nematostella\p{Zs}?vectensis') and not(italic[contains(.,'Nematostella vectensis')])" role="warning" id="nematostellasvectensis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-staphylococcussaureus-article-title-check" test="matches($lc,'staphylococcus\p{Zs}?aureus') and not(italic[contains(.,'Staphylococcus aureus')])" role="warning" id="staphylococcussaureus-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-vibrioscholerae-article-title-check" test="matches($lc,'vibrio\p{Zs}?cholerae') and not(italic[contains(.,'Vibrio cholerae')])" role="warning" id="vibrioscholerae-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-tsthermophila-article-title-check" test="matches($lc,'t\.\p{Zs}?thermophila') and not(italic[contains(.,'T. thermophila')])" role="warning" id="tsthermophila-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-tetrahymenasthermophila-article-title-check" test="matches($lc,'tetrahymena\p{Zs}?thermophila') and not(italic[contains(.,'Tetrahymena thermophila')])" role="warning" id="tetrahymenasthermophila-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-csreinhardtii-article-title-check" test="matches($lc,'c\.\p{Zs}?reinhardtii') and not(italic[contains(.,'C. reinhardtii')])" role="warning" id="csreinhardtii-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-chlamydomonassreinhardtii-article-title-check" test="matches($lc,'chlamydomonas\p{Zs}?reinhardtii') and not(italic[contains(.,'Chlamydomonas reinhardtii')])" role="warning" id="chlamydomonassreinhardtii-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-escarotovora-article-title-check" test="matches($lc,'e\.\p{Zs}?carotovora') and not(italic[contains(.,'E. carotovora')])" role="warning" id="escarotovora-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hsapiens-article-title-check" test="matches($lc,'h\.\p{Zs}?sapiens') and not(italic[contains(.,'H. sapiens')])" role="warning" id="hsapiens-article-title-check">
        <name/> contains an organism - 'H. sapiens' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-homosapiens-article-title-check" test="matches($lc,'homo\p{Zs}?sapiens') and not(italic[contains(.,'Homo sapiens')])" role="warning" id="homosapiens-article-title-check">
        <name/> contains an organism - 'Homo sapiens' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ctrachomatis-article-title-check" test="matches($lc,'c\.\p{Zs}?trachomatis') and not(italic[contains(.,'C. trachomatis')])" role="warning" id="ctrachomatis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-chlamydiatrachomatis-article-title-check" test="matches($lc,'chlamydia\p{Zs}?trachomatis') and not(italic[contains(.,'Chlamydia trachomatis')])" role="warning" id="chlamydiatrachomatis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-esfaecalis-article-title-check" test="matches($lc,'e\.\p{Zs}?faecalis') and not(italic[contains(.,'E. faecalis')])" role="warning" id="esfaecalis-article-title-check">
        <name/> contains an organism - 'E. faecalis' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-enterococcussfaecalis-article-title-check" test="matches($lc,'enterococcus\p{Zs}?faecalis') and not(italic[contains(.,'Enterococcus faecalis')])" role="warning" id="enterococcussfaecalis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-xlaevis-article-title-check" test="matches($lc,'x\.\p{Zs}?laevis') and not(italic[contains(.,'X. laevis')])" role="warning" id="xlaevis-article-title-check">
        <name/> contains an organism - 'X. laevis' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-xtropicalis-article-title-check" test="matches($lc,'x\.\p{Zs}?tropicalis') and not(italic[contains(.,'X. tropicalis')])" role="warning" id="xtropicalis-article-title-check">
        <name/> contains an organism - 'X. tropicalis' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-drosophilaimmigrans-article-title-check" test="matches($lc,'drosophila\p{Zs}?immigrans') and not(italic[contains(.,'Drosophila immigrans')])" role="warning" id="drosophilaimmigrans-article-title-check">
        <name/> contains an organism - 'Drosophila immigrans' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-dobscura-article-title-check" test="matches($lc,'d\.\p{Zs}?obscura') and not(italic[contains(.,'D. obscura')])" role="warning" id="dobscura-article-title-check">
        <name/> contains an organism - 'D. obscura' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-drosophilaobscura-article-title-check" test="matches($lc,'drosophila\p{Zs}?obscura') and not(italic[contains(.,'Drosophila obscura')])" role="warning" id="drosophilaobscura-article-title-check">
        <name/> contains an organism - 'Drosophila obscura' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ftularensis-article-title-check" test="matches($lc,'f\.\p{Zs}?tularensis') and not(italic[contains(.,'F. tularensis')])" role="warning" id="ftularensis-article-title-check">
        <name/> contains an organism - 'F. tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pplantaginis-article-title-check" test="matches($lc,'p\.\p{Zs}?plantaginis') and not(italic[contains(.,'P. plantaginis')])" role="warning" id="pplantaginis-article-title-check">
        <name/> contains an organism - 'P. plantaginis' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-podosphaeraplantaginis-article-title-check" test="matches($lc,'podosphaera\p{Zs}?plantaginis') and not(italic[contains(.,'Podosphaera plantaginis')])" role="warning" id="podosphaeraplantaginis-article-title-check">
        <name/> contains an organism - 'Podosphaera plantaginis' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-plantagolanceolata-article-title-check" test="matches($lc,'plantago\p{Zs}?lanceolata') and not(italic[contains(.,'Plantago lanceolata')])" role="warning" id="plantagolanceolata-article-title-check">
        <name/> contains an organism - 'Plantago lanceolata' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-mtrossulus-article-title-check" test="matches($lc,'m\.\p{Zs}?trossulus') and not(italic[contains(.,'M. trossulus')])" role="info" id="mtrossulus-article-title-check">
        <name/> contains an organism - 'M. trossulus' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-mytilustrossulus-article-title-check" test="matches($lc,'mytilus\p{Zs}?trossulus') and not(italic[contains(.,'Mytilus trossulus')])" role="info" id="mytilustrossulus-article-title-check">
        <name/> contains an organism - 'Mytilus trossulus' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-mytilusedulis-article-title-check" test="matches($lc,'mytilus\p{Zs}?edulis') and not(italic[contains(.,'Mytilus edulis')])" role="info" id="mytilusedulis-article-title-check">
        <name/> contains an organism - 'Mytilus edulis' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pknowlesi-article-title-check" test="matches($lc,'p\.\p{Zs}?knowlesi') and not(italic[contains(.,'P. knowlesi')])" role="info" id="pknowlesi-article-title-check">
        <name/> contains an organism - 'P. knowlesi' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pseudomonasaeruginosa-article-title-check" test="matches($lc,'pseudomonas\p{Zs}?aeruginosa') and not(italic[contains(.,'Pseudomonas aeruginosa')])" role="info" id="pseudomonasaeruginosa-article-title-check">
        <name/> contains an organism - 'Pseudomonas aeruginosa' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-tbrucei-article-title-check" test="matches($lc,'t\.\p{Zs}?brucei') and not(italic[contains(.,'T. brucei')])" role="warning" id="tbrucei-article-title-check">
        <name/> contains an organism - 'T. brucei' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-trypanosomabrucei-article-title-check" test="matches($lc,'trypanosoma\p{Zs}?brucei') and not(italic[contains(.,'Trypanosoma brucei')])" role="warning" id="trypanosomabrucei-article-title-check">
        <name/> contains an organism - 'Trypanosoma brucei' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-drerio-article-title-check" test="matches($lc,'d\.\p{Zs}?rerio') and not(italic[contains(.,'D. rerio')])" role="warning" id="drerio-article-title-check">
        <name/> contains an organism - 'D. rerio' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-yimenosaurus-article-title-check" test="matches($lc,'yimenosaurus') and not(italic[contains(.,'Yimenosaurus')])" role="warning" id="yimenosaurus-article-title-check">
        <name/> contains an organism - 'Yimenosaurus' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-scelidosaurusharrisonii-article-title-check" test="matches($lc,'scelidosaurus\p{Zs}?harrisonii') and not(italic[contains(.,'Scelidosaurus harrisonii')])" role="warning" id="scelidosaurusharrisonii-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hayagriva-article-title-check" test="matches($lc,'haya\p{Zs}?griva') and not(italic[contains(.,'Haya griva')])" role="warning" id="hayagriva-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-slawleri-article-title-check" test="matches($lc,'s\.\p{Zs}?lawleri') and not(italic[contains(.,'S. lawleri')])" role="warning" id="slawleri-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-europeltacarbonensis-article-title-check" test="matches($lc,'europelta\p{Zs}?carbonensis') and not(italic[contains(.,'Europelta carbonensis')])" role="warning" id="europeltacarbonensis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-ecarbonensis-article-title-check" test="matches($lc,'e\.\p{Zs}?carbonensis') and not(italic[contains(.,'E. carbonensis')])" role="warning" id="ecarbonensis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-stegosaurusstenops-article-title-check" test="matches($lc,'stegosaurus\p{Zs}?stenops') and not(italic[contains(.,'Stegosaurus stenops')])" role="warning" id="stegosaurusstenops-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-sstenops-article-title-check" test="matches($lc,'s\.\p{Zs}?stenops') and not(italic[contains(.,'S. stenops')])" role="warning" id="sstenops-article-title-check">
        <name/> contains an organism - 'S. stenops' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-pinacosaurusgrangeri-article-title-check" test="matches($lc,'pinacosaurus\p{Zs}?grangeri') and not(italic[contains(.,'Pinacosaurus grangeri')])" role="warning" id="pinacosaurusgrangeri-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-tatisaurusoehleri-article-title-check" test="matches($lc,'tatisaurus\p{Zs}?oehleri') and not(italic[contains(.,'Tatisaurus oehleri')])" role="warning" id="tatisaurusoehleri-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-hungarosaurustormai-article-title-check" test="matches($lc,'hungarosaurus\p{Zs}?tormai') and not(italic[contains(.,'Hungarosaurus tormai')])" role="warning" id="hungarosaurustormai-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-htormai-article-title-check" test="matches($lc,'h\.\p{Zs}?tormai') and not(italic[contains(.,'H. tormai')])" role="warning" id="htormai-article-title-check">
        <name/> contains an organism - 'H. tormai' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-lesothosaurusdiagnosticus-article-title-check" test="matches($lc,'lesothosaurus\p{Zs}?diagnosticus') and not(italic[contains(.,'Lesothosaurus diagnosticus')])" role="warning" id="lesothosaurusdiagnosticus-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-bienosauruslufengensis-article-title-check" test="matches($lc,'bienosaurus\p{Zs}?lufengensis') and not(italic[contains(.,'Bienosaurus lufengensis')])" role="warning" id="bienosauruslufengensis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-faustralis-article-title-check" test="matches($lc,'f\.\p{Zs}?australis') and not(italic[contains(.,'F. australis')])" role="warning" id="faustralis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-cchunghoensis-article-title-check" test="matches($lc,'c\.\p{Zs}?chunghoensis') and not(italic[contains(.,'C. chunghoensis')])" role="warning" id="cchunghoensis-article-title-check">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-etutus-article-title-check" test="matches($lc,'e\.\p{Zs}?tutus') and not(italic[contains(.,'E. tutus')])" role="warning" id="etutus-article-title-check">
      ...
      <report test="matches($lc,'gorilla\p{Zs}?beringei') and not(italic[contains(.,'Gorilla beringei')])" role="warning" id="gorillaberingei-article-title-check">
        <name/> contains an organism - 'Gorilla beringei' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report test="matches($lc,'m\.\p{Zs}?mulatta') and not(italic[contains(.,'M. mulatta')])" role="warning" id="mmulatta-article-title-check">
        <name/> contains an organism - 'M. mulatta' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report test="matches($lc,'m\.\p{Zs}?nemestrina') and not(italic[contains(.,'M. nemestrina')])" role="warning" id="mnemestrina-article-title-check">
        <name/> contains an organism - 'M. nemestrina' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'macaca\p{Zs}?nemestrina') and not(italic[contains(.,'Macaca nemestrina')])" role="warning" id="macacanemestrina-article-title-check">
        <name/> contains an organism - 'Macaca nemestrina' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report test="matches($lc,'p\.\p{Zs}?anubis') and not(italic[contains(.,'P. anubis')])" role="warning" id="panubis-article-title-check">
        <name/> contains an organism - 'P. anubis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'papio\p{Zs}?anubis') and not(italic[contains(.,'Papio anubis')])" role="warning" id="papioanubis-article-title-check">
        <name/> contains an organism - 'Papio anubis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'p\.\p{Zs}?hamadryas') and not(italic[contains(.,'P. hamadryas')])" role="warning" id="phamadryas-article-title-check">
        <name/> contains an organism - 'P. hamadryas' - but there is no italic element with that correct capitalisation or spacing.</report>
      ...
      <report test="matches($lc,'pan\p{Zs}?paniscus') and not(italic[contains(.,'Pan paniscus')])" role="warning" id="panpaniscus-article-title-check">
        <name/> contains an organism - 'Pan paniscus' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'p\.\p{Zs}?troglodytes') and not(italic[contains(.,'P. troglodytes')])" role="warning" id="ptroglodytes-article-title-check">
        <name/> contains an organism - 'P. troglodytes' - but there is no italic element with that correct capitalisation or spacing.</report>
      <report test="matches($lc,'pan\p{Zs}?troglodytes') and not(italic[contains(.,'Pan troglodytes')])" role="warning" id="pantroglodytes-article-title-check">
        <name/> contains an organism - 'Pan troglodytes' - but there is no italic element with that correct capitalisation or spacing.</report>

      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h1ycf-drosophila-article-title-check" test="matches($lc,'drosophila') and not(italic[contains(text(),'Drosophila')])" role="warning" id="drosophila-article-title-check">
      ...
      <report test="matches($lc,'salmonella') and not(italic[contains(.,'Salmonella')])" role="warning" id="salmonella-article-title-check">
        <name/> contains an organism - 'Salmonella' - but there is no italic element with that correct capitalisation or spacing.</report>
  ...
  <pattern id="unallowed-symbol-tests-pattern">
    <rule context="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" id="unallowed-symbol-tests">		
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#supplementalfigure-presence" test="not(ancestor::sub-article) and matches(.,'\p{Zs}?[Ss]upplemental [Ff]igure')" role="warning" id="supplementalfigure-presence">
      ...
      <report see="https://elifeproduction.slab.com/posts/asset-citations-fa3e2yoo#supplement-table-presence" test="not(ancestor::sub-article) and matches(.,'\p{Zs}?[Ss]upplementa(l|ry) [Tt]able')" role="warning" id="supplement-table-presence">
      ...
      <report see="https://elifeproduction.slab.com/posts/house-style-yi0641ob#h7s38-extra-full-stop-presence" test="not(ancestor::sub-article) and not(local-name()='code') and contains(.,'..') and not(contains(.,'...'))" role="warning" id="extra-full-stop-presence">
  ...
  <pattern id="software-ref-tests-pattern">
    <rule context="element-citation[@publication-type='software']" id="software-ref-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/software-references-aymhzmlh#ref-software-test-5" test="(normalize-space(lower-case(source[1]))='github') and not(version)" role="warning" id="ref-software-test-5">
  ...
  <pattern id="publisher-name-tests-pattern">
    <rule context="element-citation/publisher-name" id="publisher-name-tests">
      ...
      <report see="https://elifeproduction.slab.com/posts/references-ghxfa7uy#pub-name-replacement-character-presence" test="matches(.,'�')" role="error" id="pub-name-replacement-character-presence">
  ...
  <pattern id="sec-title-conformity-pattern">
    <rule context="sec/title" id="sec-title-conformity">
      ...
      <report see="https://elifeproduction.slab.com/posts/article-structure-5nhfjxj0#sec-title-full-stop" test="matches(replace(.,' ',' '),'\.[\p{Zs}]*$')" role="warning" id="sec-title-full-stop">Section title ends with full stop, which is very likely to be incorrect - <value-of select="."/>
      </report>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-structure-5nhfjxj0#sec-title-underline" test="(count(*) = 1) and child::underline and ($free-text='')" role="error" id="sec-title-underline">All section title content is captured in underline. This is incorrect - <value-of select="."/>
      </report>
      ...
      <report see="https://elifeproduction.slab.com/posts/article-structure-5nhfjxj0#sec-title-rna" test="matches(upper-case($no-link-text),'^RNA | RNA | RNA$') and not(matches($no-link-text,'^RNA | RNA | RNA$'))" role="warning" id="sec-title-rna">Section title contains the phrase RNA, but it is not in all caps - <value-of select="."/>
      </report>
  ...
  <pattern id="section-title-tests-pattern">
    <rule context="sec/p/*[1][not(preceding-sibling::text()) or (normalize-space(preceding-sibling::text())='')]" id="section-title-tests">     
      ...
      <report see="https://elifeproduction.slab.com/posts/article-structure-5nhfjxj0#section-title-test-1" test="(name()=('italic','bold','underline')) and (ends-with(.,'.') or matches($following-text,'^\p{Zs}?\.|^[\p{P}]?\p{Zs}?[A-Z]|^[\p{P}]?\p{Zs}?\d')) and not((name()='italic') and matches(lower-case(.),$sec-title-regex))" role="warning" id="section-title-test-1">
  ...
  <pattern id="strike-tests-pattern">
    <rule context="strike" id="strike-tests">     
      ...
      <report test="." role="warning" id="final-strike-flag">
        <value-of select="parent::*/local-name()"/> element contains text with strikethrough formatting - <value-of select="."/> - Is this correct? Or have the authors added strikethrough formatting as an indication that the content should be removed?</report>
  ...
  <pattern id="doi-software-ref-checks-pattern">
    <rule context="element-citation[(@publication-type='software') and year and source]" id="doi-software-ref-checks">
      ...
      <report see="https://elifeproduction.slab.com/posts/software-references-aymhzmlh#software-doi-test-2" test="$host='figshare' and not(contains(ext-link[1],'10.6084/m9.figshare'))" role="warning" id="software-doi-test-2">
        <value-of select="$cite"/> is a software ref with a source (<value-of select="source[1]"/>) known to register dois starting with '10.6084/m9.figshare'. Should it have a link in the format 'https://doi.org/10.6084/m9.figshare...'?</report>
