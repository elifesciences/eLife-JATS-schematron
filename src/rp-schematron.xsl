<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M120">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M121">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[not(ancestor::sub-article or ancestor::def) and (count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M122">
   ...
   <!--RULE p-ref-checks-->
   <xsl:template match="article[descendant::xref[@ref-type='bibr'][matches(.,'\p{L}')]]//p[not(ancestor::sub-article) and not(ancestor::ack)]" priority="1000" mode="M123">
   ...
   <!--RULE p-td-th-checks-->
   <xsl:template match="p|td|th" priority="1000" mode="M124">
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M125">
   ...
   <xsl:template match="article/front/article-meta/article-id" priority="1000" mode="M126">
   ...
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='publisher-id']" priority="1000" mode="M127">
   ...
   <!--RULE article-dois-->
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M128">
   ...
   <xsl:template match="article/front/article-meta/author-notes" priority="1000" mode="M129">
   ...
   <xsl:template match="article/front/article-meta/author-notes/fn" priority="1000" mode="M130">
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M131">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M132">
   ...
   <xsl:template match="article/front[journal-meta/journal-id='elife']/article-meta[matches(replace(article-id[@specific-use='version'][1],'^.*\.',''),'^\d\d?$') and matches(descendant::article-version[@article-version-type='preprint-version'][1],'^1\.\d+$')]" priority="1000" mode="M133">
   ...
   <xsl:template match="article/front/article-meta/pub-date[@pub-type='epub']/year" priority="1000" mode="M134">
   ...
   <!--RULE contrib-checks-->
   <xsl:template match="article/front/article-meta/contrib-group/contrib" priority="1000" mode="M135">
   ...
   <!--RULE volume-test-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/volume" priority="1000" mode="M136">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/elocation-id" priority="1000" mode="M137">
   ...
   <!--RULE history-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/history" priority="1000" mode="M138">
   ...
   <xsl:template match="article[front[journal-meta/lower-case(journal-id[1])='elife']]//pub-history" priority="1000" mode="M139">
   ...
   <!--RULE event-tests-->
   <xsl:template match="event" priority="1000" mode="M140">
   ...
   <!--RULE rp-event-tests-->
   <xsl:template match="event[date[@date-type='reviewed-preprint']/@iso-8601-date != '']" priority="1000" mode="M142">
   ...
   <xsl:template match="event-desc" priority="1000" mode="M143">
   ...
   <xsl:template match="event/date" priority="1000" mode="M144">
   ...
   <xsl:template match="event/self-uri" priority="1000" mode="M145">
   ...
   <xsl:template match="funding-group" priority="1000" mode="M146">
   ...
   <xsl:template match="funding-group/award-group" priority="1000" mode="M148">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi') and normalize-space(.)!=''] and funding-source/institution-wrap[count(institution-id)=1]/institution-id[not(.=$grant-doi-exception-funder-ids)]]" priority="1000" mode="M149">
   ...
   <xsl:template match="funding-group/award-group[not(award-id) and funding-source/institution-wrap[count(institution-id)=1]/institution-id]" priority="1000" mode="M150">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
      <xsl:variable name="funder-entry" select="document($rors)//*:ror[*:id[@type='ror']=$funder-id]"/>
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=$wellcome-funder-ids]" priority="1000" mode="M151">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=($eu-horizon-fundref-ids,'https://ror.org/00k4n6c32')]" priority="1000" mode="M152">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=$known-grant-funder-ids]" priority="1000" mode="M153">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
   ...
   <!--RULE award-id-tests-->
   <xsl:template match="funding-group/award-group/award-id" priority="1000" mode="M154">
   ...
   <xsl:template match="funding-source//institution-id" priority="1000" mode="M155">
   ...
   <xsl:template match="funding-source//institution-wrap" priority="1000" mode="M156">
   ...
   <xsl:template match="funding-source[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M157">
      <xsl:variable name="rors" select="'rors.xml'"/>
      <xsl:variable name="ror" select="institution-wrap[1]/institution-id[@institution-id-type='ror'][1]"/>
      <xsl:variable name="matching-ror" select="document($rors)//*:ror[*:id=$ror]"/>
      <!--ASSERT error-->
   ...
   <xsl:template match="abstract[parent::article-meta]" priority="1000" mode="M158">
   ...
   <xsl:template match="abstract[@xml:lang]" priority="1000" mode="M160">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions" priority="1000" mode="M161">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@*:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M162">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@*:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@*:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M163">
      <xsl:variable name="license-type" select="license/@*:href"/>
      <!--REPORT error-->
   ...
   <!--RULE license-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license" priority="1000" mode="M164">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license/license-p" priority="1000" mode="M165">
   ...
   <xsl:template match="permissions/license[@*:href]/license-p" priority="1000" mode="M166">
      <xsl:variable name="license-link" select="parent::license/@*:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[*:license_ref]/license-p" priority="1000" mode="M167">
   ...
   <xsl:template match="fig[not(descendant::permissions)]|media[@mimetype='video' and not(descendant::permissions)]|table-wrap[not(descendant::permissions)]|supplementary-material[not(descendant::permissions)]" priority="1000" mode="M168">
   ...
   <xsl:template match="related-object[@content-type or @document-id]" priority="1000" mode="M169">
   ...
   <!--RULE notes-checks-->
   <xsl:template match="front/notes" priority="1000" mode="M170">
   ...
   <xsl:template match="title" priority="1000" mode="M171">
   ...
   <xsl:template match="preformat" priority="1000" mode="M172">
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M173">
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M174">
   ...
   <!--RULE xref-checks-->
   <xsl:template match="xref" priority="1000" mode="M175">
   ...
   <xsl:template match="xref[@ref-type='bibr']" priority="1000" mode="M176">
   ...
   <xsl:template match="xref[@ref-type='fig' and @rid]" priority="1000" mode="M177">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M178">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M179">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M180">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link|ref" priority="1000" mode="M181">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub" priority="1000" mode="M182">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group" priority="1000" mode="M183">
   ...
   <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M184">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='claim-importance']/kwd" priority="1000" mode="M185">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" priority="1000" mode="M186">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body/p[1]//bold" priority="1000" mode="M187">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//fig/label" priority="1000" mode="M188">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//table-wrap/label" priority="1000" mode="M189">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//fig/label" priority="1000" mode="M190">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//table-wrap/label" priority="1000" mode="M191">
   ...
   <xsl:template match="sub-article/front-stub/title-group/article-title" priority="1000" mode="M192">
   ...
   <xsl:template match="sub-article/front-stub" priority="1000" mode="M193">
   ...
   <xsl:template match="sub-article/front-stub/article-id[@pub-id-type='doi']" priority="1000" mode="M194">
   ...
   <xsl:template match="sub-article/body//p" priority="1000" mode="M195">
   ...
   <xsl:template match="sub-article/body//ext-link" priority="1000" mode="M196">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M197">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M198">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M199">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M200">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M201">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M202">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M203">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M204">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M205">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M206">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M207">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M208">
