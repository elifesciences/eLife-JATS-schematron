<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cache="java:org.elifesciences.validator.ApiCache" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="eLife reviewed preprint schematron" schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="java:org.elifesciences.validator.ApiCache" prefix="cache"/>
   ...
   <!--RULE article-tests-->
   <xsl:template match="article[front/journal-meta/lower-case(journal-id[1])='elife']" priority="1000" mode="M44">
   ...
   <xsl:template match="article-meta/title-group/article-title/*" priority="1000" mode="M46">
   ...
   <xsl:template match="article-meta/contrib-group/contrib[@contrib-type='author' and not(collab)]" priority="1000" mode="M47">
   ...
   <xsl:template match="contrib[@contrib-type='author']" priority="1000" mode="M48">
   ...
   <!--RULE name-tests-->
   <xsl:template match="contrib-group//name" priority="1000" mode="M49">
   ...
   <!--RULE surname-tests-->
   <xsl:template match="contrib-group//name/surname" priority="1000" mode="M50">
   ...
   <xsl:template match="name/given-names" priority="1000" mode="M51">
   ...
   <xsl:template match="contrib-group//name/*" priority="1000" mode="M52">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[1]" priority="1000" mode="M53">
   ...
   <!--RULE orcid-tests-->
   <xsl:template match="contrib-id[@contrib-id-type='orcid']" priority="1000" mode="M54">
   ...
   <xsl:template match="aff" priority="1000" mode="M55">
   ...
   <!--RULE country-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//aff/country" priority="1000" mode="M56">
   ...
   <xsl:template match="aff[ancestor::contrib-group[not(@*)]/parent::article-meta]//institution-wrap" priority="1000" mode="M57">
   ...
   <xsl:template match="aff//institution-id" priority="1000" mode="M58">
   ...
   <!--RULE aff-ror-tests-->
   <xsl:template match="aff[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M59">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[@content-type='section']" priority="1000" mode="M60">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[@content-type='section']/contrib" priority="1000" mode="M61">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']" priority="1000" mode="M62">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/source" priority="1000" mode="M63">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/fpage" priority="1000" mode="M64">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']" priority="1000" mode="M65">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']/source" priority="1000" mode="M66">
      <xsl:variable name="lc" select="lower-case(.)"/>
      <!--REPORT warning-->
   ...
   <xsl:template match="mixed-citation[@publication-type='book']" priority="1000" mode="M67">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']/source" priority="1000" mode="M68">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']" priority="1000" mode="M69">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']/conf-name" priority="1000" mode="M70">
   ...
   <xsl:template match="ref-list" priority="1000" mode="M71">
   ...
   <xsl:template match="ref-list[ref/label[matches(.,'^\p{P}*\d+\p{P}*$')] and not(ref/label[not(matches(.,'^\p{P}*\d+\p{P}*$'))])]/ref[label]" priority="1000" mode="M72">
   ...
   <xsl:template match="ref-list[ref/label]/ref" priority="1000" mode="M73">
   ...
   <xsl:template match="ref//year" priority="1000" mode="M74">
   ...
   <xsl:template match="mixed-citation//name | mixed-citation//string-name" priority="1000" mode="M75">
   ...
   <xsl:template match="mixed-citation//given-names | mixed-citation//surname" priority="1000" mode="M76">
   ...
   <!--RULE collab-checks-->
   <xsl:template match="collab" priority="1000" mode="M77">
   ...
   <xsl:template match="mixed-citation[person-group]//etal" priority="1000" mode="M78">
   ...
   <xsl:template match="comment" priority="1000" mode="M79">
   ...
   <xsl:template match="ref//pub-id" priority="1000" mode="M80">
