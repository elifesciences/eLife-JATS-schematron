<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='isbn']|isbn" priority="1000" mode="M80">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='issn']|issn" priority="1000" mode="M81">
   ...
   <xsl:template match="ref//person-group" priority="1000" mode="M82">
   ...
   <!--RULE ref-checks-->
   <xsl:template match="ref" priority="1000" mode="M83">
   ...
   <xsl:template match="ref//article-title" priority="1000" mode="M85">
   ...
   <xsl:template match="ref//chapter-title" priority="1000" mode="M86">
   ...
   <xsl:template match="ref//source" priority="1000" mode="M87">
   ...
   <xsl:template match="mixed-citation" priority="1000" mode="M88">
   ...
   <!--RULE comment-checks-->
   <xsl:template match="comment" priority="1000" mode="M90">
   ...
   <!--RULE back-tests-->
   <xsl:template match="back" priority="1000" mode="M91">
   ...
   <!--RULE ack-tests-->
   <xsl:template match="ack" priority="1000" mode="M92">
   ...
   <!--RULE strike-checks-->
   <xsl:template match="strike" priority="1000" mode="M93">
   ...
   <xsl:template match="underline" priority="1000" mode="M94">
   ...
   <!--RULE bold-checks-->
   <xsl:template match="bold" priority="1000" mode="M95">
   ...
   <!--RULE sc-checks-->
   <xsl:template match="sc" priority="1000" mode="M96">
   ...
   <xsl:template match="fig/label" priority="1000" mode="M99">
   ...
   <xsl:template match="fig/caption/title" priority="1000" mode="M100">
   ...
   <xsl:template match="fig/caption" priority="1000" mode="M101">
   ...
   <xsl:template match="table-wrap" priority="1000" mode="M102">
   ...
   <xsl:template match="table-wrap/label" priority="1000" mode="M104">
   ...
   <xsl:template match="table-wrap/caption" priority="1000" mode="M105">
   ...
   <xsl:template match="table-wrap/caption/title" priority="1000" mode="M106">
   ...
   <!--RULE table-checks-->
   <xsl:template match="table" priority="1000" mode="M107">
   ...
   <xsl:template match="supplementary-material" priority="1000" mode="M108">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M110">
   ...
   <xsl:template match="inline-formula" priority="1000" mode="M111">
   ...
   <xsl:template match="alternatives[parent::disp-formula]" priority="1000" mode="M112">
   ...
   <xsl:template match="alternatives[parent::inline-formula]" priority="1000" mode="M113">
   ...
   <!--RULE math-tests-->
   <xsl:template match="*:math" priority="1000" mode="M114">
   ...
   <!--RULE list-checks-->
   <xsl:template match="list" priority="1000" mode="M115">
   ...
   <!--RULE graphic-checks-->
   <xsl:template match="graphic|inline-graphic" priority="1000" mode="M116">
   ...
   <xsl:template match="graphic" priority="1000" mode="M117">
   ...
   <!--RULE inline-checks-->
   <xsl:template match="inline-graphic" priority="1000" mode="M118">
   ...
   <!--RULE media-checks-->
   <xsl:template match="media" priority="1000" mode="M119">
   ...
   <!--RULE sec-checks-->
   <xsl:template match="sec" priority="1000" mode="M120">
   ...
   <!--RULE top-sec-checks-->
   <xsl:template match="sec[(parent::body or parent::back) and title]" priority="1000" mode="M121">
   ...
   <xsl:template match="sec/label" priority="1000" mode="M122">
   ...
   <!--RULE app-checks-->
   <xsl:template match="app" priority="1000" mode="M123">
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M124">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M125">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[not(ancestor::sub-article or ancestor::def) and (count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M126">
   ...
   <!--RULE p-ref-checks-->
   <xsl:template match="article[descendant::xref[@ref-type='bibr'][matches(.,'\p{L}')]]//p[not(ancestor::sub-article) and not(ancestor::ack)]" priority="1000" mode="M127">
   ...
   <xsl:template match="article//p[not(ancestor::sub-article) and not(ancestor::ack)]" priority="1000" mode="M128">
   ...
   <!--RULE p-td-th-checks-->
   <xsl:template match="p|td|th" priority="1000" mode="M129">
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M130">
   ...
   <xsl:template match="article/front/article-meta/article-id" priority="1000" mode="M131">
   ...
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='publisher-id']" priority="1000" mode="M132">
   ...
   <!--RULE article-dois-->
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M133">
   ...
   <xsl:template match="article/front/article-meta/author-notes" priority="1000" mode="M134">
   ...
   <xsl:template match="article/front/article-meta/author-notes/fn" priority="1000" mode="M135">
      <xsl:variable name="id" select="@id"/>
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M136">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M137">
   ...
   <xsl:template match="article/front[journal-meta/journal-id='elife']/article-meta[matches(replace(article-id[@specific-use='version'][1],'^.*\.',''),'^\d\d?$') and matches(descendant::article-version[@article-version-type='preprint-version'][1],'^1\.\d+$')]" priority="1000" mode="M138">
   ...
   <xsl:template match="article/front/article-meta/pub-date[@pub-type='epub']/year" priority="1000" mode="M139">
   ...
   <!--RULE contrib-checks-->
   <xsl:template match="article/front/article-meta/contrib-group/contrib" priority="1000" mode="M140">
   ...
   <!--RULE volume-test-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/volume" priority="1000" mode="M141">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/elocation-id" priority="1000" mode="M142">
   ...
   <!--RULE history-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/history" priority="1000" mode="M143">
   ...
   <xsl:template match="article[front[journal-meta/lower-case(journal-id[1])='elife']]//pub-history" priority="1000" mode="M144">
   ...
   <!--RULE event-tests-->
   <xsl:template match="event" priority="1000" mode="M145">
   ...
   <!--RULE rp-event-tests-->
   <xsl:template match="event[date[@date-type='reviewed-preprint']/@iso-8601-date != '']" priority="1000" mode="M147">
   ...
   <xsl:template match="event-desc" priority="1000" mode="M148">
   ...
   <xsl:template match="event/date" priority="1000" mode="M149">
   ...
   <xsl:template match="event/self-uri" priority="1000" mode="M150">
   ...
   <xsl:template match="funding-group" priority="1000" mode="M151">
   ...
   <xsl:template match="funding-group/award-group" priority="1000" mode="M153">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi') and normalize-space(.)!=''] and funding-source/institution-wrap[count(institution-id)=1]/institution-id[not(.=$grant-doi-exception-funder-ids)]]" priority="1000" mode="M154">
   ...
   <xsl:template match="funding-group/award-group[not(award-id) and funding-source/institution-wrap[count(institution-id)=1]/institution-id]" priority="1000" mode="M155">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
      <xsl:variable name="funder-entry" select="document($rors)//*:ror[*:id[@type='ror']=$funder-id]"/>
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=$wellcome-funder-ids]" priority="1000" mode="M156">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=($eu-horizon-fundref-ids,'https://ror.org/00k4n6c32')]" priority="1000" mode="M157">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=$known-grant-funder-ids]" priority="1000" mode="M158">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
   ...
   <xsl:template match="funding-source//institution-id" priority="1000" mode="M160">
   ...
   <xsl:template match="funding-source//institution-wrap" priority="1000" mode="M161">
   ...
   <xsl:template match="funding-source[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M162">
      <xsl:variable name="rors" select="'rors.xml'"/>
      <xsl:variable name="ror" select="institution-wrap[1]/institution-id[@institution-id-type='ror'][1]"/>
      <xsl:variable name="matching-ror" select="document($rors)//*:ror[*:id=$ror]"/>
      <!--ASSERT error-->
   ...
   <xsl:template match="abstract[parent::article-meta]" priority="1000" mode="M163">
   ...
   <xsl:template match="abstract[@xml:lang]" priority="1000" mode="M165">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions" priority="1000" mode="M166">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@*:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M167">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@*:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@*:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M168">
      <xsl:variable name="license-type" select="license/@*:href"/>
      <!--REPORT error-->
   ...
   <!--RULE license-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license" priority="1000" mode="M169">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license/license-p" priority="1000" mode="M170">
   ...
   <xsl:template match="permissions/license[@*:href]/license-p" priority="1000" mode="M171">
      <xsl:variable name="license-link" select="parent::license/@*:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[*:license_ref]/license-p" priority="1000" mode="M172">
   ...
   <xsl:template match="fig[not(descendant::permissions)]|media[@mimetype='video' and not(descendant::permissions)]|table-wrap[not(descendant::permissions)]|supplementary-material[not(descendant::permissions)]" priority="1000" mode="M173">
   ...
   <xsl:template match="related-object[@content-type or @document-id]" priority="1000" mode="M174">
   ...
   <!--RULE notes-checks-->
   <xsl:template match="front/notes" priority="1000" mode="M175">
   ...
   <xsl:template match="title" priority="1000" mode="M176">
   ...
   <xsl:template match="preformat" priority="1000" mode="M177">
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M178">
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M179">
   ...
   <xsl:template match="inline-media" priority="1000" mode="M180">
   ...
   <xsl:template match="disp-quote" priority="1000" mode="M181">
   ...
   <!--RULE xref-checks-->
   <xsl:template match="xref" priority="1000" mode="M182">
   ...
   <xsl:template match="xref[@ref-type='bibr']" priority="1000" mode="M183">
   ...
   <xsl:template match="xref[@ref-type='fig' and @rid]" priority="1000" mode="M184">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M185">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M186">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M187">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link|ref" priority="1000" mode="M188">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub" priority="1000" mode="M189">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group" priority="1000" mode="M190">
   ...
   <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M191">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='claim-importance']/kwd" priority="1000" mode="M192">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" priority="1000" mode="M193">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body" priority="1000" mode="M194">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body/p[1]//bold" priority="1000" mode="M195">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//fig/label" priority="1000" mode="M196">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//table-wrap/label" priority="1000" mode="M197">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//fig/label" priority="1000" mode="M198">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//table-wrap/label" priority="1000" mode="M199">
   ...
   <xsl:template match="sub-article/front-stub/title-group/article-title" priority="1000" mode="M200">
   ...
   <xsl:template match="sub-article/front-stub" priority="1000" mode="M201">
   ...
   <xsl:template match="sub-article/front-stub/article-id[@pub-id-type='doi']" priority="1000" mode="M202">
   ...
   <xsl:template match="sub-article/body//p" priority="1000" mode="M203">
   ...
   <xsl:template match="sub-article/body//ext-link" priority="1000" mode="M204">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M205">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M206">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M207">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M208">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M209">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M210">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M211">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M212">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M213">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M214">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M215">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M216">
   ...
   <xsl:template match="processing-instruction('fig-class')" priority="1000" mode="M217">
   ...
   <xsl:template match="processing-instruction('fig-width')" priority="1000" mode="M218">
   ...
   <xsl:template match="processing-instruction('math-size')" priority="1000" mode="M219">
      <xsl:variable name="next-node-name" select="following-sibling::node()[not(self::text())][1]/name()"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="processing-instruction('page-break')" priority="1000" mode="M220">
   ...
   <xsl:template match="processing-instruction('table-escape')" priority="1000" mode="M221">
      <xsl:variable name="next-node-name" select="following-sibling::node()[not(self::text())][1]/name()"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <!--RULE all-pi-checks-->
   <xsl:template match="processing-instruction()" priority="1000" mode="M222">
   ...
   <xsl:template match="ref//comment()" priority="1000" mode="M223">
