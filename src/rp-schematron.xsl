<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <!--RULE article-tests-->
   <xsl:template match="article[front/journal-meta/lower-case(journal-id[1])='elife']" priority="1000" mode="M28">
   ...
   <xsl:template match="article-meta/title-group/article-title" priority="1000" mode="M29">
   ...
   <xsl:template match="article-meta/contrib-group/contrib[@contrib-type='author' and not(collab)]" priority="1000" mode="M31">
   ...
   <xsl:template match="contrib[@contrib-type='author']" priority="1000" mode="M32">
   ...
   <!--RULE name-tests-->
   <xsl:template match="contrib-group//name" priority="1000" mode="M33">
   ...
   <!--RULE surname-tests-->
   <xsl:template match="contrib-group//name/surname" priority="1000" mode="M34">
   ...
   <xsl:template match="name/given-names" priority="1000" mode="M35">
   ...
   <xsl:template match="contrib-group//name/*" priority="1000" mode="M36">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[1]" priority="1000" mode="M37">
   ...
   <!--RULE orcid-tests-->
   <xsl:template match="contrib-id[@contrib-id-type='orcid']" priority="1000" mode="M38">
   ...
   <xsl:template match="aff" priority="1000" mode="M39">
   ...
   <!--RULE country-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//aff/country" priority="1000" mode="M40">
   ...
   <xsl:template match="aff[ancestor::contrib-group[not(@*)]/parent::article-meta]//institution-wrap" priority="1000" mode="M41">
   ...
   <xsl:template match="aff//institution-id" priority="1000" mode="M42">
   ...
   <!--RULE aff-ror-tests-->
   <xsl:template match="aff[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M43">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']" priority="1000" mode="M44">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/source" priority="1000" mode="M45">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']" priority="1000" mode="M46">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']/source" priority="1000" mode="M47">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']" priority="1000" mode="M48">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']/source" priority="1000" mode="M49">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']" priority="1000" mode="M50">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']/conf-name" priority="1000" mode="M51">
   ...
   <xsl:template match="ref-list" priority="1000" mode="M52">
   ...
   <xsl:template match="ref-list[ref/label[matches(.,'^\p{P}*\d+\p{P}*$')] and not(ref/label[not(matches(.,'^\p{P}*\d+\p{P}*$'))])]/ref[label]" priority="1000" mode="M53">
   ...
   <xsl:template match="ref-list[ref/label]/ref" priority="1000" mode="M54">
   ...
   <xsl:template match="ref//year" priority="1000" mode="M55">
   ...
   <xsl:template match="mixed-citation//name | mixed-citation//string-name" priority="1000" mode="M56">
   ...
   <xsl:template match="mixed-citation//given-names | mixed-citation//surname" priority="1000" mode="M57">
   ...
   <!--RULE collab-checks-->
   <xsl:template match="collab" priority="1000" mode="M58">
   ...
   <xsl:template match="mixed-citation[person-group]//etal" priority="1000" mode="M59">
   ...
   <xsl:template match="comment" priority="1000" mode="M60">
   ...
   <xsl:template match="ref//pub-id" priority="1000" mode="M61">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='isbn']|isbn" priority="1000" mode="M62">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='issn']|issn" priority="1000" mode="M63">
   ...
   <xsl:template match="ref//person-group" priority="1000" mode="M64">
   ...
   <!--RULE ref-checks-->
   <xsl:template match="ref" priority="1000" mode="M65">
   ...
   <xsl:template match="ref//article-title" priority="1000" mode="M66">
   ...
   <xsl:template match="ref//chapter-title" priority="1000" mode="M67">
   ...
   <xsl:template match="ref//source" priority="1000" mode="M68">
   ...
   <xsl:template match="mixed-citation" priority="1000" mode="M69">
   ...
   <!--RULE back-tests-->
   <xsl:template match="back" priority="1000" mode="M72">
   ...
   <!--RULE ack-tests-->
   <xsl:template match="ack" priority="1000" mode="M73">
   ...
   <!--RULE strike-checks-->
   <xsl:template match="strike" priority="1000" mode="M74">
   ...
   <xsl:template match="underline" priority="1000" mode="M75">
   ...
   <!--RULE bold-checks-->
   <xsl:template match="bold" priority="1000" mode="M76">
   ...
   <!--RULE sc-checks-->
   <xsl:template match="sc" priority="1000" mode="M77">
   ...
   <!--RULE fig-checks-->
   <xsl:template match="fig" priority="1000" mode="M78">
   ...
   <xsl:template match="fig/label" priority="1000" mode="M80">
   ...
   <xsl:template match="fig/caption[p]/title" priority="1000" mode="M81">
   ...
   <xsl:template match="fig/caption" priority="1000" mode="M82">
   ...
   <xsl:template match="table-wrap" priority="1000" mode="M83">
   ...
   <xsl:template match="table-wrap/label" priority="1000" mode="M85">
   ...
   <xsl:template match="table-wrap/caption" priority="1000" mode="M86">
   ...
   <xsl:template match="supplementary-material" priority="1000" mode="M87">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M89">
   ...
   <xsl:template match="inline-formula" priority="1000" mode="M90">
   ...
   <xsl:template match="alternatives[parent::disp-formula]" priority="1000" mode="M91">
   ...
   <xsl:template match="alternatives[parent::inline-formula]" priority="1000" mode="M92">
   ...
   <!--RULE list-checks-->
   <xsl:template match="list" priority="1000" mode="M93">
   ...
   <!--RULE graphic-checks-->
   <xsl:template match="graphic|inline-graphic" priority="1000" mode="M94">
   ...
   <xsl:template match="graphic" priority="1000" mode="M95">
   ...
   <!--RULE inline-checks-->
   <xsl:template match="inline-graphic" priority="1000" mode="M96">
   ...
   <!--RULE media-checks-->
   <xsl:template match="media" priority="1000" mode="M97">
   ...
   <!--RULE sec-checks-->
   <xsl:template match="sec" priority="1000" mode="M98">
   ...
   <!--RULE top-sec-checks-->
   <xsl:template match="sec[(parent::body or parent::back) and title]" priority="1000" mode="M99">
   ...
   <xsl:template match="sec/label" priority="1000" mode="M100">
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M101">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M102">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[not(ancestor::sub-article or ancestor::def) and (count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M103">
   ...
   <!--RULE p-ref-checks-->
   <xsl:template match="p[not(ancestor::sub-article)]" priority="1000" mode="M104">
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M105">
   ...
   <xsl:template match="article/front/article-meta/article-id" priority="1000" mode="M106">
   ...
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='publisher-id']" priority="1000" mode="M107">
   ...
   <!--RULE article-dois-->
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M108">
   ...
   <xsl:template match="article/front/article-meta/author-notes" priority="1000" mode="M109">
   ...
   <xsl:template match="article/front/article-meta/author-notes/fn" priority="1000" mode="M110">
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M111">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M112">
   ...
   <xsl:template match="article/front[journal-meta/journal-id='elife']/article-meta[matches(replace(article-id[@specific-use='version'][1],'^.*\.',''),'^\d\d?$') and matches(descendant::article-version[@article-version-type='preprint-version'][1],'^1\.\d+$')]" priority="1000" mode="M113">
   ...
   <xsl:template match="article/front/article-meta/pub-date[@pub-type='epub']/year" priority="1000" mode="M114">
   ...
   <!--RULE contrib-checks-->
   <xsl:template match="article/front/article-meta/contrib-group/contrib" priority="1000" mode="M115">
   ...
   <!--RULE volume-test-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/volume" priority="1000" mode="M116">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/elocation-id" priority="1000" mode="M117">
   ...
   <!--RULE history-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/history" priority="1000" mode="M118">
   ...
   <xsl:template match="article[front[journal-meta/lower-case(journal-id[1])='elife']]//pub-history" priority="1000" mode="M119">
   ...
   <!--RULE event-tests-->
   <xsl:template match="event" priority="1000" mode="M120">
   ...
   <!--RULE rp-event-tests-->
   <xsl:template match="event[date[@date-type='reviewed-preprint']/@iso-8601-date != '']" priority="1000" mode="M122">
   ...
   <xsl:template match="event-desc" priority="1000" mode="M123">
   ...
   <xsl:template match="event/date" priority="1000" mode="M124">
   ...
   <xsl:template match="event/self-uri" priority="1000" mode="M125">
   ...
   <xsl:template match="funding-group" priority="1000" mode="M126">
   ...
   <xsl:template match="funding-group/award-group" priority="1000" mode="M128">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi') and normalize-space(.)!=''] and funding-source/institution-wrap[count(institution-id)=1]/institution-id[not(.=$grant-doi-exception-funder-ids)]]" priority="1000" mode="M129">
   ...
   <xsl:template match="funding-group/award-group[not(award-id) and funding-source/institution-wrap[count(institution-id)=1]/institution-id]" priority="1000" mode="M130">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
      <xsl:variable name="funder-entry" select="document($rors)//*:ror[*:id[@type='ror']=$funder-id]"/>
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi') and normalize-space(.)!=''] and funding-source/institution-wrap[count(institution-id)=1]/institution-id=$wellcome-ror-ids]" priority="1000" mode="M131">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi') and normalize-space(.)!=''] and funding-source/institution-wrap[count(institution-id)=1]/institution-id=$known-grant-funder-ror-ids]" priority="1000" mode="M132">
   ...
   <!--RULE award-id-tests-->
   <xsl:template match="funding-group/award-group/award-id" priority="1000" mode="M133">
   ...
   <xsl:template match="funding-source//institution-id" priority="1000" mode="M134">
   ...
   <xsl:template match="funding-source//institution-wrap" priority="1000" mode="M135">
   ...
   <xsl:template match="funding-source[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M136">
      <xsl:variable name="rors" select="'rors.xml'"/>
      <xsl:variable name="ror" select="institution-wrap[1]/institution-id[@institution-id-type='ror'][1]"/>
      <xsl:variable name="matching-ror" select="document($rors)//*:ror[*:id=$ror]"/>
      <!--ASSERT error-->
   ...
   <xsl:template match="abstract[parent::article-meta]" priority="1000" mode="M137">
   ...
   <xsl:template match="abstract[@xml:lang]" priority="1000" mode="M139">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions" priority="1000" mode="M140">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M141">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M142">
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <!--REPORT error-->
   ...
   <!--RULE license-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license" priority="1000" mode="M143">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license/license-p" priority="1000" mode="M144">
   ...
   <xsl:template match="permissions/license[@xlink:href]/license-p" priority="1000" mode="M145">
      <xsl:variable name="license-link" select="parent::license/@xlink:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[ali:license_ref]/license-p" priority="1000" mode="M146">
   ...
   <xsl:template match="fig[not(descendant::permissions)]|media[@mimetype='video' and not(descendant::permissions)]|table-wrap[not(descendant::permissions)]|supplementary-material[not(descendant::permissions)]" priority="1000" mode="M147">
   ...
   <xsl:template match="related-object[@content-type or @document-id]" priority="1000" mode="M148">
   ...
   <!--RULE notes-checks-->
   <xsl:template match="front/notes" priority="1000" mode="M149">
   ...
   <xsl:template match="title" priority="1000" mode="M150">
   ...
   <xsl:template match="preformat" priority="1000" mode="M151">
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M152">
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M153">
   ...
   <!--RULE xref-checks-->
   <xsl:template match="xref" priority="1000" mode="M154">
   ...
   <xsl:template match="xref[@ref-type='bibr']" priority="1000" mode="M155">
   ...
   <xsl:template match="xref[@ref-type='fig' and @rid]" priority="1000" mode="M156">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M157">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M158">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M159">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" priority="1000" mode="M160">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub" priority="1000" mode="M161">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group" priority="1000" mode="M162">
   ...
   <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M163">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='claim-importance']/kwd" priority="1000" mode="M164">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" priority="1000" mode="M165">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body/p[1]//bold" priority="1000" mode="M166">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//fig/label" priority="1000" mode="M167">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//table-wrap/label" priority="1000" mode="M168">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//fig/label" priority="1000" mode="M169">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//table-wrap/label" priority="1000" mode="M170">
   ...
   <xsl:template match="sub-article/front-stub/title-group/article-title" priority="1000" mode="M171">
   ...
   <xsl:template match="sub-article/front-stub" priority="1000" mode="M172">
   ...
   <xsl:template match="sub-article/front-stub/article-id[@pub-id-type='doi']" priority="1000" mode="M173">
   ...
   <xsl:template match="sub-article/body//p" priority="1000" mode="M174">
   ...
   <xsl:template match="sub-article/body//ext-link" priority="1000" mode="M175">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M176">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M177">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M178">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M179">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M180">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M181">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M182">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M183">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M184">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M185">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M186">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M187">
