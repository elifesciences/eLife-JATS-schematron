<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']" priority="1000" mode="M29">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/source" priority="1000" mode="M30">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']" priority="1000" mode="M31">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']" priority="1000" mode="M32">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']/source" priority="1000" mode="M33">
   ...
   <xsl:template match="ref-list" priority="1000" mode="M34">
   ...
   <xsl:template match="ref-list[ref/label[matches(.,'^\p{P}*\d+\p{P}*$')] and not(ref/label[not(matches(.,'^\p{P}*\d+\p{P}*$'))])]/ref[label]" priority="1000" mode="M35">
   ...
   <xsl:template match="ref-list[ref/label]/ref" priority="1000" mode="M36">
   ...
   <xsl:template match="ref//year" priority="1000" mode="M37">
   ...
   <xsl:template match="mixed-citation//name | mixed-citation//string-name" priority="1000" mode="M38">
   ...
   <xsl:template match="mixed-citation//given-names | mixed-citation//surname" priority="1000" mode="M39">
   ...
   <!--RULE collab-checks-->
   <xsl:template match="collab" priority="1000" mode="M40">
   ...
   <xsl:template match="mixed-citation[person-group]//etal" priority="1000" mode="M41">
   ...
   <xsl:template match="comment" priority="1000" mode="M42">
   ...
   <xsl:template match="ref//pub-id" priority="1000" mode="M43">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='isbn']|isbn" priority="1000" mode="M44">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='issn']|issn" priority="1000" mode="M45">
   ...
   <xsl:template match="ref//person-group" priority="1000" mode="M46">
   ...
   <!--RULE ref-checks-->
   <xsl:template match="ref" priority="1000" mode="M47">
   ...
   <xsl:template match="mixed-citation" priority="1000" mode="M48">
   ...
   <!--RULE back-tests-->
   <xsl:template match="back" priority="1000" mode="M49">
   ...
   <!--RULE strike-checks-->
   <xsl:template match="strike" priority="1000" mode="M50">
   ...
   <xsl:template match="underline" priority="1000" mode="M51">
   ...
   <!--RULE fig-checks-->
   <xsl:template match="fig" priority="1000" mode="M52">
   ...
   <xsl:template match="fig/label" priority="1000" mode="M54">
   ...
   <xsl:template match="table-wrap" priority="1000" mode="M55">
   ...
   <xsl:template match="table-wrap/label" priority="1000" mode="M57">
   ...
   <xsl:template match="supplementary-material" priority="1000" mode="M58">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M60">
   ...
   <xsl:template match="inline-formula" priority="1000" mode="M61">
   ...
   <xsl:template match="alternatives[parent::disp-formula]" priority="1000" mode="M62">
   ...
   <xsl:template match="alternatives[parent::inline-formula]" priority="1000" mode="M63">
   ...
   <!--RULE list-checks-->
   <xsl:template match="list" priority="1000" mode="M64">
   ...
   <!--RULE graphic-checks-->
   <xsl:template match="graphic|inline-graphic" priority="1000" mode="M65">
   ...
   <!--RULE media-checks-->
   <xsl:template match="media" priority="1000" mode="M66">
   ...
   <!--RULE sec-checks-->
   <xsl:template match="sec" priority="1000" mode="M67">
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M68">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M69">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[not(ancestor::sub-article) and (count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M70">
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M71">
   ...
   <xsl:template match="article/front/article-meta/article-id" priority="1000" mode="M72">
   ...
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='publisher-id']" priority="1000" mode="M73">
   ...
   <xsl:template match="article/front/article-meta/author-notes" priority="1000" mode="M75">
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M77">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M78">
   ...
   <xsl:template match="article/front/article-meta/pub-date[@pub-type='epub']/year" priority="1000" mode="M79">
   ...
   <!--RULE contrib-checks-->
   <xsl:template match="article/front/article-meta/contrib-group/contrib" priority="1000" mode="M80">
   ...
   <!--RULE volume-test-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/volume" priority="1000" mode="M81">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/elocation-id" priority="1000" mode="M82">
   ...
   <!--RULE history-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/history" priority="1000" mode="M83">
   ...
   <xsl:template match="article[front[journal-meta/lower-case(journal-id[1])='elife']]//pub-history" priority="1000" mode="M84">
   ...
   <!--RULE event-tests-->
   <xsl:template match="event" priority="1000" mode="M85">
   ...
   <!--RULE rp-event-tests-->
   <xsl:template match="event[date[@date-type='reviewed-preprint']/@iso-8601-date != '']" priority="1000" mode="M87">
   ...
   <xsl:template match="event-desc" priority="1000" mode="M88">
   ...
   <xsl:template match="event/date" priority="1000" mode="M89">
   ...
   <xsl:template match="event/self-uri" priority="1000" mode="M90">
   ...
   <xsl:template match="abstract[parent::article-meta]" priority="1000" mode="M91">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions" priority="1000" mode="M93">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M94">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M95">
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <!--REPORT error-->
   ...
   <!--RULE license-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license" priority="1000" mode="M96">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license/license-p" priority="1000" mode="M97">
   ...
   <xsl:template match="permissions/license[@xlink:href]/license-p" priority="1000" mode="M98">
      <xsl:variable name="license-link" select="parent::license/@xlink:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[ali:license_ref]/license-p" priority="1000" mode="M99">
   ...
   <xsl:template match="preformat" priority="1000" mode="M101">
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M102">
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M103">
   ...
   <!--RULE xref-checks-->
   <xsl:template match="xref" priority="1000" mode="M104">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M105">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M106">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M107">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" priority="1000" mode="M108">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub" priority="1000" mode="M109">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group" priority="1000" mode="M110">
   ...
   <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M111">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='claim-importance']/kwd" priority="1000" mode="M112">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" priority="1000" mode="M113">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body/p[1]//bold" priority="1000" mode="M114">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M115">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M116">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M117">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M118">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M119">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M120">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M121">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M122">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M123">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M124">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M125">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M126">
