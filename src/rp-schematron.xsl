<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <!--PATTERN strike-checks-pattern-->
	  ...
	  <!--RULE strike-checks-->
   <xsl:template match="strike" priority="1000" mode="M29">
   ...
   <xsl:template match="underline" priority="1000" mode="M30">
   ...
   <!--PATTERN fig-checks-pattern-->
	  ...
	  <!--RULE fig-checks-->
   <xsl:template match="fig" priority="1000" mode="M31">
   ...
   <xsl:template match="fig/label" priority="1000" mode="M33">
   ...
   <xsl:template match="table-wrap" priority="1000" mode="M34">
   ...
   <xsl:template match="table-wrap/label" priority="1000" mode="M36">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M37">
   ...
   <xsl:template match="inline-formula" priority="1000" mode="M38">
   ...
   <xsl:template match="alternatives[parent::disp-formula]" priority="1000" mode="M39">
   ...
   <xsl:template match="alternatives[parent::inline-formula]" priority="1000" mode="M40">
   ...
   <!--PATTERN list-checks-pattern-->
	  ...
	  <!--RULE list-checks-->
   <xsl:template match="list" priority="1000" mode="M41">
   ...
   <!--PATTERN graphic-checks-pattern-->
	  ...
	  <!--RULE graphic-checks-->
   <xsl:template match="graphic|inline-graphic" priority="1000" mode="M42">
   ...
   <!--PATTERN title-checks-pattern-->
	  ...
	  <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M43">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M44">
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M45">
   ...
   <xsl:template match="article/front/article-meta/article-version" priority="1000" mode="M46">
   ...
   <xsl:template match="preformat" priority="1000" mode="M48">
   ...
   <!--PATTERN code-checks-pattern-->
	  ...
	  <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M49">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" priority="1000" mode="M50">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id)='arxiv']" priority="1000" mode="M51">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id)='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M52">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id)='rs']" priority="1000" mode="M53">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id)='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M54">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id)='psyarxiv']" priority="1000" mode="M55">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id)='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M56">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id)='osf preprints']" priority="1000" mode="M57">
   ...
   <!--PATTERN osf-doi-checks-pattern-->
	  ...
	  <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id)='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M58">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id)='ecoevorxiv']" priority="1000" mode="M59">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id)='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M60">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id)='authorea']" priority="1000" mode="M61">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id)='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M62">
