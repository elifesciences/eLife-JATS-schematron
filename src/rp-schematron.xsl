<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xlink="http://www.w3.org/1999/xlink" name="e:analyze-string" as="element()">
      <xsl:param name="node"/>
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xlink="http://www.w3.org/1999/xlink" name="e:org-conform" as="element()">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xlink="http://www.w3.org/1999/xlink" name="e:org-conform-helper" as="element()*">
      <xsl:param name="node" as="node()"/>
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xlink="http://www.w3.org/1999/xlink" name="e:assessment-term-to-number">
      <xsl:param name="term"/>
      <xsl:choose>
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="eLife reviewed preprint schematron" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ref-doi-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">ref-doi-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ref-child-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">ref-child-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">table-wrap-title-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">table-wrap-title-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">table-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">table-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">app-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">app-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">p-file-ref-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">p-file-ref-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">p-td-th-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">p-td-th-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">eu-horizon-grant-doi-tests-pattern</xsl:attribute>
            <xsl:attribute name="name">eu-horizon-grant-doi-tests-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">inline-media-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">inline-media-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">disp-quote-checks-pattern</xsl:attribute>
            <xsl:attribute name="name">disp-quote-checks-pattern</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <xsl:param name="wellcome-funder-ids" select="('http://dx.doi.org/10.13039/100010269','http://dx.doi.org/10.13039/100004440','https://ror.org/029chgv08')"/>
   <xsl:param name="known-grant-funder-ids" select="('http://dx.doi.org/10.13039/100000936','http://dx.doi.org/10.13039/501100002241','http://dx.doi.org/10.13039/100000913','http://dx.doi.org/10.13039/501100002428','http://dx.doi.org/10.13039/100000968','https://ror.org/006wxqw41','https://ror.org/00097mb19','https://ror.org/03dy4aq19','https://ror.org/013tf3c58','https://ror.org/013kjyp64')"/>
   <xsl:param name="eu-horizon-fundref-ids" select="('http://dx.doi.org/10.13039/100018693','http://dx.doi.org/10.13039/100018694','http://dx.doi.org/10.13039/100018695','http://dx.doi.org/10.13039/100018696','http://dx.doi.org/10.13039/100018697','http://dx.doi.org/10.13039/100018698','http://dx.doi.org/10.13039/100018699','http://dx.doi.org/10.13039/100018700','http://dx.doi.org/10.13039/100018701','http://dx.doi.org/10.13039/100018702','http://dx.doi.org/10.13039/100018703','http://dx.doi.org/10.13039/100018704','http://dx.doi.org/10.13039/100018705','http://dx.doi.org/10.13039/100018706','http://dx.doi.org/10.13039/100018707','http://dx.doi.org/10.13039/100019180','http://dx.doi.org/10.13039/100019185','http://dx.doi.org/10.13039/100019186','http://dx.doi.org/10.13039/100019187','http://dx.doi.org/10.13039/100019188')"/>
   <xsl:param name="grant-doi-exception-funder-ids" select="($wellcome-funder-ids,$known-grant-funder-ids,$eu-horizon-fundref-ids)"/>
   ...
   <!--RULE article-tests-->
   <xsl:template match="article[front/journal-meta/lower-case(journal-id[1])='elife']" priority="1000" mode="M43">
   ...
   <xsl:template match="article-meta/title-group/article-title" priority="1000" mode="M44">
   ...
   <xsl:template match="article-meta/title-group/article-title/*" priority="1000" mode="M45">
   ...
   <xsl:template match="article-meta/contrib-group/contrib[@contrib-type='author' and not(collab)]" priority="1000" mode="M46">
   ...
   <xsl:template match="contrib[@contrib-type='author']" priority="1000" mode="M47">
   ...
   <!--RULE name-tests-->
   <xsl:template match="contrib-group//name" priority="1000" mode="M48">
   ...
   <!--RULE surname-tests-->
   <xsl:template match="contrib-group//name/surname" priority="1000" mode="M49">
   ...
   <xsl:template match="name/given-names" priority="1000" mode="M50">
   ...
   <xsl:template match="contrib-group//name/*" priority="1000" mode="M51">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[1]" priority="1000" mode="M52">
   ...
   <!--RULE orcid-tests-->
   <xsl:template match="contrib-id[@contrib-id-type='orcid']" priority="1000" mode="M53">
   ...
   <xsl:template match="aff" priority="1000" mode="M54">
   ...
   <!--RULE country-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//aff/country" priority="1000" mode="M55">
   ...
   <xsl:template match="aff[ancestor::contrib-group[not(@*)]/parent::article-meta]//institution-wrap" priority="1000" mode="M56">
   ...
   <xsl:template match="aff//institution-id" priority="1000" mode="M57">
   ...
   <!--RULE aff-ror-tests-->
   <xsl:template match="aff[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M58">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[@content-type='section']" priority="1000" mode="M59">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[@content-type='section']/contrib" priority="1000" mode="M60">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']" priority="1000" mode="M61">
      <xsl:variable name="text-regex" select="'^[\p{Z}\p{P}]+((jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)\p{Z}?\d?\d?|doi|pmid|epub|vol|no|and|pp?|in|is[sb]n)[:\.]?'"/>
      <!--ASSERT error-->
      <xsl:choose>
      ...
      <!--REPORT warning-->
      <xsl:if test="text()[matches(.,'\p{L}') and not(matches(lower-case(.),$text-regex))]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="text()[matches(.,'\p{L}') and not(matches(lower-case(.),$text-regex))]">
            ...
            <svrl:text>[journal-ref-text-content] This journal reference (<xsl:text/>
               ...
               <xsl:value-of select="string-join(text()[matches(.,'\p{L}') and not(matches(lower-case(.),$text-regex))],'; ')"/>
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/source" priority="1000" mode="M62">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/fpage" priority="1000" mode="M63">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']" priority="1000" mode="M64">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']/source" priority="1000" mode="M65">
      <xsl:variable name="lc" select="lower-case(.)"/>
      <!--REPORT warning-->
   ...
   <xsl:template match="mixed-citation[@publication-type='book']" priority="1000" mode="M66">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']/source" priority="1000" mode="M67">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']" priority="1000" mode="M68">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']/conf-name" priority="1000" mode="M69">
   ...
   <xsl:template match="ref-list" priority="1000" mode="M70">
   ...
   <xsl:template match="ref-list[ref/label[matches(.,'^\p{P}*\d+\p{P}*$')] and not(ref/label[not(matches(.,'^\p{P}*\d+\p{P}*$'))])]/ref[label]" priority="1000" mode="M71">
   ...
   <xsl:template match="ref-list[ref/label]/ref" priority="1000" mode="M72">
   ...
   <xsl:template match="ref//year" priority="1000" mode="M73">
   ...
   <xsl:template match="mixed-citation//name | mixed-citation//string-name" priority="1000" mode="M74">
   ...
   <xsl:template match="mixed-citation//given-names | mixed-citation//surname" priority="1000" mode="M75">
   ...
   <!--RULE collab-checks-->
   <xsl:template match="collab" priority="1000" mode="M76">
   ...
   <xsl:template match="mixed-citation[person-group]//etal" priority="1000" mode="M77">
   ...
   <xsl:template match="comment" priority="1000" mode="M78">
   ...
   <xsl:template match="ref//pub-id" priority="1000" mode="M79">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="normalize-space(.) = .">
               <xsl:attribute name="id">pub-id-check-7</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[pub-id-check-7] <xsl:text/>
                  <xsl:value-of select="name(.)"/>
                  <xsl:text/> must contain a value with normalized space. This one has '<xsl:text/>
                  <xsl:value-of select="."/>
                  <xsl:text/>'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
   ...
   <!--PATTERN ref-doi-checks-pattern-->
   <!--RULE ref-doi-checks-->
   <xsl:template match="ref//pub-id[@pub-id-type='doi']" priority="1000" mode="M80">
      ...
      <xsl:if test="matches(normalize-space(lower-case(.)),'^10\.7554/elife\.\d{5,6}\.\d{3}$')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(normalize-space(lower-case(.)),'^10\.7554/elife\.\d{5,6}\.\d{3}$')">
            ...
            <svrl:text>[ref-doi-elife-component] This DOI (<xsl:text/>
               <xsl:value-of select="."/>
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='isbn']|isbn" priority="1000" mode="M81">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='issn']|issn" priority="1000" mode="M82">
   ...
   <xsl:template match="ref//person-group" priority="1000" mode="M83">
   ...
   <!--RULE ref-checks-->
   <xsl:template match="ref" priority="1000" mode="M84">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="mixed-citation or element-citation">
               <xsl:attribute name="id">ref-no-citations</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--REPORT error-->
      <xsl:if test="(count(mixed-citation) + count(element-citation)) gt 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(count(mixed-citation) + count(element-citation)) gt 1">
            <xsl:attribute name="id">ref-extra-citations</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[ref-extra-citations] <xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/> cannot contain more that one citation element (mixed-citation or element-citation). This one (with id=<xsl:text/>
               <xsl:value-of select="ancestor::ref/@id"/>
               <xsl:text/>) has <xsl:text/>
               <xsl:value-of select="count(mixed-citation) + count(element-citation)"/>
               <xsl:text/>.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
   ...
   <!--PATTERN ref-child-checks-pattern-->
   <!--RULE ref-child-checks-->
   <xsl:template match="ref/*" priority="1000" mode="M85">
      <xsl:variable name="allowed-children" select="('label','mixed-citation','element-citation')"/>
      <!--ASSERT error-->
      <xsl:choose>
         <xsl:when test="name()=$allowed-children"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="name()=$allowed-children">
               <xsl:attribute name="id">ref-child</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[ref-child] <xsl:text/>
                  <xsl:value-of select="name(.)"/>
                  <xsl:text/> is not supported in ref. Only the following elements are permittted: <xsl:text/>
      ...
      <!--REPORT warning-->
      <xsl:if test="name()='element-citation'">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="name()='element-citation'">
            <xsl:attribute name="id">ref-element-citation</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[ref-element-citation] mixed-citation is typically used for references in Reviewed preprints instead of <xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/>. Please check this refeerence displays as corrceted.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M85"/>
   </xsl:template>
   ...
   <xsl:template match="ref//article-title" priority="1000" mode="M86">
   ...
   <xsl:template match="ref//chapter-title" priority="1000" mode="M87">
   ...
   <xsl:template match="ref//source" priority="1000" mode="M88">
   ...
   <xsl:template match="mixed-citation" priority="1000" mode="M89">
   ...
   <xsl:template match="mixed-citation/*" priority="1000" mode="M90">
   ...
   <!--RULE comment-checks-->
   <xsl:template match="comment" priority="1000" mode="M91">
   ...
   <!--RULE back-tests-->
   <xsl:template match="back" priority="1000" mode="M92">
   ...
   <!--RULE ack-tests-->
   <xsl:template match="ack" priority="1000" mode="M93">
   ...
   <!--RULE strike-checks-->
   <xsl:template match="strike" priority="1000" mode="M94">
   ...
   <xsl:template match="underline" priority="1000" mode="M95">
   ...
   <!--RULE bold-checks-->
   <xsl:template match="bold" priority="1000" mode="M96">
   ...
   <!--RULE sc-checks-->
   <xsl:template match="sc" priority="1000" mode="M97">
   ...
   <!--RULE fig-checks-->
   <xsl:template match="fig" priority="1000" mode="M98">
      ...
      <!--REPORT warning-->
      <xsl:if test="not(label) and parent::sec and preceding-sibling::title and not(following-sibling::*)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(label) and parent::sec and preceding-sibling::title and not(following-sibling::*)">
            <xsl:attribute name="id">fig-sec-wrapper</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[fig-sec-wrapper] Unlablled figure is entirely wrapped in a sec with a title. Is the sec redundant and the title actually the label (or title) for the figure?</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M98"/>
   </xsl:template>
   ...
   <xsl:template match="fig/*" priority="1000" mode="M99">
   ...
   <xsl:template match="fig/label" priority="1000" mode="M100">
   ...
   <xsl:template match="fig/caption/title" priority="1000" mode="M101">
      ...
      <xsl:if test="$sentence-count gt 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$sentence-count gt 1">
            <xsl:attribute name="id">fig-title-2</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[fig-title-2] Title for <xsl:text/>
               <xsl:value-of select="replace(ancestor::fig[1]/label[1],'\.$','')"/>
               <xsl:text/> contains <xsl:text/>
               <xsl:value-of select="$sentence-count"/>
               <xsl:text/> sentences. Should the sentence(s) after the first be moved into the caption? Or is the title itself a caption?</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M101"/>
   </xsl:template>
   ...
   <xsl:template match="fig/caption" priority="1000" mode="M102">
      ...
      <xsl:if test="not(title) and (count(p)=1) and not(count(tokenize(p[1],'\.\p{Z}')) gt 1)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(title) and (count(p)=1) and not(count(tokenize(p[1],'\.\p{Z}')) gt 1)">
            <xsl:attribute name="id">fig-caption-3</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[fig-caption-3] Caption for <xsl:text/>
               <xsl:value-of select="$label"/>
   ...
   <xsl:template match="table-wrap" priority="1000" mode="M103">
      ...
      <xsl:if test="not(label) and parent::sec and preceding-sibling::title and not(following-sibling::*)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(label) and parent::sec and preceding-sibling::title and not(following-sibling::*)">
            <xsl:attribute name="id">table-wrap-sec-wrapper</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[table-wrap-sec-wrapper] Unlablled table is entirely wrapped in a sec with a title. Is the sec redundant and the title actually the label (or title) for the table?</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M103"/>
   </xsl:template>
   ...
   <xsl:template match="table-wrap/*" priority="1000" mode="M104">
   ...
   <xsl:template match="table-wrap/label" priority="1000" mode="M105">
   ...
   <xsl:template match="table-wrap/caption" priority="1000" mode="M106">
   ...
   <!--PATTERN table-wrap-title-checks-pattern-->
   <!--RULE table-wrap-title-checks-->
   <xsl:template match="table-wrap/caption/title" priority="1000" mode="M107">
      <xsl:variable name="sentence-count" select="count(tokenize(replace(replace(lower-case(.),$org-regex,''),'[\p{Zs}]$',''),'\. '))"/>
      <!--REPORT warning-->
      <xsl:if test="$sentence-count gt 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$sentence-count gt 1">
            <xsl:attribute name="id">table-wrap-title-1</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[table-wrap-title-1] Title for <xsl:text/>
   ...
   <!--PATTERN table-checks-pattern-->
   <!--RULE table-checks-->
   <xsl:template match="table" priority="1000" mode="M108">

		<!--REPORT warning-->
      <xsl:if test="descendant::*[name()=('tr','td','th') and @style[contains(.,'background-color')]]">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="descendant::*[name()=('tr','td','th') and @style[contains(.,'background-color')]]">
            <xsl:attribute name="id">table-style-test-1</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[table-style-test-1] <xsl:text/>
   ...
   <xsl:template match="supplementary-material" priority="1000" mode="M109">
   ...
   <xsl:template match="supplementary-material/*" priority="1000" mode="M110">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M111">
   ...
   <xsl:template match="inline-formula" priority="1000" mode="M112">
   ...
   <xsl:template match="alternatives[parent::disp-formula]" priority="1000" mode="M113">
   ...
   <xsl:template match="alternatives[parent::inline-formula]" priority="1000" mode="M114">
   ...
   <!--RULE math-tests-->
   <xsl:template match="*:math" priority="1000" mode="M115">
      ...
      <!--REPORT error-->
      <xsl:if test="descendant::*:merror">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="descendant::*:merror">
            ...
            <svrl:text>[math-test-2] math contains an mml:merror with '<xsl:text/>
               <xsl:value-of select="descendant::*:merror[1]/*"/>
   ...
   <!--RULE list-checks-->
   <xsl:template match="list" priority="1000" mode="M116">
   ...
   <!--RULE graphic-checks-->
   <xsl:template match="graphic|inline-graphic" priority="1000" mode="M117">
   ...
   <xsl:template match="graphic" priority="1000" mode="M118">
   ...
   <!--RULE inline-checks-->
   <xsl:template match="inline-graphic" priority="1000" mode="M119">
   ...
   <!--RULE media-checks-->
   <xsl:template match="media" priority="1000" mode="M120">
   ...
   <!--RULE sec-checks-->
   <xsl:template match="sec" priority="1000" mode="M121">
      ...
      <!--REPORT error-->
      <xsl:if test="label and not(title)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="label and not(title)">
            <xsl:attribute name="id">sec-label-no-title</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE top-sec-checks-->
   <xsl:template match="sec[(parent::body or parent::back) and title]" priority="1000" mode="M122">
   ...
   <xsl:template match="sec/label" priority="1000" mode="M123">
   ...
   <!--PATTERN app-checks-pattern-->
   <!--RULE app-checks-->
   <xsl:template match="app" priority="1000" mode="M124">

		<!--REPORT error-->
      <xsl:if test="label and not(title)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="label and not(title)">
            <xsl:attribute name="id">app-label-no-title</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[app-label-no-title] app element has a label but not title. This is not correct. Please capture the label as the title.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M124"/>
   </xsl:template>
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M125">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M126">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[not(ancestor::sub-article or ancestor::def) and (count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M127">
   ...
   <!--RULE p-ref-checks-->
   <xsl:template match="article[descendant::xref[@ref-type='bibr'][matches(.,'\p{L}')]]//p[not(ancestor::sub-article) and not(ancestor::ack)]" priority="1000" mode="M128">
      ...
      <xsl:if test="matches($text,$missing-ref-regex)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches($text,$missing-ref-regex)">
            ...
            <svrl:text>[missing-ref-in-text-test] <xsl:text/>
               ...
               <xsl:value-of select="string-join(e:analyze-string($text,$missing-ref-regex)//*:match,'; ')"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
   ...
   <!--PATTERN p-file-ref-checks-pattern-->
   <!--RULE p-file-ref-checks-->
   <xsl:template match="article//p[not(ancestor::sub-article) and not(ancestor::ack)]" priority="1000" mode="M129">
      <xsl:variable name="text" select="lower-case(string-join(for $x in self::*/(*|text())                                             return if ($x/local-name()='xref') then ()                                                    else if ($x//*:p) then ($x/text())                                                    else string($x),''))"/>
      <xsl:variable name="missing-file-regex" select="'\s(fig(\.|ure)?|table|file|movie|video)s?(\s+supp(\.|l[ae]m[ae]nt(ary|al)?)?s?)?\s+s?\d'"/>
      <!--REPORT warning-->
      <xsl:if test="matches($text,$missing-file-regex)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches($text,$missing-file-regex)">
            ...
            <svrl:text>[missing-file-in-text-test] <xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/> element contains possible unlinked citation to a figure, table or file - search - <xsl:text/>
               <xsl:value-of select="string-join(e:analyze-string($text,$missing-file-regex)//*:match,'; ')"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
   ...
   <!--PATTERN p-td-th-checks-pattern-->
   <!--RULE p-td-th-checks-->
   <xsl:template match="p|td|th" priority="1000" mode="M130">
      <xsl:variable name="rrid-link-count" select="count(descendant::ext-link[matches(@*:href,'identifiers\.org/RRID(:|/).*')])"/>
      <xsl:variable name="rrid-text-count" select="number(count(         for $x in tokenize(.,'RRID\p{Zs}?#?\p{Zs}?:|RRID AB_[\d]+|RRID CVCL_[\d]+|RRID SCR_[\d]+|RRID ISMR_JAX')         return $x)) -1"/>
      ...
      <!--REPORT warning-->
      <xsl:if test="($rrid-text-count gt $rrid-link-count)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="($rrid-text-count gt $rrid-link-count)">
      ...
      <xsl:if test="matches(.,'˚') and not(descendant::p[matches(.,'˚')]) and not(descendant::td[matches(.,'˚')]) and not(descendant::th[matches(.,'˚')])">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(.,'˚') and not(descendant::p[matches(.,'˚')]) and not(descendant::td[matches(.,'˚')]) and not(descendant::th[matches(.,'˚')])">
            ...
            <xsl:attribute name="see">https://elifeproduction.slab.com/posts/house-style-yi0641ob#hrt08-ring-diacritic-symbol-test</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M131">
   ...
   <xsl:template match="article/front/article-meta/article-id" priority="1000" mode="M132">
   ...
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='publisher-id']" priority="1000" mode="M133">
   ...
   <!--RULE article-dois-->
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M134">
   ...
   <xsl:template match="article/front/article-meta/author-notes" priority="1000" mode="M135">
   ...
   <xsl:template match="article/front/article-meta/author-notes/fn" priority="1000" mode="M136">
      <xsl:variable name="id" select="@id"/>
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M137">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M138">
   ...
   <xsl:template match="article/front[journal-meta/journal-id='elife']/article-meta[matches(replace(article-id[@specific-use='version'][1],'^.*\.',''),'^\d\d?$') and matches(descendant::article-version[@article-version-type='preprint-version'][1],'^1\.\d+$')]" priority="1000" mode="M139">
   ...
   <xsl:template match="article/front/article-meta/pub-date[@pub-type='epub']/year" priority="1000" mode="M140">
   ...
   <!--RULE contrib-checks-->
   <xsl:template match="article/front/article-meta/contrib-group/contrib" priority="1000" mode="M141">
   ...
   <!--RULE volume-test-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/volume" priority="1000" mode="M142">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/elocation-id" priority="1000" mode="M143">
   ...
   <!--RULE history-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/history" priority="1000" mode="M144">
   ...
   <xsl:template match="article[front[journal-meta/lower-case(journal-id[1])='elife']]//pub-history" priority="1000" mode="M145">
   ...
   <!--RULE event-tests-->
   <xsl:template match="event" priority="1000" mode="M146">
   ...
   <xsl:template match="event/*" priority="1000" mode="M147">
   ...
   <!--RULE rp-event-tests-->
   <xsl:template match="event[date[@date-type='reviewed-preprint']/@iso-8601-date != '']" priority="1000" mode="M148">
   ...
   <xsl:template match="event-desc" priority="1000" mode="M149">
   ...
   <xsl:template match="event/date" priority="1000" mode="M150">
   ...
   <xsl:template match="event/self-uri" priority="1000" mode="M151">
   ...
   <xsl:template match="funding-group" priority="1000" mode="M152">
   ...
   <xsl:template match="funding-group" priority="1000" mode="M153">
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi') and normalize-space(.)!=''] and funding-source/institution-wrap[count(institution-id)=1]/institution-id[not(.=$grant-doi-exception-funder-ids)]]" priority="1000" mode="M155">
   ...
   <xsl:template match="funding-group/award-group[not(award-id) and funding-source/institution-wrap[count(institution-id)=1]/institution-id]" priority="1000" mode="M156">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
      <xsl:variable name="funder-entry" select="document($rors)//*:ror[*:id[@type='ror']=$funder-id]"/>
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=$wellcome-funder-ids]" priority="1000" mode="M157">
      <xsl:variable name="grants" select="document($rors)//*:ror[*:id=$wellcome-funder-ids]/*:grant"/>
      <xsl:variable name="award-id-elem" select="award-id"/>
      <xsl:variable name="award-id" select="e:alter-award-id($award-id-elem,$wellcome-funder-ids[last()])"/>
   ...
   <!--PATTERN eu-horizon-grant-doi-tests-pattern-->
   <!--RULE eu-horizon-grant-doi-tests-->
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=($eu-horizon-fundref-ids,'https://ror.org/00k4n6c32')]" priority="1000" mode="M158">
      <xsl:variable name="eu-comission-ror-id" select="'https://ror.org/00k4n6c32'"/>
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
      <xsl:variable name="grants" select="document($rors)//*:ror[*:id[@type='ror']=$eu-comission-ror-id]/*:grant"/>
      <xsl:variable name="award-id" select="e:alter-award-id(award-id[1],$funder-id)"/>
      <xsl:variable name="grant-matches" select="if ($award-id='') then ()         else $grants[@award=$award-id]"/>
      <!--REPORT warning-->
      <xsl:if test="$grant-matches">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$grant-matches">
            <xsl:attribute name="id">eu-horizon-grant-doi-test-1</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[eu-horizon-grant-doi-test-1] Funding entry from <xsl:text/>
               <xsl:value-of select="funding-source/institution-wrap/institution"/>
               <xsl:text/> has an award-id (<xsl:text/>
               <xsl:value-of select="award-id[1]"/>
               <xsl:text/>) which could potentially be replaced with a grant DOI. The following grant DOIs are possibilities: <xsl:text/>
               <xsl:value-of select="string-join(for $grant in $grant-matches return concat('https://doi.org/',$grant/@doi),'; ')"/>
               <xsl:text/>.</svrl:text>
         </svrl:successful-report>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$grant-matches">
               <xsl:attribute name="id">eu-horizon-grant-doi-test-2</xsl:attribute>
               <xsl:attribute name="see">https://elifeproduction.slab.com/posts/funding-3sv64358#wellcome-grant-doi-test-2</xsl:attribute>
               <xsl:attribute name="role">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[eu-horizon-grant-doi-test-2] Funding entry from <xsl:text/>
                  <xsl:value-of select="funding-source/institution-wrap/institution"/>
                  <xsl:text/> has an award-id (<xsl:text/>
                  <xsl:value-of select="award-id[1]"/>
                  <xsl:text/>). The award id hasn't exactly matched the details of a known grant DOI, but the funder is known to mint grant DOIs (for example in the format <xsl:text/>
   ...
   <xsl:template match="funding-group/award-group[award-id[not(@award-id-type='doi')] and funding-source/institution-wrap/institution-id=$known-grant-funder-ids]" priority="1000" mode="M159">
      <xsl:variable name="funder-id" select="funding-source/institution-wrap/institution-id"/>
      <xsl:variable name="grants" select="document($rors)//*:ror[*:id[@type=('ror','fundref')]=$funder-id]/*:grant"/>
      <xsl:variable name="award-id-elem" select="award-id"/>
      <xsl:variable name="award-id" select="e:alter-award-id($award-id-elem,$funder-id)"/>
      <xsl:variable name="grant-matches" select="if ($award-id='') then ()         else $grants[@award=$award-id]"/>
      <!--REPORT warning-->
      <xsl:if test="$grant-matches">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$grant-matches">
   ...
   <!--RULE award-id-tests-->
   <xsl:template match="funding-group/award-group/award-id" priority="1000" mode="M160">
      ...
      <!--REPORT error-->
      <xsl:if test="not(@award-id-type='doi') and matches(.,'^10\.\d{4,9}/[-._;\+()#/:A-Za-z0-9&lt;&gt;\[\]]+$')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(@award-id-type='doi') and matches(.,'^10\.\d{4,9}/[-._;\+()#/:A-Za-z0-9&lt;&gt;\[\]]+$')">
            <xsl:attribute name="id">award-id-test-10</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
      ...
      <!--REPORT error-->
      <xsl:if test="@award-id-type='doi' and not(matches(.,'^10\.\d{4,9}/[-._;\+()#/:A-Za-z0-9&lt;&gt;\[\]]+$'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@award-id-type='doi' and not(matches(.,'^10\.\d{4,9}/[-._;\+()#/:A-Za-z0-9&lt;&gt;\[\]]+$'))">
            <xsl:attribute name="id">award-id-test-12</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[award-id-test-12] award-id has the attribute award-id-type="doi" but it does not contain a valid DOI (<xsl:text/>
               <xsl:value-of select="."/>
               <xsl:text/>).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
   ...
   <xsl:template match="funding-source//institution-id" priority="1000" mode="M161">
   ...
   <xsl:template match="funding-source//institution-wrap" priority="1000" mode="M162">
   ...
   <xsl:template match="funding-source[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M163">
      <xsl:variable name="rors" select="'rors.xml'"/>
      <xsl:variable name="ror" select="institution-wrap[1]/institution-id[@institution-id-type='ror'][1]"/>
      <xsl:variable name="matching-ror" select="document($rors)//*:ror[*:id=$ror]"/>
      <!--ASSERT error-->
   ...
   <xsl:template match="abstract[parent::article-meta]" priority="1000" mode="M164">
   ...
   <xsl:template match="abstract[parent::article-meta]/*" priority="1000" mode="M165">
   ...
   <xsl:template match="abstract[@xml:lang]" priority="1000" mode="M166">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions" priority="1000" mode="M167">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@*:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M168">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@*:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@*:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M169">
      <xsl:variable name="license-type" select="license/@*:href"/>
      <!--REPORT error-->
   ...
   <!--RULE license-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license" priority="1000" mode="M170">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license/license-p" priority="1000" mode="M171">
   ...
   <xsl:template match="permissions/license[@*:href]/license-p" priority="1000" mode="M172">
      <xsl:variable name="license-link" select="parent::license/@*:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[*:license_ref]/license-p" priority="1000" mode="M173">
   ...
   <xsl:template match="fig[not(descendant::permissions)]|media[@mimetype='video' and not(descendant::permissions)]|table-wrap[not(descendant::permissions)]|supplementary-material[not(descendant::permissions)]" priority="1000" mode="M174">
   ...
   <xsl:template match="related-object[@content-type or @document-id]" priority="1000" mode="M175">
   ...
   <!--RULE notes-checks-->
   <xsl:template match="front/notes" priority="1000" mode="M176">
   ...
   <xsl:template match="title" priority="1000" mode="M177">
   ...
   <xsl:template match="preformat" priority="1000" mode="M178">
      ...
      <xsl:if test=".">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=".">
            ...
            <svrl:text>[preformat-flag] Please check whether the content in this preformat element has been captured correctly (and is rendered approriately).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M178"/>
   </xsl:template>
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M179">
      ...
      <xsl:if test=".">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=".">
            ...
            <svrl:text>[code-flag] Please check whether the content in this code element has been captured correctly (and is rendered approriately).</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M179"/>
   </xsl:template>
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M180">
   ...
   <!--PATTERN inline-media-checks-pattern-->
   <!--RULE inline-media-checks-->
   <xsl:template match="inline-media" priority="1000" mode="M181">

		<!--REPORT error-->
      <xsl:if test=".">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=".">
            <xsl:attribute name="id">inline-media-flag</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[inline-media-flag] The inline-media element is not permitted. Instead use inline-graphic for images or supplementary-material for downloadable files.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M181"/>
   </xsl:template>
   ...
   <!--PATTERN disp-quote-checks-pattern-->
   <!--RULE disp-quote-checks-->
   <xsl:template match="disp-quote" priority="1000" mode="M182">

		<!--ASSERT warning-->
      <xsl:choose>
         <xsl:when test="ancestor::sub-article[@article-type='author-comment']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::sub-article[@article-type='author-comment']">
               <xsl:attribute name="id">disp-quote-1</xsl:attribute>
               <xsl:attribute name="role">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[disp-quote-1] Display quotes are uncommon in eLife content outside the author response. Please check whether this content has been captured correctly (and is rendered approriately).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--REPORT error-->
      <xsl:if test="ancestor::sub-article[@article-type='author-comment'] and not(@content-type='editor-comment')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ancestor::sub-article[@article-type='author-comment'] and not(@content-type='editor-comment')">
            <xsl:attribute name="id">disp-quote-2</xsl:attribute>
            <xsl:attribute name="role">error</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[disp-quote-2] Display quotes in the author response must have the attribute content-type="editor-comment". This one does not.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M182"/>
   </xsl:template>
   ...
   <!--RULE xref-checks-->
   <xsl:template match="xref" priority="1000" mode="M183">
   ...
   <xsl:template match="xref[@ref-type='bibr']" priority="1000" mode="M184">
   ...
   <xsl:template match="xref[@ref-type='fig' and @rid]" priority="1000" mode="M185">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M186">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M187">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M188">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link|ref" priority="1000" mode="M189">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub" priority="1000" mode="M190">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group" priority="1000" mode="M191">
   ...
   <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M192">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='claim-importance']/kwd" priority="1000" mode="M193">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" priority="1000" mode="M194">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body" priority="1000" mode="M195">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body/p[1]//bold" priority="1000" mode="M196">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//fig/label" priority="1000" mode="M197">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//table-wrap/label" priority="1000" mode="M198">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//fig/label" priority="1000" mode="M199">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//table-wrap/label" priority="1000" mode="M200">
   ...
   <xsl:template match="sub-article/front-stub/title-group/article-title" priority="1000" mode="M201">
   ...
   <xsl:template match="sub-article/front-stub" priority="1000" mode="M202">
   ...
   <xsl:template match="sub-article/front-stub/article-id[@pub-id-type='doi']" priority="1000" mode="M203">
   ...
   <xsl:template match="sub-article/body//p" priority="1000" mode="M204">
      ...
      <!--REPORT warning-->
      <xsl:if test="not(matches(.,'\$?\$.*?\$\$?')) and matches(.,'\\[a-z]+\p{Ps}')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(matches(.,'\$?\$.*?\$\$?')) and matches(.,'\\[a-z]+\p{Ps}')">
            <xsl:attribute name="id">sub-article-tex-2</xsl:attribute>
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>[sub-article-tex-2] sub-article contains what looks like potential latex: <xsl:text/>
               <xsl:value-of select="string-join(distinct-values(e:analyze-string(.,'\\[a-z]+\p{Ps}')//*:match),'; ')"/>
               <xsl:text/>. If this is maths it should either be represented in plain unicode or as an image.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M204"/>
   ...
   <xsl:template match="sub-article/body//ext-link" priority="1000" mode="M205">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M206">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M207">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M208">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M209">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M210">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M211">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M212">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M213">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M214">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M215">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M216">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M217">
   ...
   <xsl:template match="processing-instruction('fig-class')" priority="1000" mode="M218">
   ...
   <xsl:template match="processing-instruction('fig-width')" priority="1000" mode="M219">
   ...
   <xsl:template match="processing-instruction('math-size')" priority="1000" mode="M220">
      <xsl:variable name="next-node-name" select="following-sibling::node()[not(self::text())][1]/name()"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="processing-instruction('page-break')" priority="1000" mode="M221">
   ...
   <xsl:template match="processing-instruction('table-escape')" priority="1000" mode="M222">
      <xsl:variable name="next-node-name" select="following-sibling::node()[not(self::text())][1]/name()"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <!--RULE all-pi-checks-->
   <xsl:template match="processing-instruction()" priority="1000" mode="M223">
   ...
   <xsl:template match="ref//comment()" priority="1000" mode="M224">
