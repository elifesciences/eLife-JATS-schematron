<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="graphic" priority="1000" mode="M77">
   ...
   <!--RULE inline-checks-->
   <xsl:template match="inline-graphic" priority="1000" mode="M78">
   ...
   <!--RULE media-checks-->
   <xsl:template match="media" priority="1000" mode="M79">
   ...
   <!--RULE sec-checks-->
   <xsl:template match="sec" priority="1000" mode="M80">
   ...
   <!--RULE top-sec-checks-->
   <xsl:template match="sec[(parent::body or parent::back) and title]" priority="1000" mode="M81">
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M82">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M83">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[not(ancestor::sub-article) and (count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M84">
   ...
   <xsl:template match="article/front/article-meta" priority="1000" mode="M85">
   ...
   <xsl:template match="article/front/article-meta/article-id" priority="1000" mode="M86">
   ...
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='publisher-id']" priority="1000" mode="M87">
   ...
   <!--RULE article-dois-->
   <xsl:template match="article/front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M88">
   ...
   <xsl:template match="article/front/article-meta/author-notes" priority="1000" mode="M89">
   ...
   <xsl:template match="article/front/article-meta/author-notes/fn" priority="1000" mode="M90">
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M91">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M92">
   ...
   <xsl:template match="article/front[journal-meta/journal-id='elife']/article-meta[matches(replace(article-id[@specific-use='version'][1],'^.*\.',''),'^\d\d?$') and matches(descendant::article-version[@article-version-type='preprint-version'][1],'^1\.\d+$')]" priority="1000" mode="M93">
   ...
   <xsl:template match="article/front/article-meta/pub-date[@pub-type='epub']/year" priority="1000" mode="M94">
   ...
   <!--RULE contrib-checks-->
   <xsl:template match="article/front/article-meta/contrib-group/contrib" priority="1000" mode="M95">
   ...
   <!--RULE volume-test-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/volume" priority="1000" mode="M96">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/elocation-id" priority="1000" mode="M97">
   ...
   <!--RULE history-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']/article-meta/history" priority="1000" mode="M98">
   ...
   <xsl:template match="article[front[journal-meta/lower-case(journal-id[1])='elife']]//pub-history" priority="1000" mode="M99">
   ...
   <!--RULE event-tests-->
   <xsl:template match="event" priority="1000" mode="M100">
   ...
   <!--RULE rp-event-tests-->
   <xsl:template match="event[date[@date-type='reviewed-preprint']/@iso-8601-date != '']" priority="1000" mode="M102">
   ...
   <xsl:template match="event-desc" priority="1000" mode="M103">
   ...
   <xsl:template match="event/date" priority="1000" mode="M104">
   ...
   <xsl:template match="event/self-uri" priority="1000" mode="M105">
   ...
   <xsl:template match="abstract[parent::article-meta]" priority="1000" mode="M106">
   ...
   <xsl:template match="abstract[@xml:lang]" priority="1000" mode="M108">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions" priority="1000" mode="M109">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M110">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M111">
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <!--REPORT error-->
   ...
   <!--RULE license-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license" priority="1000" mode="M112">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions/license/license-p" priority="1000" mode="M113">
   ...
   <xsl:template match="permissions/license[@xlink:href]/license-p" priority="1000" mode="M114">
      <xsl:variable name="license-link" select="parent::license/@xlink:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[ali:license_ref]/license-p" priority="1000" mode="M115">
   ...
   <xsl:template match="fig[not(descendant::permissions)]|media[@mimetype='video' and not(descendant::permissions)]|table-wrap[not(descendant::permissions)]|supplementary-material[not(descendant::permissions)]" priority="1000" mode="M116">
   ...
   <xsl:template match="related-object[@content-type or @document-id]" priority="1000" mode="M117">
   ...
   <!--RULE notes-checks-->
   <xsl:template match="front/notes" priority="1000" mode="M118">
   ...
   <xsl:template match="preformat" priority="1000" mode="M120">
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M121">
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M122">
   ...
   <!--RULE xref-checks-->
   <xsl:template match="xref" priority="1000" mode="M123">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M124">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M125">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M126">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" priority="1000" mode="M127">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub" priority="1000" mode="M128">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group" priority="1000" mode="M129">
   ...
   <!--RULE ed-report-kwds-->
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group/kwd" priority="1000" mode="M130">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='claim-importance']/kwd" priority="1000" mode="M131">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/front-stub/kwd-group[@kwd-group-type='evidence-strength']/kwd" priority="1000" mode="M132">
   ...
   <xsl:template match="sub-article[@article-type='editor-report']/body/p[1]//bold" priority="1000" mode="M133">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//fig/label" priority="1000" mode="M134">
   ...
   <xsl:template match="sub-article[@article-type='author-comment']//table-wrap/label" priority="1000" mode="M135">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//fig/label" priority="1000" mode="M136">
   ...
   <xsl:template match="sub-article[@article-type='referee-report']//table-wrap/label" priority="1000" mode="M137">
   ...
   <xsl:template match="sub-article/front-stub/title-group/article-title" priority="1000" mode="M138">
   ...
   <xsl:template match="sub-article/front-stub" priority="1000" mode="M139">
   ...
   <xsl:template match="sub-article/front-stub/article-id[@pub-id-type='doi']" priority="1000" mode="M140">
   ...
   <xsl:template match="sub-article/body//p" priority="1000" mode="M141">
   ...
   <xsl:template match="sub-article/body//ext-link" priority="1000" mode="M142">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M143">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M144">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M145">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M146">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M147">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M148">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M149">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M150">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M151">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M152">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M153">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M154">
