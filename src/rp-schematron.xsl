<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <!--XSD TYPES FOR XSLT2-->
   <!--KEYS AND FUNCTIONS-->
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:is-valid-isbn" as="xs:boolean">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:is-valid-issn" as="xs:boolean">
      <xsl:param name="s" as="xs:string"/>
      <xsl:choose>
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:is-valid-orcid" as="xs:boolean">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:orcid-calculate-total" as="xs:integer">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:get-name" as="xs:string">
      <xsl:param name="name"/>
      <xsl:choose>
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:get-copyright-holder">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:get-surname" as="text()">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:get-ordinal" as="xs:string">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:alter-award-id">
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:toLowerCase" as="xs:string">
      <xsl:param name="s" as="xs:string"/>
   ...
   <xsl:function xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="e:toSentenceCase" as="xs:string">
      <xsl:param name="s" as="xs:string"/>
      <xsl:variable name="exceptions">
         <list>
            <case lower="elife">eLife</case>
   ...
   <xsl:template xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" match="." mode="customCopy">
      <xsl:copy copy-namespaces="no">
         <xsl:apply-templates select="*|@*|text()|comment()|processing-instruction()" mode="customCopy"/>
      </xsl:copy>
   </xsl:template>
   <xsl:template xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="copy-non-default-attribute" match="@*" mode="customCopy">
   ...
   <xsl:template xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" match="." mode="sentenceCase">
      <xsl:copy copy-namespaces="no">
   ...
   <xsl:template xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" match="." mode="lowerCase">
      <xsl:copy copy-namespaces="no">
         <xsl:apply-templates select="@*" mode="customCopy"/>
         <xsl:for-each select="node()|comment()|processing-instruction()">
            <xsl:choose>
   ...
   <xsl:template xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="tag-author-list">
   ...
   <xsl:template xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" name="get-remaining-sentences">
      <xsl:param name="nodes"/>
   ...
   <sqf:fixes xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns="http://purl.oclc.org/dsdl/schematron">
   ...
   <!--RULE article-tests-->
   <xsl:template match="article[front/journal-meta/lower-case(journal-id[1])='elife']" priority="1000" mode="M36">
   ...
   <xsl:template match="article-meta/title-group/article-title/*" priority="1000" mode="M38">
   ...
   <xsl:template match="article-meta/contrib-group/contrib[@contrib-type='author' and not(collab)]" priority="1000" mode="M39">
   ...
   <xsl:template match="contrib[@contrib-type='author']" priority="1000" mode="M40">
   ...
   <!--RULE name-tests-->
   <xsl:template match="contrib-group//name" priority="1000" mode="M41">
   ...
   <!--RULE surname-tests-->
   <xsl:template match="contrib-group//name/surname" priority="1000" mode="M42">
   ...
   <xsl:template match="name/given-names" priority="1000" mode="M43">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[1]" priority="1000" mode="M45">
   ...
   <!--RULE orcid-tests-->
   <xsl:template match="contrib-id[@contrib-id-type='orcid']" priority="1000" mode="M46">
   ...
   <xsl:template match="aff" priority="1000" mode="M47">
   ...
   <!--RULE country-tests-->
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//aff/country" priority="1000" mode="M48">
   ...
   <xsl:template match="aff[ancestor::contrib-group[not(@*)]/parent::article-meta]//institution-wrap" priority="1000" mode="M49">
   ...
   <xsl:template match="aff//institution-id" priority="1000" mode="M50">
   ...
   <!--RULE aff-ror-tests-->
   <xsl:template match="aff[count(institution-wrap/institution-id[@institution-id-type='ror'])=1]" priority="1000" mode="M51">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[@content-type='section']" priority="1000" mode="M52">
   ...
   <xsl:template match="article/front/article-meta/contrib-group[@content-type='section']/contrib" priority="1000" mode="M53">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']" priority="1000" mode="M54">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/source" priority="1000" mode="M55">
   ...
   <xsl:template match="mixed-citation[@publication-type='journal']/fpage" priority="1000" mode="M56">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']" priority="1000" mode="M57">
   ...
   <xsl:template match="mixed-citation[@publication-type='preprint']/source" priority="1000" mode="M58">
      <xsl:variable name="lc" select="lower-case(.)"/>
      <!--REPORT warning-->
   ...
   <xsl:template match="mixed-citation[@publication-type='book']" priority="1000" mode="M59">
   ...
   <xsl:template match="mixed-citation[@publication-type='book']/source" priority="1000" mode="M60">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']" priority="1000" mode="M61">
   ...
   <xsl:template match="mixed-citation[@publication-type='confproc']/conf-name" priority="1000" mode="M62">
   ...
   <xsl:template match="ref-list" priority="1000" mode="M63">
   ...
   <xsl:template match="ref-list[ref/label[matches(.,'^\p{P}*\d+\p{P}*$')] and not(ref/label[not(matches(.,'^\p{P}*\d+\p{P}*$'))])]/ref[label]" priority="1000" mode="M64">
   ...
   <xsl:template match="ref-list[ref/label]/ref" priority="1000" mode="M65">
   ...
   <xsl:template match="ref//year" priority="1000" mode="M66">
   ...
   <xsl:template match="mixed-citation//name | mixed-citation//string-name" priority="1000" mode="M67">
   ...
   <xsl:template match="mixed-citation//given-names | mixed-citation//surname" priority="1000" mode="M68">
   ...
   <!--RULE collab-checks-->
   <xsl:template match="collab" priority="1000" mode="M69">
      ...
      <sqf:fix xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns="http://purl.oclc.org/dsdl/schematron" id="replace-collab-to-string-name">
         <sqf:description>
   ...
   <xsl:template match="mixed-citation[person-group]//etal" priority="1000" mode="M70">
   ...
   <xsl:template match="comment" priority="1000" mode="M71">
   ...
   <xsl:template match="ref//pub-id" priority="1000" mode="M72">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='isbn']|isbn" priority="1000" mode="M73">
   ...
   <xsl:template match="ref//pub-id[@pub-id-type='issn']|issn" priority="1000" mode="M74">
   ...
   <xsl:template match="ref//person-group" priority="1000" mode="M75">
   ...
   <!--RULE p-ref-checks-->
   <xsl:template match="p[not(ancestor::sub-article)]" priority="1000" mode="M115">
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/licenses/by/')]" priority="1000" mode="M152">
      <xsl:variable name="author-contrib-group" select="ancestor::article-meta/contrib-group[1]"/>
      <xsl:variable name="copyright-holder" select="e:get-copyright-holder($author-contrib-group)"/>
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <xsl:variable name="is-first-version" select="if (ancestor::article-meta/article-id[@specific-use='version' and ends-with(.,'.1')]) then true()                                           else if (not(ancestor::article-meta/pub-history[event[date[@date-type='reviewed-preprint']]])) then true()                                           else false()"/>
   ...
   <xsl:template match="front[journal-meta/lower-case(journal-id[1])='elife']//permissions[contains(license[1]/@xlink:href,'creativecommons.org/publicdomain/zero')]" priority="1000" mode="M153">
      <xsl:variable name="license-type" select="license/@xlink:href"/>
      <!--REPORT error-->
   ...
   <xsl:template match="permissions/license[@xlink:href]/license-p" priority="1000" mode="M156">
      <xsl:variable name="license-link" select="parent::license/@xlink:href"/>
      <!--ASSERT error-->
      <xsl:choose>
   ...
   <xsl:template match="permissions/license[ali:license_ref]/license-p" priority="1000" mode="M157">
   ...
   <xsl:template match="sub-article/body//ext-link" priority="1000" mode="M186">
		...
		<!--REPORT warning-->
      <xsl:if test="not(inline-graphic) and matches(lower-case(@xlink:href),'imgur\.com')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(inline-graphic) and matches(lower-case(@xlink:href),'imgur\.com')">
