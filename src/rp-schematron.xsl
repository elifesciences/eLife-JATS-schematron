<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:dc="http://purl.org/dc/terms/" xmlns:e="https://elifesciences.org/namespace" xmlns:file="java.io.File" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:java="http://www.java.com/" xmlns:meca="http://manuscriptexchange.org" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:saxon="http://saxon.sf.net/" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="article" priority="1000" mode="M16">
      ...
      <xsl:if test="matches(lower-case($article-text),'biorend[eo]r')">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(lower-case($article-text),'biorend[eo]r')">
            ...
            <svrl:text>[biorender-check] Article text contains a mention of bioRender. Since bioRender do not permit content to be published under a CC-BY license (https://help.biorender.com/en/articles/8601313-creative-commons-licensing-for-biorender-figures-premium-only), if any images were created using bioRender a blanket permissions statement will need to be added for the Reviewed Preprint: 'Any parts of this image created with BioRender are not made available under the same license as the Reviewed Preprint, and are © 2024, BioRender Inc.'</svrl:text>
   ...
   <!--RULE strike-checks-->
   <xsl:template match="strike" priority="1000" mode="M42">
   ...
   <xsl:template match="underline" priority="1000" mode="M43">
   ...
   <xsl:template match="fig/label" priority="1000" mode="M46">
   ...
   <xsl:template match="table-wrap/label" priority="1000" mode="M49">
   ...
   <xsl:template match="disp-formula" priority="1000" mode="M52">
   ...
   <xsl:template match="inline-formula" priority="1000" mode="M53">
   ...
   <xsl:template match="alternatives[parent::disp-formula]" priority="1000" mode="M54">
   ...
   <xsl:template match="alternatives[parent::inline-formula]" priority="1000" mode="M55">
   ...
   <!--RULE list-checks-->
   <xsl:template match="list" priority="1000" mode="M56">
   ...
   <!--RULE graphic-checks-->
   <xsl:template match="graphic|inline-graphic" priority="1000" mode="M57">
   ...
   <!--RULE media-checks-->
   <xsl:template match="media" priority="1000" mode="M58">
   ...
   <!--RULE sec-checks-->
   <xsl:template match="sec" priority="1000" mode="M59">
   ...
   <!--RULE title-checks-->
   <xsl:template match="title" priority="1000" mode="M60">
   ...
   <xsl:template match="article/body/sec/title|article/back/sec/title" priority="1000" mode="M61">
   ...
   <!--RULE p-bold-checks-->
   <xsl:template match="p[(count(*)=1) and (child::bold or child::italic)]" priority="1000" mode="M62">
   ...
   <xsl:template match="article/front/article-meta//article-version" priority="1000" mode="M64">
   ...
   <xsl:template match="article/front/article-meta/article-version-alternatives" priority="1000" mode="M65">
   ...
   <xsl:template match="preformat" priority="1000" mode="M67">
   ...
   <!--RULE code-checks-->
   <xsl:template match="code" priority="1000" mode="M68">
   ...
   <!--RULE uri-checks-->
   <xsl:template match="uri" priority="1000" mode="M69">
   ...
   <!--RULE ext-link-tests-->
   <xsl:template match="ext-link[@ext-link-type='uri']" priority="1000" mode="M71">
   ...
   <xsl:template match="ext-link" priority="1000" mode="M72">
   ...
   <xsl:template match="fn-group[fn]" priority="1000" mode="M73">
   ...
   <xsl:template match="p|td|th|title|xref|bold|italic|sub|sc|named-content|monospace|code|underline|fn|institution|ext-link" priority="1000" mode="M74">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='arxiv']" priority="1000" mode="M75">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='arxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M76">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='rs']" priority="1000" mode="M77">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='rs']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M78">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='psyarxiv']" priority="1000" mode="M79">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='psyarxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M80">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='osf preprints']" priority="1000" mode="M81">
   ...
   <!--RULE osf-doi-checks-->
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='osf preprints']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M82">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='ecoevorxiv']" priority="1000" mode="M83">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='ecoevorxiv']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M84">
   ...
   <xsl:template match="article/front/journal-meta[lower-case(journal-id[1])='authorea']" priority="1000" mode="M85">
   ...
   <xsl:template match="article/front[journal-meta[lower-case(journal-id[1])='authorea']]/article-meta/article-id[@pub-id-type='doi']" priority="1000" mode="M86">
