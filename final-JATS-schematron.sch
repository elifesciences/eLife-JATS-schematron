 ...
 <pattern id="object-id-tests-pattern">
  ...
  <pattern id="list-item-tests-pattern">
    <rule context="list-item" id="list-item-tests">
      ...
      <report test="($type='alpha-lower') and matches(.,'^\s?[a-z][\.|\)]? ')" role="warning" id="alpha-lower-test-1">list-item is part of an alpha-lower list, but it begins with a single lower-case letter. Is this correct? <value-of select="."/>
      </report>
      
      <report test="($type='alpha-upper') and matches(.,'^\s?[A-Z][\.|\)]? ')" role="warning" id="alpha-upper-test-1">list-item is part of an alpha-upper list, but it begins with a single upper-case letter. Is this correct? <value-of select="."/>
      </report>
