   ...
   <rule context="article-meta/article-categories" id="test-article-categories">
    ...
    <let name="article-type" value="ancestor::article/@article-type"/> 
      ...
      <assert test="if ($article-type = 'research-article') then . = $research-disp-channels
        ...
        else if ($article-type = 'review-article') then . = 'Review Article'
        else . = 'Retraction'"
        role="error" 
 ...
 <pattern
  ...
  <pattern
    ...
    <rule context="article/body//fig[@specific-use='child-fig']" 
      ...
      <assert test="label[matches(.,'^Figure [\d]+—figure supplement [\d]+\.$')]" 
        role="error"
  ...
  <pattern
    ...
    <rule context="article-meta//article-title" 
      ...
      <report test="if ($type = $specifics) then not(starts-with(.,$string))
        ...
        role="error"
        id="article-type-title-test-1">title of a '<value-of select="$type"/>' must start with '<value-of select="$string"/>'.</report>
  ...
  <pattern
    ...
    <rule context="back"
      ...
      <report test="($subj-type = $features-subj) and (count(sec[@sec-type='additional-information']/fn-group[@content-type='competing-interest']) + count(fn-group[@content-type='competing-interest']) != 1) "
        role="error"
        id="back-test-7">An fn-group[@content-type='competing-interest'] must be present in back in <value-of select="$subj-type"/> content.</report>
      
      <report test="($subj-type = $research-subj) and (count(sec[@sec-type='additional-information']/fn-group[@content-type='competing-interest']) != 1)"
        role="error"
        id="back-test-9">One and only one fn-group[@content-type='competing-interest'] must be present in back in <value-of select="$subj-type"/> content.</report>
 ...
 <pattern
  ...
  <pattern
    ...
    <rule context="element-citation[@publication-type='journal']/article-title"
      ...
      <report test="matches($lc,'p\.\s?plantaginis') and not(italic[contains(text() ,'P. plantaginis')])"
        role="warning" 
        id="pplantaginis-ref-article-title-check"><name/> contains an organism - 'F. tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'podosphaera\s?plantaginis') and not(italic[contains(text() ,'Podosphaera plantaginis')])"
        role="warning" 
        id="podosphaeraplantaginis-ref-article-title-check"><name/> contains an organism - 'Francisella tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'p\.\s?lanceolata') and not(italic[contains(text() ,'P. lanceolata')])"
        role="warning" 
        id="planceolata-ref-article-title-check"><name/> contains an organism - 'F. tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'plantago\s?lanceolata') and not(italic[contains(text() ,'Plantago lanceolata')])"
        role="warning" 
        id="plantagolanceolata-ref-article-title-check"><name/> contains an organism - 'Francisella tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
    ...
    <rule context="article//article-meta/title-group/article-title | article/body//sec/title | article//article-meta//kwd"
      ...
      <report test="matches($lc,'p\.\s?plantaginis') and not(italic[contains(text() ,'P. plantaginis')])"
        role="warning" 
        id="pplantaginis-article-title-check"><name/> contains an organism - 'F. tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'podosphaera\s?plantaginis') and not(italic[contains(text() ,'Podosphaera plantaginis')])"
        role="warning" 
        id="podosphaeraplantaginis-article-title-check"><name/> contains an organism - 'Francisella tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'p\.\s?lanceolata') and not(italic[contains(text() ,'P. lanceolata')])"
        role="warning" 
        id="planceolata-article-title-check"><name/> contains an organism - 'F. tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
      
      <report test="matches($lc,'plantago\s?lanceolata') and not(italic[contains(text() ,'Plantago lanceolata')])"
        role="warning" 
        id="plantagolanceolata-article-title-check"><name/> contains an organism - 'Francisella tularensis' - but there is no italic element with that correct capitalisation or spacing.</report>
  ...
  <pattern
    ...
    <rule context="element-citation//name" 
      ...
      <report test="matches(surname,'^[A-Z]*$')"
        role="warning"
        id="all-caps-surname">surname in ref '<value-of select="ancestor::ref/@id"/>' is composed of only capitalised letters - <value-of select="surname"/>. Should this be captured as a collab? If not, Should it be - <value-of select="concat(substring(surname,1,1),lower-case(substring(surname,2)))"/>?</report>
    ...
    <rule context="italic[not(ancestor::ref)]" 
      ...
      <report test="matches(.,'et al[\.]?')"
        role="warning" 
        id="et-al-italic-test"><name/> element contains '<value-of select="."/>' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ii]n [Vv]itro')"
        role="warning" 
        id="in-vitro-italic-test"><name/> element contains 'in vitro' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ii]n [Vv]ivo')"
        role="warning" 
        id="in-vivo-italic-test"><name/> element contains 'in vivo' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ee]x [Vv]ivo')"
        role="warning" 
        id="ex-vivo-italic-test"><name/> element contains 'ex vivo' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Aa] [Pp]riori')"
        role="warning" 
        id="a-priori-italic-test"><name/> element contains 'a priori' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Aa] [Pp]osteriori')"
        role="warning" 
        id="a-posteriori-italic-test"><name/> element contains 'a posteriori' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Dd]e [Nn]ovo')"
        role="warning" 
        id="de-novo-italic-test"><name/> element contains 'de novo' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ii]n [Uu]tero')"
        role="warning" 
        id="in-utero-italic-test"><name/> element contains 'in utero' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ii]n [Nn]atura')"
        role="warning" 
        id="in-natura-italic-test"><name/> element contains 'in natura' - this should not be in italics (eLife house style).</report>
      ...
      <report test="matches(.,'[Rr]ete [Mm]irabile')"
        role="warning" 
        id="rete-mirabile-italic-test"><name/> element contains 'rete mirabile' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Nn]omen [Nn]ovum')"
        role="warning" 
        id="nomen-novum-italic-test"><name/> element contains 'nomen novum' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ss]ativum')"
        role="warning" 
        id="sativum-italic-test"><name/> element contains 'sativum' - this should not be in italics (eLife house style).</report>
      
      <report test="matches(.,'[Ss]ensu')"
        role="warning" 
        id="sensu-italic-test"><name/> element contains 'sensu' - this should not be in italics (eLife house style).</report>
    </rule>
