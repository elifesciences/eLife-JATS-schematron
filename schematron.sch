 ...
 <pattern
  ...
  <pattern
    ...
    <rule context="p" 
      ...
      <report test="(ancestor::body) and (string-length(.) le 100) and (preceding-sibling::*[1]/local-name() = 'p') and (string-length(preceding-sibling::p[1]) le 100) and (($article-type != 'correction') or ($article-type != 'retraction'))"
        role="warning" 
