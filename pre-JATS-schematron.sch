 ...
 <pattern id="object-id-tests-pattern">
  ...
  <pattern id="general-video-pattern">
    <rule context="media[@mimetype='video'][matches(@id,'^video[0-9]{1,3}$')]" id="general-video">
      ...
      <report test="count($xref1) = 0" role="warning" id="pre-video-cite">There is no citation to <value-of select="label"/> Ensure to query the author asking for a citation.</report>
