<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:java="http://www.java.com/" xmlns:file="java.io.File" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:mml="http://www.w3.org/1998/Math/MathML" queryBinding="xslt2">
  ...
  <pattern id="article-metadata">
    <rule context="event-desc" id="event-desc-tests">
      ...
      <report test="matches(parent::event/self-uri[1]/@xlink:href,'elifesciences\.org|10.7554/e[lL]ife') and not(matches(.,'^Reviewed preprint v\d$') or .=$template-descriptions)" role="error" id="event-desc-content-2">
        <name/> that's a child of an event with an eLife DOI must contain the text 'Reviewed preprint v0' (or in older content one of the folllowing template descriptions: '<value-of select="string-join($template-descriptions,'; ')"/>'). This one has '<value-of select="."/>'.</report>
    </rule>
  </pattern>
