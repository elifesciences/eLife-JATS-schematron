<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:java="http://www.java.com/" xmlns:file="java.io.File" xmlns:ali="http://www.niso.org/schemas/ali/1.0/" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:meca="http://manuscriptexchange.org" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" queryBinding="xslt2">
  ...
  <pattern id="p-file-ref-checks-pattern">
    <rule context="article//p[not(ancestor::sub-article) and not(ancestor::ack)]" id="p-file-ref-checks">
      ...
      <report test="matches($text,$missing-file-regex)" role="warning" id="missing-file-in-text-test">[missing-file-in-text-test] <name/> element contains possible unlinked citation to a figure, table or file - search - <value-of select="string-join(e:analyze-string($text,$missing-file-regex)//*:match,'; ')"/>
      </report>
    </rule>
  </pattern>
