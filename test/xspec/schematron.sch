 ...
 <pattern id="article-tests-pattern">
  ...
  <pattern id="pub-date-tests-1-pattern">
    <rule context="pub-date[not(@pub-type='collection')]" id="pub-date-tests-1">
      ...
      <assert test="matches(day[1],'^[0-9]{2}$')" role="warning" id="pre-pub-date-test-1">day is not present in pub-date.</assert>
      ...
      <assert test="matches(month[1],'^[0-9]{2}$')" role="warning" id="pre-pub-date-test-2">month is not present in pub-date.</assert>
  ...
  <pattern id="abstract-word-count-pattern">
    <rule context="front//abstract[not(@abstract-type) and not(sec)]" id="abstract-word-count">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/article-structure/abstract-digest-impact-statement#pre-abstract-word-count-restriction" test="($count gt 280)" role="warning" id="pre-abstract-word-count-restriction">The abstract contains <value-of select="$count"/> words, when the usual upper limit is 280. Exeter: Please check with the eLife production team who will need to contact the eLife Editorial team.</report>
  ...
  <pattern id="meta-value-tests-pattern">
    <rule context="article-meta/custom-meta-group/custom-meta[meta-name='Author impact statement']/meta-value" id="meta-value-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/article-structure/abstract-digest-impact-statement#pre-custom-meta-test-9" test="matches(.,'[Ww]e show|[Ww]e present|[Tt]his study|[Tt]his paper')" role="warning" id="pre-custom-meta-test-9">Impact statement contains a possessive phrase. This is not allowed.</report>
  ...
  <pattern id="fig-tests-pattern">
    <rule context="fig[not(ancestor::sub-article)]" id="fig-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-test-5" test="not($article-type = ('discussion',$notice-article-types)) and not(caption/title)" role="warning" id="pre-fig-test-5">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/figures#pre-fig-test-7" test="graphic" role="warning" id="pre-fig-test-7">fig does not have graphic. Ensure author query is added asking for file.</assert>
  ...
  <pattern id="table-title-tests-pattern">
    <rule context="table-wrap[not(ancestor::sub-article) and not(contains(@id,'keyresource')) and label]" id="table-title-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#pre-table-title-test-1" test="caption/title" role="warning" id="pre-table-title-test-1">
  ...
  <pattern id="elem-citation-pattern">
    <rule context="element-citation" id="elem-citation">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-element-cite-year" test="not(year)" role="warning" id="pre-element-cite-year">'<value-of select="@publication-type"/>' type references must have a year. Reference '<value-of select="../@id"/>' does not. If you are unable to determine this, please ensure to add an author query asking for the year of publication.</report>
  ...
  <pattern id="elem-citation-book-pattern">
    <rule context="element-citation[@publication-type='book']" id="elem-citation-book">
      ...
      <assert test="count(person-group)=1 or (count(person-group[@person-group-type='author'])=1 and count(person-group[@person-group-type='editor'])=1)" role="warning" id="pre-err-elem-cit-book-2-3">In a book reference, there should be a single person-group element (either author or editor) or one person-group with @person-group-type="author" and one person-group with @person-group-type=editor. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(person-group)"/> &lt;person-group&gt; elements. If this finromation is missing, please query it with the authors.</assert>
      ...
      <assert test="count(source)=1" role="warning" id="pre-err-elem-cit-book-10-1">Each  &lt;element-citation&gt; of type 'book' must contain one and only one &lt;source&gt; element. Reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(source)"/> &lt;source&gt; elements. If this information is missing, please query it with the authors.</assert>
  ...
  <pattern id="elem-citation-data-pattern">
    <rule context="ref/element-citation[@publication-type='data']" id="elem-citation-data">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references/data-references#pre-err-elem-cit-data-10" test="count(data-title)=1" role="warning" id="pre-err-elem-cit-data-10">Data reference '<value-of select="ancestor::ref/@id"/>' has <value-of select="count(data-title)"/> data-title elements, when it should contain one. If this information is missing, please query it with the authors.</assert>
  ...
  <pattern id="gen-das-tests-pattern">
    <rule context="sec[@sec-type='data-availability']//element-citation[@publication-type='data']" id="gen-das-tests">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-person-group-1" test="count(person-group[@person-group-type='author'])=1" role="warning" id="pre-das-elem-person-group-1">The reference in position <value-of select="$pos"/> of the data availability section does not have any authors (no person-group[@person-group-type='author']). Please ensure to add them in or query the authors asking for the author list.</assert>
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/data-availability#pre-das-elem-source-1" test="count(source)=1" role="warning" id="pre-das-elem-source-1">The reference in position <value-of select="$pos"/> of the data availability section does not have a database name (no source). Please ensure to add it in or query the authors asking for it.</assert>
  ...
  <pattern id="pub-id-tests-pattern">
    <rule context="element-citation/pub-id" id="pub-id-tests">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-pub-id-test-2" test="(@pub-id-type='doi') and not(matches(.,'^10\.\d{4,9}/[-._;\+()#/:A-Za-z0-9&lt;&gt;\[\]]+$'))" role="warning" id="pre-pub-id-test-2">pub-id is tagged as a doi, but it is not one - <value-of select="."/>. If this information is missing, please ensure to query it with the authors.</report>
 ...
 <pattern id="feature-title-tests-pattern">
  ...
  <pattern id="italic-house-style-pattern">
    <rule context="italic[not(ancestor::ref) and not(ancestor::sub-article)]" id="italic-house-style">  
      ...
      <report test="matches(.,'et al[\.]?')" role="error" id="pre-et-al-italic-test">
      ...
      <report test="matches(.,'[Ii]n [Vv]itro')" role="error" id="pre-in-vitro-italic-test">
      ...
      <report test="matches(.,'[Ee]x [Vv]ivo')" role="error" id="pre-ex-vivo-italic-test">
      ...
      <report test="matches(.,'[Aa] [Pp]osteriori')" role="error" id="pre-a-posteriori-italic-test">
      ...
      <report test="matches(.,'[Ii]n [Ss]itu')" role="error" id="pre-in-situ-italic-test">
        <name/> element contains 'in situ' - this should not be in italics (eLife house style).</report>  
      
      <report test="matches(.,'[Ii]n [Pp]lanta')" role="error" id="pre-in-planta-italic-test">
      ...
      <report test="matches(.,'[Ii]n [Oo]vo')" role="error" id="pre-in-ovo-italic-test">
  ...
  <pattern id="pubmed-link-2-pattern">
    <rule context="table-wrap//ext-link[(contains(@xlink:href,'ncbi.nlm.nih.gov/pubmed') or contains(@xlink:href,'pubmed.ncbi.nlm.nih.gov')) and not(ancestor::sub-article)]" id="pubmed-link-2">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/allowed-assets/tables#pre-pmid-spacing-table" test="ends-with($lc,'pmid: ') or ends-with($lc,'pmid ')" role="error" id="pre-pmid-spacing-table">PMID link should be preceding by 'PMID:' with no space but instead it is preceded by '<value-of select="concat(substring($pre-text,string-length($pre-text)-15),.)"/>'.</report>
  ...
  <pattern id="rrid-link-pattern">
    <rule context="ext-link[contains(@xlink:href,'scicrunch.org/resolver') and not(ancestor::sub-article)]" id="rrid-link">
      ...
      <report see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/rrids#pre-rrid-spacing" test="ends-with($lc,'rrid: ') or ends-with($lc,'rrid ')" role="error" id="pre-rrid-spacing">RRID link should be preceded by 'RRID:' with no space but instead it is preceded by '<value-of select="concat(substring($pre-text,string-length($pre-text)-15),.)"/>'.</report>
  ...
  <pattern id="ref-link-mandate-pattern">
    <rule context="ref-list/ref" id="ref-link-mandate">
      ...
      <assert see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/references#pre-ref-link-presence" test="ancestor::article//xref[@rid = $id]" role="warning" id="pre-ref-link-presence">'<value-of select="$id"/>' has no linked citations. Either the reference should be removed or a citation linking to it needs to be added.</assert>
...
<pattern id="root-pattern">
    <rule context="root" id="root-rule">
      ...
      <assert test="descendant::article[@article-type='research-article' and sub-article]" role="error" id="research-article-sub-article-xspec-assert">article[@article-type='research-article' and sub-article] must be present.</assert>
      ...
      <assert test="descendant::article/front/journal-meta/journal-id" role="error" id="journal-id-xspec-assert">article/front/journal-meta/journal-id must be present.</assert>
      ...
      <assert test="descendant::ext-link[@ext-link-type='uri' and not(ancestor::sec[@sec-type='data-availability']) and not(parent::element-citation) and not(ancestor::table-wrap) and string-length(.) gt 59]" role="error" id="ext-link-tests-2-xspec-assert">ext-link[@ext-link-type='uri' and not(ancestor::sec[@sec-type='data-availability']) and not(parent::element-citation) and not(ancestor::table-wrap) and string-length(.) gt 59] must be present.</assert>
      ...
      <assert test="descendant::table-wrap//supplementary-material[contains(label[1],' code ')]" role="error" id="table-source-code-tests-xspec-assert">table-wrap//supplementary-material[contains(label[1],' code ')] must be present.</assert>
      ...
      <assert test="descendant::sub-article[@article-type='editor-report']/front-stub/*" role="error" id="ed-eval-front-child-tests-xspec-assert">sub-article[@article-type='editor-report']/front-stub/* must be present.</assert>
      ...
      <assert test="descendant::p[not(child::table-wrap)]" role="error" id="gene-primer-sequence-xspec-assert">p[not(child::table-wrap)] must be present.</assert>
